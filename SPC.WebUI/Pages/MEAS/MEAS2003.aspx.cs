...
{
    public partial class MEAS2003 : WebUIBasePage
    {
        ...
        Int32 MEAS2003_CNT()
        {
            ...
            {
                CreateParameters();
                totalCnt = biz.MEAS2003_CNT(oParamDic);
            }
        ...
        void MEAS2003_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            string errMsg = String.Empty;
            ...
            using (MEASBiz biz = new MEASBiz())
            {
                ...
                ds = biz.MEAS2003_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, MEAS2003_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            MEAS2003_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        {
            MEAS2003_LST(MEAS2003_CNT(), 1, false);
            devGridExporter.WriteXlsToResponse(String.Format("팀별검교정계획_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
