...
{
    public partial class MEAS2002 : WebUIBasePage
    {
        ...
        {
            oParamDic.Clear();
            oParamDic.Add("F_FROMDT", srcF_FIXPLANDT_FROM.Text);
            oParamDic.Add("F_TODT", srcF_FIXPLANDT_TO.Text);
        ...
        Int32 MEAS2002_CNT()
        {
            ...
            {
                CreateParameters();
                totalCnt = biz.MEAS2002_CNT(oParamDic);
            }
        ...
        void MEAS2002_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            string errMsg = String.Empty;
            ...
            using (MEASBiz biz = new MEASBiz())
            {
                ...
                ds = biz.MEAS2002_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, MEAS2002_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            MEAS2002_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        {
            MEAS2002_LST(MEAS2002_CNT(), 1, false);
            devGridExporter.WriteXlsToResponse(String.Format("월검교정계획_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
