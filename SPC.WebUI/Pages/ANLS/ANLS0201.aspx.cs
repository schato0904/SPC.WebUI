...
{
    public partial class ANLS0201 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["ANLS0201_1"];
            }
            set
            {
                Session["ANLS0201_1"] = value;
            }
        }
        ...
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["ANLS0201_2"];
            }
            set
            {
                Session["ANLS0201_2"] = value;
            }
        }
        ...
        DataTable dtChart3
        {
            get
            {
                return (DataTable)Session["ANLS0201_3"];
            }
            set
            {
                Session["ANLS0201_3"] = value;
            }
        }
        #endregion
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart1 != null)
            {
                ...
                DevExpressLib.SetChartSplineSeries(devChart1, "", "F_DATA1", "F_DATA2", System.Drawing.Color.DarkGreen, null, DevExpress.XtraCharts.ScaleType.Qualitative);
                DevExpressLib.SetChartBarLineSeries(devChart1, "", "F_DATA1", "F_STANDARD", System.Drawing.Color.Khaki, 0.2);
        ...
        void ChartData()
        {
            ...
            {
                ds = biz.ANLS0201_ANAL(oParamDic, out errMsg);
            }
            ...
            if (true == bExecute1)
            {
                using (ANLSBiz biz = new ANLSBiz())
                {
                    ds = biz.ANLS0201_CHART(oParamDic, out errMsg);
                }
