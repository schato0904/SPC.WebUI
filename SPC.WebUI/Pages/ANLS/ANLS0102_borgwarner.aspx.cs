...
{
    public partial class ANLS0102_borgwarner : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["ANLS0102_1_borgwarner"];
            }
            set
            {
                Session["ANLS0102_1_borgwarner"] = value;
            }
        }
        DataTable dtChart3
        {
            get
            {
                return (DataTable)Session["ANLS0102_3_borgwarner"];
            }
            set
            {
                Session["ANLS0102_3_borgwarner"] = value;
            }
        }
        #endregion
        ...
        void SetGrid(DataTable dt1, DataTable dt3)
        {
            ...
            foreach (DataRow dtRow1 in dt1.Rows)
            {
                ...
                dtNewRow["검사일자"] = String.Format("{0}", dtRow1["F_MEMBER"].ToString().Substring(5));
                dtNewRow["검사시간"] = dtRow1["F_WORKTIME"].ToString();
                dtNewRow["공정"] = dtRow1["F_WORKNM"].ToString();
        ...
        /// <param name="sender">object</param>
        /// <param name="e">EventArgs</param>
        protected void txtINSPITEMCD_Init(object sender, EventArgs e)
        {
            (sender as DevExpress.Web.ASPxTextBox).Attributes.Add("ondblclick", "fn_OnPopupUCInspectionItemSearch()");
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            oParamDic.Add("F_MEAINSPCD", hidINSPITEMCD.Text);
            ...
            {
                ds = biz.ANLS0101_1_BORGWARNER(oParamDic, out errMsg);
            }
            ...
            if (true == bExecute1)
            {
                ...
                using (ANLSBiz biz = new ANLSBiz())
                {
                    ds = biz.ANLS0101_2_BORGWARNER(oParamDic, out errMsg);
                }
