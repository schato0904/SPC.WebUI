...
{
    public partial class ANLS0203 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["ANLS0203_1"];
            }
            set
            {
                Session["ANLS0203_1"] = value;
            }
        }
        ...
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["ANLS0203_2"];
            }
            set
            {
                Session["ANLS0203_2"] = value;
            }
        }
        ...
        DataTable dtChart3
        {
            get
            {
                return (DataTable)Session["ANLS0203_3"];
            }
            set
            {
                Session["ANLS0203_3"] = value;
            }
        }
        #endregion
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart1 != null)
            {
                ...
                DevExpressLib.SetChartBarLineSeriesWithLabel(devChart1, "규격", "F_GBNNM", "F_VALUE", System.Drawing.Color.LightPink, System.Drawing.Color.LightPink, 0.2);

                devChart1.Series["규격"].Label.TextPattern = "{A}";
                BarSeriesLabel serieslabel = devChart1.Series["규격"].Label as BarSeriesLabel;
                ...
                DevExpressLib.SetChartDiagram(devChart1, false, 0, 0, 0, 0, null, "{V:n4}", false, false);
            }
        }
        #endregion
