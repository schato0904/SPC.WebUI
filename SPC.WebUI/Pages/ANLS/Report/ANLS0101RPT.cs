...
{
    public partial class ANLS0101RPT : DevExpress.XtraReports.UI.XtraReport
    {
        string[] oParams;
        /*
         *  0 : 업체코드
        ...
        public ANLS0101RPT(string[] oParams, DataTable dtTable1, DataTable dtTable2, DataTable dtTable3, Image imgChartX, Image imgChartR, Image imgChartH)
        {
            InitializeComponent();
