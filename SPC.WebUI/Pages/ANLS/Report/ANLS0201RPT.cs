...
{
    public partial class ANLS0201RPT : DevExpress.XtraReports.UI.XtraReport
    {
        string[] oParams;
        /*
         *  0 : 업체코드
        ...
        public ANLS0201RPT(string[] oParams, DataTable dtTable1, DataTable dtTable2, DataTable dtTable3, Image imgChartH)
        {
            InitializeComponent();
