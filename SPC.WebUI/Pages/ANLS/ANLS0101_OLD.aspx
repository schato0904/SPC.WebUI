<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ANLS0101_OLD.aspx.cs" Inherits="SPC.WebUI.Pages.ANLS.ANLS0101_OLD" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (oSetParam != '') {
                ...
                //FROMDT|TODT|F_ITEMCD|F_ITEMNM|F_WORKCD|F_WORKNM|F_MEAINSPCD|F_INSPDETAIL|F_SERIALNO|F_SIRYO|
                //F_FREEPOINT|F_STANDARD|F_MAX|F_MIN|F_WORKDATE|F_WORKTIME|F_PCNM|F_MEASNO|F_INSPCD|F_TSERIALNO|
                //F_COMPCD|F_FACTCD
                // 검색일
        ...
        function fn_AdjustSize() {
            ...
            devGrid.SetWidth(parseInt($(".search").width() - width - 5, 10));
            devGrid.SetHeight(190);

            chartWidth = parseInt($(".search").width() - width - 5, 10);
        ...
        function fn_OnPrintClick() {
            ...
            // 업체
            <%if(!gsVENDOR) {%>
            KEYS += fn_GetCastText('hidCOMPCD') + '|';
            KEYS += encodeURIComponent(fn_GetCastSelectedItemText('ddlCOMP')) + '|';
            <%} else {%>
            KEYS += '<%=gsCOMPCD%>|';
            ...
            // 공장
            <%if(!gsVENDOR) {%>
            KEYS += fn_GetCastText('hidFACTCD');
            <%} else {%>
            KEYS += '<%=gsFACTCD%>';
            <%}%>

            fn_OnPopupANLS0101Report_OLD(KEYS);
        }
        ...
        // 관리한계 이력조회
        function OnPopupCONTROL() {
            if (fn_GetCastText('hidUCITEMCD') == '') {
                alert('품목을 선택하세요!!');
                return false;
            }
            ...
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4 control-label">
                        <div class="form-group">
                            ...
                            <label class="col-sm-4 control-label">
                                <button class="btn btn-sm btn-danger" onclick="return OnPopupCONTROL();">
                    ...
                    <div class="col-sm-4 control-label">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label">해석용</label>
                            <div class="col-sm-3 control-label">
