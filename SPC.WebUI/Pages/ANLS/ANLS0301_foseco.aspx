<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ANLS0301_foseco.aspx.cs" Inherits="SPC.WebUI.Pages.ANLS.ANLS0301_foseco" %>
                        ...
                        <div class="form-horizontal divEditForm">
                            ...
                            <div class="form-group">                                
                                ...
                                <div class="col-sm-2" >
                                    ...
                                    <button class="btn btn-sm btn-warning" style="width: 100%; padding: 3px 0px;" onclick="fn_AttachFileOpen('시제품결과등록', 'G', 'F'); return false;" >
                            ...
                            <div class="form-group">                                
                                ...
                                <label class="col-sm-1 control-label">시제품 차수</label>
                                <div class="col-sm-1" >
