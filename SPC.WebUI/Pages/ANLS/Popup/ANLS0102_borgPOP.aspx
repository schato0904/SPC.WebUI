<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="ANLS0102_borgPOP.aspx.cs" Inherits="SPC.WebUI.Pages.Common.Popup.ANLS0102_borgPOP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnRowDblClick(s, e) {
            ...
            fn_OnGetRowValues(rowKey);
            parent.fn_OnSettingMeainsp(rowKey[0], rowKey[1]);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        ...
        <dx:ASPxTextBox ID="txtITEMCD" ClientInstanceName="txtITEMCD" runat="server" ClientVisible="false" ></dx:ASPxTextBox>
        <dx:ASPxTextBox ID="txtWORKCD" ClientInstanceName="txtWORKCD" runat="server" ClientVisible="false" ></dx:ASPxTextBox>
        <div class="content">
            <dx:ASPxTextBox ID="hidGridAction" ClientInstanceName="hidGridAction" runat="server" ClientVisible="false" Text="false" />
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_MEAINSPCD;F_INSPDETAIL;F_INSPCD;F_INSPNM;F_STANDARD;F_MAX;F_MIN;F_UCLX;F_LCLX;F_UCLR;F_SIRYO;F_FREEPOINT" EnableViewState="false" EnableRowsCache="false"
