...
{
    public partial class ANLS0203REPORT : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DataTable dtChart1 = (DataTable)Session["ANLS0203_1"];
            DataTable dtChart2 = (DataTable)Session["ANLS0203_2"];
            DataTable dtChart3 = (DataTable)Session["ANLS0203_3"];
            ...
            else
            {
                ...
                ANLS0203RPT report = new ANLS0203RPT(oParams, dtChart1, dtChart2, dtChart3, imgChartH);
