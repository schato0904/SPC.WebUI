...
{
    public partial class ANLS0101REPORT : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DataTable dtChart1 = (DataTable)Session["ANLS0101_1_NEW"];
            DataTable dtChart2 = (DataTable)Session["ANLS0101_2_NEW"];
            DataTable dtChart3 = (DataTable)Session["ANLS0101_3_NEW"];
            ...
            else
            {
                ...
                ANLS0101RPT report = new ANLS0101RPT(oParams, dtChart1, dtChart2, dtChart3, imgChartX, imgChartR, imgChartH);
        ...
        System.Drawing.Image GetHChartImg(string[] oParams, DataTable dtChart1)
        {
            ...
            DataTable dtChart4 = (DataTable)Session["ANLS0101_4_NEW"];

            oParamDic = new Dictionary<string, string>();
            oParamDic.Add("F_COMPCD", oParams[0]);
            oParamDic.Add("F_FACTCD", oParams[21]);
            oParamDic.Add("F_STDT", oParams[2]);
            oParamDic.Add("F_EDDT", oParams[3]);
            ...
            using (ANLSBiz biz = new ANLSBiz())
            {
                ...
                //ds = GetDataHistogram(oParamDic);
                //var c = sc.GetHistogram(chartcontrol, ds);
            }

            //DataTable dtt = dtChart4;
            // 데이타가 있는 경우
