...
{
    public partial class ANLS0201REPORT : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DataTable dtChart1 = (DataTable)Session["ANLS0201_1"];
            DataTable dtChart2 = (DataTable)Session["ANLS0201_2"];
            DataTable dtChart3 = (DataTable)Session["ANLS0201_3"];
            ...
            else
            {
                ...
                ANLS0201RPT report = new ANLS0201RPT(oParams, dtChart1, dtChart2, dtChart3, imgChartH);
