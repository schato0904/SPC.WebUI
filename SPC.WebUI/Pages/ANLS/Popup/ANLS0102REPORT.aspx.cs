...
{
    public partial class ANLS0102REPORT : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DataTable dtChart1 = (DataTable)Session["ANLS0102_1"];
            DataTable dtChart3 = (DataTable)Session["ANLS0102_3"];
            ...
            else
            {
                ...
                ANLS0102RPT report = new ANLS0102RPT(oParams, dtChart1, dtChart3, imgChartX, imgChartR);
