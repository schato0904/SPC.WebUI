...
{
    public partial class FITM0202 : WebUIBasePage
    {
        ...
        Int32 QWK04A_FITM0202_CNT()
        {
            using (FITMBiz biz = new FITMBiz())
            {
                ...
                {
                    totalCnt = biz.QWK04A_FITM0202_CNT_MST(oParamDic);
                }
                else                 // 협력사
                {
                    totalCnt = biz.QWK04A_FITM0202_CNT(oParamDic);
                }
        ...
        #region Data조회
        void QWK04A_FITM0202_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (FITMBiz biz = new FITMBiz())
            {
                ...
                if (!this.gsVENDOR)  // 마스터
                {
                    ds = biz.QWK04A_FITM0202_LST_MST(oParamDic, out errMsg);
                }
                else                 // 협력사
                {
                    ds = biz.QWK04A_FITM0202_LST(oParamDic, out errMsg);
                }
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK04A_FITM0202_CNT());
                }
            }
        }
        #endregion
        ...
        #region Data조회 엑셀출력용
        void QWK04A_FITM0202_EXCEL()
        {
            string errMsg = String.Empty;

            using (FITMBiz biz = new FITMBiz())
            {
                int nCount = QWK04A_FITM0202_CNT();
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            QWK04A_FITM0202_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
