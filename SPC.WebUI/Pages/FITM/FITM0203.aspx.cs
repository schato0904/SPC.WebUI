...
{
    public partial class FITM0203 : WebUIBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                // 작업표준서 목록을 구한다
                QWK04A_FITM0203_LST(ucPager.GetPageSize(), CurrPage, false);
            }
        ...
        Int32 QWK04A_FITM0203_CNT()
        {
            using (FITMBiz biz = new FITMBiz())
            {
                ...
                totalCnt = biz.QWK04A_FITM0203_CNT(oParamDic);
            }
        ...
        #region Data조회
        void QWK04A_FITM0203_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (FITMBiz biz = new FITMBiz())
            {
                ...
                ds = biz.QWK04A_FITM0203_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK04A_FITM0203_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            CurrPage = nCurrPage;
            QWK04A_FITM0203_LST(nPageSize, CurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        protected void devGrid_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            oParamDic.Add("F_FOURCD", e.NewValues["F_FOURCD"] == null ? "" : e.NewValues["F_FOURCD"].ToString());
            ...
            using (FITMBiz biz = new FITMBiz())
            {
                    bExecute = biz.QWK04A_FITM0203_UPD(oParamDic);
            }
