...
{
    public partial class CATM1101 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM1101_Grid"] as DataTable; }
            set { Session["CATM1101_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM1101_Grid1"] as DataTable; }
            set { Session["CATM1101_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_MACHTYPECD"] = this.srcF_MACHTYPECD.GetValue();
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1101_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM1101_LST2(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_CATM1101_INS1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM1101_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM1101_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
