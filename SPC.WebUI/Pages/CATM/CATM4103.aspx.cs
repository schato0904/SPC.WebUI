...
{
    public partial class CATM4103 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM4103_Grid"] as DataTable; }
            set { Session["CATM4103_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM4103_Grid1"] as DataTable; }
            set { Session["CATM4103_Grid1"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM4103_LST1(oParamDic, out errMsg);
            }
