...
{
    public partial class CATM2123 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM2123_Grid"] as DataTable; }
            set { Session["CATM2123_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM2123_Grid1"] as DataTable; }
            set { Session["CATM2123_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_OUTSTOCKNO"] = this.srcF_OUTSTOCKNO.Text ?? "";
            result["F_OUTTYPECD"] = (this.srcF_OUTTYPECD.Value ?? "").ToString();
            result["F_OUTYMD"] = "";
            result["F_OUTDATE"] = this.srcF_OUTDATE.Text ?? "";
            result["F_MACHCD"] = (this.srcF_MACHCD.Value ?? "").ToString();
            result["F_ITEMCD"] = this.srcF_ITEMCD.Text ?? "";
            result["F_OUTCNT"] = (this.srcF_OUTCNT.Value ?? "0").ToString();
            result["F_SCRAP"] = (this.srcF_SCRAP.Value ?? "0").ToString();
        ...
        {
            var dic = new Dictionary<string, string>() { {"F_MACHTYPECD", "01"} };
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM2123_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_OUTSTOCKNO"] = dic.GetString("F_OUTSTOCKNO");
                oParamDic["F_COMPCD"] = gsCOMPCD;
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM2123_LST2(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM2123_LST3(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg, out string pkey)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                //oParamDic["F_OUTSTOCKNO"] = dic.GetString("F_OUTSTOCKNO");
                oParamDic["F_OUTTYPECD"] = dic.GetString("F_OUTTYPECD");
                oParamDic["F_OUTYMD"] = dic.GetString("F_OUTYMD");
                oParamDic["F_OUTDATE"] = dic.GetString("F_OUTDATE");
                oParamDic["F_MACHCD"] = dic.GetString("F_MACHCD");
                oParamDic["F_ITEMCD"] = dic.GetString("F_ITEMCD");
                oParamDic["F_OUTCNT"] = dic.GetString("F_OUTCNT");
                oParamDic["F_SCRAP"] = dic.GetString("F_SCRAP");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_CATM2123_INS1(oParamDic, out errMsg, out pkey);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM2123_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM2123_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
