<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1403.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1403" %>
<%-- 월수불현황 --%>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_CPLANCOUNT" Caption="당월목표량" Width="13%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_CCOUNT" Caption="당월생산량" Width="13%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
