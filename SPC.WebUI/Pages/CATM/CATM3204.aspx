<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM3204.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM3204" %>
<%-- 월수불현황 --%>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <%--<dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />--%>
                        <dx:GridViewDataColumn FieldName="F_INOUTYMD" Caption="재고월" Width="120px"/>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRECNT" Caption="전월재고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRODCOUNT" Caption="당월입고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_OUTCOUNT" Caption="당월출고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_REMAINS" Caption="당월재고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
