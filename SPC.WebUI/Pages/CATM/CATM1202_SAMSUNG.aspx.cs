...
{
    public partial class CATM1202_SAMSUNG : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM1202_Grid_SAMSUNG"] as DataTable; }
            set { Session["CATM1202_Grid_SAMSUNG"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM1202_Grid1_SAMSUNG"] as DataTable; }
            set { Session["CATM1202_Grid1_SAMSUNG"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1202_LST1_SAMSUNG(oParamDic, out errMsg);
            }
