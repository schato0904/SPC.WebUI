...
{
    public partial class CATM3111 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM3111_Grid"] as DataTable; }
            set { Session["CATM3111_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM3111_Grid1"] as DataTable; }
            set { Session["CATM3111_Grid1"] = value; }
        }

        // 우측정보
        DataTable CachedData2
        {
            get { return Session["CATM3111_Grid2"] as DataTable; }
            set { Session["CATM3111_Grid2"] = value; }
        }

        // 우측정보 상세
        DataTable CachedData3
        {
            get { return Session["CATM3111_Grid3"] as DataTable; }
            set { Session["CATM3111_Grid3"] = value; }
        }
        #endregion
        ...
        protected void devGrid1_CustomCallback(object sender, ASPxGridViewCustomCallbackEventArgs e)
        {
            if (e.Parameters.In("GET", "NEW"))
            {
                ...
                if (e.Parameters == "NEW")
                {
                    DataTable dt = this.GetDataEX1(this.srcF_ITEMCD.Text, out errMsg);
                    devGrid1.JSProperties["cpGridData"] = DataTable2EncodeJson(dt);
                }
            ...
            if (!string.IsNullOrEmpty(e.Parameter))
            {
                ...
                switch (param["action"])
                {
                    case "VIEW":
                        ...
                        dicResult["griddata"] = DataTable2EncodeJson(this.CachedData3.Copy());
                        break;
                    case "SAVE":
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_OUTORDERNO"] = this.srcF_OUTORDERNO.Text ?? "";
            result["F_OUTYMD"] = this.srcF_OUTYMD.Text ?? "";
            result["F_CUSTCD"] = (this.srcF_CUSTCD.Value ?? "").ToString();
            result["F_ORDERNO"] = this.srcF_ORDERNO.Text ?? "";
            result["F_ITEMCD"] = this.srcF_ITEMCD.Text ?? "";
            result["F_OUTCOUNT"] = this.srcF_OUTCOUNT.Text ?? "0";
            result["F_MEMO"] = this.srcF_MEMO.Text ?? "";
            result["GridData"] = this.hidGridData.Text ?? "";
        ...
        protected DataTable View(Dictionary<string, string> pDic, out string errMsg)
        {
            ...
            DataSet ds = this.GetDataRightTop(pDic, out errMsg);
            if (!string.IsNullOrEmpty(errMsg)) return null;
            this.CachedData2 = ds != null && ds.Tables.Count > 0 ? ds.Tables[0].Copy() : null;
            this.CachedData3 = ds != null && ds.Tables.Count > 1 ? ds.Tables[1].Copy() : null;
            //this.CachedData1 = dt;
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM3111_LST1(oParamDic, out errMsg);
            }
        ...
        /// <param name="errMsg"></param>
        /// <returns></returns>
        protected DataSet GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            DataSet ds = new DataSet();
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM3111_LST2(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM3111_LST3(oParamDic, out errMsg);
            }
        ...
        /// <param name="errMsg"></param>
        /// <returns></returns>
        protected DataTable GetDataEX1(string F_ITEMCD, out string errMsg)
        {
            DataTable dt = new DataTable();
            ...
            {
                oParamDic.Clear();
                oParamDic["F_ITEMCD"] = F_ITEMCD;
                oParamDic["F_COMPCD"] = gsCOMPCD;
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM3111_LST5(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg, out string pkey)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_ORDERNO"] = dic.GetString("F_ORDERNO");
                oParamDic["F_ITEMCD"] = dic.GetString("F_ITEMCD");
                oParamDic["F_OUTCOUNT"] = dic.GetString("F_OUTCOUNT");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                //result = biz.USP_CATM3111_INS1(oParamDic, out errMsg, out pkey);

                System.Web.Script.Serialization.JavaScriptSerializer js = new System.Web.Script.Serialization.JavaScriptSerializer();
                var oPd = js.Deserialize<Dictionary<string, string>[]>(HttpUtility.UrlDecode(dic.GetString("GridData")));
                if (oPd != null && oPd.Length > 0)
                {
                    foreach (var o in oPd)
                    {
                        o["F_COMPCD"] = gsCOMPCD;
                        o["F_FACTCD"] = gsFACTCD;
                        o["F_LOGINUSER"] = gsUSERID;
                        o["F_LANGTYPE"] = gsLANGTP;
                    }
                }

                result = biz.USP_CATM3111_INSERT(oParamDic, oPd.ToList(), out errMsg, out pkey);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM3111_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                //result = biz.USP_CATM3111_UPD1(oParamDic, out errMsg);
                ...
                if (oPd != null && oPd.Length > 0)
                {
                    foreach (var o in oPd)
                    {
                        o["F_OUTORDERNO"] = dic.GetString("F_OUTORDERNO");
                        o["F_COMPCD"] = gsCOMPCD;
                        o["F_FACTCD"] = gsFACTCD;
                        o["F_LOGINUSER"] = gsUSERID;
                        o["F_LANGTYPE"] = gsLANGTP;
                ...
                result = biz.USP_CATM3111_UPDATE(oParamDic, oPd.ToList(), out errMsg);
            }
            return result;
        }
        #endregion
