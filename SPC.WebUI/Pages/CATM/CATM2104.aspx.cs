...
{
    public partial class CATM2104 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM2104_Grid"] as DataTable; }
            set { Session["CATM2104_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM2104_Grid1"] as DataTable; }
            set { Session["CATM2104_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightParameter()
        {
            ...
            result["F_INOUT"] = (this.schF_INOUT.Value ?? "").ToString();
            result["F_ITEMCD"] = (this.schF_ITEMCD.Text ?? "");
            result["F_GUBUNCD"] = (this.schF_GUBUNCD.Value ?? "").ToString();
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_INOUT"] = dic.GetString("F_INOUT");
                ...
                ds = biz.USP_CATM2104_LST1(oParamDic, out errMsg);
            }
