...
{
    public partial class CATM1305 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM1305_Grid"] as DataTable; }
            set { Session["CATM1305_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM1305_Grid1"] as DataTable; }
            set { Session["CATM1305_Grid1"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1305_LST1(oParamDic, out errMsg);
            }
