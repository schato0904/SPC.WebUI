...
{
    public partial class CATM1304 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM1304_Grid"] as DataTable; }
            set { Session["CATM1304_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM1304_Grid1"] as DataTable; }
            set { Session["CATM1304_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightParameter()
        {
            ...
            result["F_MELTCD"] = this.srcF_MELTCD.Text ?? "";
            //result["F_TOYMD"] = (this.schF_TOYEAR.Value ?? "").ToString() + "-12-31";
            //result["F_MNGUSER"] = this.schF_MNGUSER1.Text;
            //result["F_LANGTYPE"] = gsLANGTP;
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_ITEMCD"] = (this.srcF_ITEMCD.Value ?? "").ToString();
            result["F_INAMT"] = this.srcF_INAMT.Text ?? "";
            result["F_INNGAMT"] = this.srcF_INNGAMT.Text ?? "";
        ...
        void BindCombo(ASPxComboBox c)
        {
            ...
            c.DataSource = dt;
            c.TextField = "F_ITEMNM";
            c.ValueField = "F_ITEMCD";
            c.DataBind();
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1304_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM1304_LST2(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM1304_LST3(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg, out string pkey)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_INAMT"] = dic.GetString("F_INAMT");
                oParamDic["F_INNGAMT"] = dic.GetString("F_INNGAMT");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_CATM1304_INS1(oParamDic, out errMsg, out pkey);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM1304_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM1304_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected DataTable GetDataCombo(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                oParamDic.Clear();
                oParamDic["F_SEARCHTEXT"] = dic.GetString("F_SEARCHTEXT");
                oParamDic["F_GUBUNCD"] = dic.GetString("F_GUBUNCD");
                oParamDic["F_USEYN"] = "1";
                oParamDic["F_COMPCD"] = gsCOMPCD;
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM2002_LST3(oParamDic, out errMsg);
            }
