<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM4104.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM4104" %>
<%-- 금형사용현황 조회 --%>
            ...
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:75%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="schF_MOLDNTH" ClientInstanceName="schF_MOLDNTH" ClientEnabled="true" Width="100%">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_PLANYMD" Caption="작업일자" Width="120px"/>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_MACHNM" Caption="주조기" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="품번" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_PLANCOUNT" Caption="보증사용수" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_PRODCOUNT" Caption="사용수" Width="120px"/>                        
