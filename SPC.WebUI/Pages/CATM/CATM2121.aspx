<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2121.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2121" %>
<%-- 원재료 입고등록(2019.11.12) --%>
            ...
            <div id="divLeftTop" style="width:100%;">
                <table class="InputTable" style="margin-bottom: 5px;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <ucCTF:SYCOD01 runat="server" id="srcF_GUBUNCD" ClientInstanceName="srcF_GUBUNCD" F_CODEGROUP="48" nullText="--선택하세요--" IsRequired="false"></ucCTF:SYCOD01>
            ...
            <div id="divMiddle" style="margin-bottom:10px;">
                <table class="InputTable" style="margin-bottom: 5px;width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="srcF_LOTNO" ClientInstanceName="srcF_LOTNO" ClientEnabled="false" Width="100%">
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_INDATE" Caption="입고일시" Width="140px"/>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_INCNT" Caption="입고수량" Width="80px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataColumn FieldName="F_LOTNO" Caption="LOT No." Width="120px"/>
