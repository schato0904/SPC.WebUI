...
{
    public partial class CATM4104 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM4104_Grid"] as DataTable; }
            set { Session["CATM4104_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM4104_Grid1"] as DataTable; }
            set { Session["CATM4104_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightParameter()
        {
            ...
            result["F_MOLDNTH"] = (this.schF_MOLDNTH.Text ?? "0");
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM4104_LST1(oParamDic, out errMsg);
            }
