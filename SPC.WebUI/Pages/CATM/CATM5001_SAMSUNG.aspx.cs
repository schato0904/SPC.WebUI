...
{
    public partial class CATM5001_SAMSUNG : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM5001_Grid_SAMSUNG"] as DataTable; }
            set { Session["CATM5001_Grid_SAMSUNG"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM5001_Grid1_SAMSUNG"] as DataTable; }
            set { Session["CATM5001_Grid1_SAMSUNG"] = value; }
        }
        #endregion
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            //s2 = new Series("상한", ViewType.Line);
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM5001_LST1_SAMSUNG(oParamDic, out errMsg);
            }
