...
{
    public partial class CATM3131 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM3131_Grid"] as DataTable; }
            set { Session["CATM3131_Grid"] = value; }
        }
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM3131_LST1(oParamDic, out errMsg);
            }
