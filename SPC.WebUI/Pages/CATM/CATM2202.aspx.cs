...
{
    public partial class CATM2202 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM2202_Grid"] as DataTable; }
            set { Session["CATM2202_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM2202_Grid1"] as DataTable; }
            set { Session["CATM2202_Grid1"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM2202_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM2202_LST3(oParamDic, out errMsg);
            }
