...
{
    public partial class CATM3102 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM3102_Grid"] as DataTable; }
            set { Session["CATM3102_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM3102_Grid1"] as DataTable; }
            set { Session["CATM3102_Grid1"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM3102_LST1(oParamDic, out errMsg);
            }
