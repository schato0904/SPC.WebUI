...
{
    public partial class CATM1302 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM1302_Grid"] as DataTable; }
            set { Session["CATM1302_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM1302_Grid1"] as DataTable; }
            set { Session["CATM1302_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightParameter()
        {
            ...
            result["F_WORKNO"] = (this.schF_WORKNO.Text ?? "");
            result["F_LOTNO"] = (this.schF_LOTNO.Text ?? "");
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1302_LST1(oParamDic, out errMsg);
            }
