...
{
    public partial class CATM2002 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM2002_Grid"] as DataTable; }
            set { Session["CATM2002_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM2002_Grid1"] as DataTable; }
            set { Session["CATM2002_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_ITEMNM"] = this.srcF_ITEMNM.Text ?? "";
            result["F_GUBUNCD"] = this.srcF_GUBUNCD.GetValue();
            result["F_UNIT"] = this.srcF_UNIT.Text ?? "";
            result["F_NEEDCOUNT"] = this.srcF_NEEDCOUNT.Text ?? "";
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM2002_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM2002_LST2(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                oParamDic.Clear();
                oParamDic["F_ITEMCD"] = dic.GetString("F_ITEMCD");
                oParamDic["F_ITEMNM"] = dic.GetString("F_ITEMNM");
                oParamDic["F_GUBUNCD"] = dic.GetString("F_GUBUNCD");
                oParamDic["F_UNIT"] = dic.GetString("F_UNIT");
                oParamDic["F_NEEDCOUNT"] = dic.GetString("F_NEEDCOUNT");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_CATM2002_INS1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM2002_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM2002_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
