...
{
    public partial class CATM3201 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM3201_Grid"] as DataTable; }
            set { Session["CATM3201_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM3201_Grid1"] as DataTable; }
            set { Session["CATM3201_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightParameter()
        {
            ...
            //result["F_ORDERNO"] = (this.schF_ORDERNO.Text ?? "");
        ...
        void BindCombo(ASPxComboBox c)
        {
            ...
            dic["F_CUSTTYPECD"] = "02";
            //dic["F_CUSTTYPECD"] = (c.ClientInstanceName == "schF_CUSTCD") ? "02" : (c.ClientInstanceName == "schF_MELTCD") ? "01" : "";
            string errMsg = string.Empty;
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM3201_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataCombo(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM3001_LST3(oParamDic, out errMsg);
            }
