...
{
    public partial class CATM3001 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM3001_Grid"] as DataTable; }
            set { Session["CATM3001_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM3001_Grid1"] as DataTable; }
            set { Session["CATM3001_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_CUSTCD"] = this.srcF_CUSTCD.Text ?? "";
            result["F_CUSTNM"] = this.srcF_CUSTNM.Text ?? "";
            result["F_CUSTTYPECD"] = this.srcF_CUSTTYPECD.Text ?? "";
            result["F_ADDR"] = this.srcF_ADDR.Text ?? "";
            result["F_TEL"] = this.srcF_TEL.Text ?? "";
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM3001_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM3001_LST2(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                oParamDic.Clear();
                oParamDic["F_CUSTCD"] = dic.GetString("F_CUSTCD");
                oParamDic["F_CUSTNM"] = dic.GetString("F_CUSTNM");
                oParamDic["F_CUSTTYPECD"] = dic.GetString("F_CUSTTYPECD");
                oParamDic["F_ADDR"] = dic.GetString("F_ADDR");
                oParamDic["F_TEL"] = dic.GetString("F_TEL");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_CATM3001_INS1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM3001_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM3001_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
