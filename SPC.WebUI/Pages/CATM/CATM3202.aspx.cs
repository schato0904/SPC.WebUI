...
{
    public partial class CATM3202 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM3202_Grid"] as DataTable; }
            set { Session["CATM3202_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM3202_Grid1"] as DataTable; }
            set { Session["CATM3202_Grid1"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM3202_LST1(oParamDic, out errMsg);
            }
