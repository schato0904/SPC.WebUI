...
{
    public partial class PopRptCATM1201_SAMSUNG : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            RptCATM1201_SAMSUNG report = new RptCATM1201_SAMSUNG(dic);
        ...
        protected Dictionary<string, string> GetData(string F_WORKNO, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1201_LST4_SAMSUNG(oParamDic, out errMsg);
            }
