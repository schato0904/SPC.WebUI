...
{
    public partial class PopRptCATM1305 : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            //var dic = this.GetData(this.popParam.GetString("F_WORKYMD"), out errMsg);
            ...
            RptCATM1305 report = new RptCATM1305(dic);
