...
{
    public partial class PopRptCATM3101 : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            //RptCATM3101 report = new RptCATM3101(this.gsCOMPCD, this.gsFACTCD, this.popParam.GetString("F_OUTORDERNO"), this.gsLANGTP);
            string errMsg = string.Empty;
            var dic = this.GetData(this.popParam.GetString("F_OUTORDERNO"), out errMsg);
            if (!string.IsNullOrWhiteSpace(errMsg)) throw new Exception(errMsg);
            RptCATM3101 report = new RptCATM3101(dic);
        ...
        /// 데이터 조회
        /// </summary>
        /// <param name="F_OUTORDERNO"></param>
        /// <param name="errMsg"></param>
        /// <returns></returns>
        protected Dictionary<string, string> GetData(string F_OUTORDERNO, out string errMsg)
        {
            errMsg = string.Empty;
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_OUTORDERNO"] = F_OUTORDERNO;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM3101_LST4(oParamDic, out errMsg);
            }
