...
{
    public partial class CATM4102 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM4102_Grid"] as DataTable; }
            set { Session["CATM4102_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM4102_Grid1"] as DataTable; }
            set { Session["CATM4102_Grid1"] = value; }
        }
        #endregion
        ...
        protected void devCallback_Callback(object source, CallbackEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(e.Parameter))
            {
                ...
                dicResult["gridhtml"] = "";
                //var F_MOLDNO = param.GetString("F_MOLDNO", "0");
                switch (param["action"])
                {
                    case "VIEW":
                        // 우측 내용 조회
        ...
        protected Dictionary<string, string> GetLeftParameter()
        {
            ...
            result["F_MOLDNO"] = (this.schF_MOLDNO.Value ?? "").ToString() ;
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_SEQ"] = this.srcF_SEQ.Text ?? "0";
            result["F_MOLDNO"] = this.srcF_MOLDNO.Text ?? "";
            result["F_MOLDNTH"] = this.srcF_MOLDNTH.Text ?? "";
            result["F_FIXYMD"] = this.srcF_FIXYMD.Text ?? "";
            result["F_FIXTYPECD"] = this.srcF_FIXTYPECD.GetValue();
            result["F_FIXCOST"] = this.srcF_FIXCOST.Text ?? "";
            result["F_FIXDAYS"] = this.srcF_FIXDAYS.Text ?? "";
        ...
        protected DataTable View(string pkey, out string errMsg)
        {
            ...
            Dictionary<string, string> dic = new Dictionary<string, string>();
            dic["F_SEQ"] = pkey;
            dic["F_MOLDNO"] = srcF_MOLDNO.Text ?? "";
            dic["F_MOLDNTH"] = srcF_MOLDNTH.Text ?? "";
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM4102_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_SEQ"] = dic.GetString("F_SEQ", "0");
                oParamDic["F_COMPCD"] = gsCOMPCD;
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM4102_LST2(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM4102_LST3(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg, out string pkey)
        {
            ...
            {
                oParamDic.Clear();
                //oParamDic["F_SEQ"] = dic.GetString("F_SEQ");
                oParamDic["F_MOLDNO"] = dic.GetString("F_MOLDNO");
                oParamDic["F_MOLDNTH"] = dic.GetString("F_MOLDNTH");
                oParamDic["F_FIXYMD"] = dic.GetString("F_FIXYMD");
                oParamDic["F_FIXTYPECD"] = dic.GetString("F_FIXTYPECD");
                oParamDic["F_FIXCOST"] = dic.GetString("F_FIXCOST");
                oParamDic["F_FIXDAYS"] = dic.GetString("F_FIXDAYS");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_CATM4102_INS1(oParamDic, out errMsg, out pkey);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM4102_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                result = biz.USP_CATM4102_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
