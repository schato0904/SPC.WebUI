...
{
    public partial class CATM5002 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM5002_Grid"] as DataTable; }
            set { Session["CATM5002_Grid"] = value; }
        }

        // 상단목록
        DataTable CachedData1
        {
            get { return Session["CATM5002_Grid1"] as DataTable; }
            set { Session["CATM5002_Grid1"] = value; }
        }
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            c.Series.Clear();
            Series s = new Series("금형上온도", ViewType.Line);
        ...
        protected void devChart2_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            //s.DataSource = dt;
            c.Series.Add(s);
            s = new Series("응고시간", ViewType.Line);
            (s.View as LineSeriesView).LineMarkerOptions.Size = 3;
            s.ArgumentDataMember = "F_WORKTIME";
        ...
        #region devGrid2_HtmlDataCellPrepared
        protected void devGrid2_HtmlDataCellPrepared(object sender, ASPxGridViewTableDataCellEventArgs e)
        {
        ...
        protected Dictionary<string, string> GetRightParameter()
        {
            ...
            result["F_AUTO"] = (this.schF_AUTO.Value ?? "").ToString();
