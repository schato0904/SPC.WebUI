...
{
    public partial class CATM1403 : WebUIBasePage
    {
        ...
        {
            get { return Session["CATM1403_Grid"] as DataTable; }
            set { Session["CATM1403_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["CATM1403_Grid1"] as DataTable; }
            set { Session["CATM1403_Grid1"] = value; }
        }
        #endregion
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                ds = biz.USP_CATM1403_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightBody(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (CATMBiz biz = new CATMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_CATM1403_LST3(oParamDic, out errMsg);
            }
