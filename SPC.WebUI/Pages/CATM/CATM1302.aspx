<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1302.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1302" %>
<%-- 생산실적 조회 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnSearchClick() {
            ...
            if (schF_MACHCD.GetValue() == null || schF_MACHCD.GetValue() == '') {
                ...
                test = schF_MACHCD.GetValue();
            }

            var KEY = schF_FROMYMD.GetText() + '|' + schF_TOYMD.GetText() + '|'
                + test + '|' + schF_ITEMCD.GetText() + '|' + schF_WORKNO.GetText() + '|' + schF_LOTNO.GetText() + '|' + schF_MOLDNO.GetText();
        ...
        function fn_OnPrintClick() {
            var key = hidKEY.GetText();

            fn_OnPopRptCATM1302('생산일보',key,'');
        }

        function fn_OnPopRptCATM1302(TITLE, KEY, parentCallbackName) {
            ...
            pPage = './Popup/PopRptCATM1302.aspx' +
    ...
    <script type="text/javascript">
        ...
        function devGrid1_RowDblClick(s, e) {
            fn_OnPopupCATM1302(devGrid1.GetRowKey(e.visibleIndex));
        }
    </script>
</asp:Content>
        ...
        <div id="divRight" style="width:100%;">
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:84%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="schF_LOTNO" ClientInstanceName="schF_LOTNO" ClientEnabled="true" Width="100%">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                            </div>
                        </td>
                        ...
                        <td class="tdContent">
                            <div style="width:84%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="schF_WORKNO" ClientInstanceName="schF_WORKNO" ClientEnabled="true" Width="100%">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width:100%;">
                ...
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_COMPCD;F_FACTCD;F_ENDYMD;F_MACHNM;F_ITEMCD;F_WORKNO;F_MOLDNO;F_MOLDNTH;F_LOTNO;F_PRODCOUNT;F_ERRCOUNT" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        <dx:GridViewDataColumn FieldName="No" Caption="No" Width="3%" />
                        <dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_PLANYMD" Caption="지시일" Width="7%"/>
                        <dx:GridViewDataTextColumn FieldName="F_ENDYMD" Caption="완료일" Width="7%"/>
                        <dx:GridViewDataColumn FieldName="F_MACHNM" Caption="설비명" Width="7%"/>
                        <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="생산품번" Width="11%"/>
                        <dx:GridViewDataColumn FieldName="F_WORKNO" Caption="작업지시번호" Width="7%"/>
                        <dx:GridViewDataColumn FieldName="F_LOTNO" Caption="Lot No." Width="7%"/>
                        <%--<dx:GridViewDataTextColumn FieldName="F_WORKNO_SEQ" Caption="작업순서" Width="70px"/>--%>
                        <dx:GridViewDataColumn FieldName="F_MOLDNO" Caption="금형번호" Width="7%"/>
                        <dx:GridViewDataColumn FieldName="F_MOLDNTH" Caption="금형차수" Width="4%"/>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_PLANCOUNT" Caption="지시수량" Width="7%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}" />
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRODCOUNT" Caption="생산수량" Width="7%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_ERRCOUNT" Caption="불량수량" Width="7%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_SDATETIME" Caption="지시시작시간" Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_EDATETIME" Caption="지시종료시간" Width="90px"/>--%>
                    </Columns>
                </dx:ASPxGridView>
