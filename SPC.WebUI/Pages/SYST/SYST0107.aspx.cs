...
{
    public partial class SYST0107 : WebUIBasePage
    {
        ...
        DataTable SYCOD01_LST(string sCODEGROUP)
        {
            string errMsg = String.Empty;
            ...
            dtTable.Rows.Add("cybertechfriend", "기본제공양식(CTF)");
        ...
        {
            DevExpress.Web.GridViewDataComboBoxColumn comboBox = devGrid.Columns["F_REMARK"] as DevExpress.Web.GridViewDataComboBoxColumn;
            ...
            comboBox.PropertiesComboBox.DataSource = SYCOD01_LST("92");
        }
        #endregion
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            //devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 고객사정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
