...
{
    public partial class SYST0104 : WebUIBasePage
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            //devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 직위정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
