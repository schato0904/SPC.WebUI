<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="COMPPOP2.aspx.cs" Inherits="SPC.WebUI.Pages.COMM.Popup.COMPPOP2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnRowDblClick(s, e) {
            ...
            parent.fn_OnSettingComp2(rowKey);
    ...
    <div class="container">
        ...
        <div style="padding-top: 10px;">
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_COMPNM;F_REGION;F_TELNO;F_ADDRESS;F_BIGO;" EnableViewState="false" EnableRowsCache="false"
