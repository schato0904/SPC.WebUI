...
{
    public partial class WSTA0103 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WSTA0103"];
            }
            set
            {
                Session["WSTA0103"] = value;
            }
        }
        DataTable dtgrid2
        {
            get
            {
                return (DataTable)Session["WSTA0103_2"];
            }
            set
            {
                Session["WSTA0103_2"] = value;
            }
        }
        #endregion
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WSTABiz biz = new WSTABiz())
            {
                ...
                oParamDic.Add("F_IMPORT", (chkImport.Checked ? "1" : ""));
                ds = biz.QWK03A_WSTA0103_LST(oParamDic, out errMsg);
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 공정능력 Worst 정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
