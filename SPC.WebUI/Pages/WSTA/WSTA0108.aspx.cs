...
{
    public partial class WSTA0108 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WSTA0108"];
            }
            set
            {
                Session["WSTA0108"] = value;
            }
        }
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["WSTA0108_1"];
            }
            set
            {
                Session["WSTA0108_1"] = value;
            }
        }
        ...
        DataTable dtGrid1
        {
            get
            {
                return (DataTable)Session["WSTA0108_2"];
            }
            set
            {
                Session["WSTA0108_2"] = value;
            }
        }
        #endregion
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WSTABiz biz = new WSTABiz())
            {
                ...
                ds = biz.QWK03A_WSTA0108_LST(oParamDic, out errMsg);
            }
