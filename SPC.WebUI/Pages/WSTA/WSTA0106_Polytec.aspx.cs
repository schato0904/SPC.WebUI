...
{
    public partial class WSTA0106_Polytec : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WSTA0102"];
            }
            set
            {
                Session["WSTA0102"] = value;
            }
        }
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["WSTA0102_1"];
            }
            set
            {
                Session["WSTA0102_1"] = value;
            }
        }
        DataTable dtgrid1
        {
        ...
        DataTable dtgrid2
        {
            get
            {
                return (DataTable)Session["WSTA0102_2"];
            }
            set
            {
                Session["WSTA0102_2"] = value;
            }
        }
        #endregion
        ...
        #region Data조회
        void WSTA0106_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WSTABiz biz = new WSTABiz())
            {
                ...
                ds = biz.QWK03A_WSTA0106_LST(oParamDic, out errMsg);
            }
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart1 != null)
            {
                ...
                //DevExpressLib.SetChartLineSeries(devChart1, "시료수", "F_SEQ", "누적점유율", System.Drawing.Color.Red);

                Series series = new Series("점유율", ViewType.Point) { ArgumentDataMember = "F_SEQ" };
                series.ValueDataMembers.AddRange(new string[] { "F_GRAPH" });
                ...
                Series series2 = new Series("누적점유율", ViewType.Point) { ArgumentDataMember = "F_SEQ" };
                series2.ValueDataMembers.AddRange(new string[] { "누적점유율" });
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            WSTA0106_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
            //dtChart1 = ds.Tables[1].Copy();
            //dtgrid1 = ds.Tables[2].Copy();
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 항목별 Worst 정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
        ...
        protected void devChart2_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart2 != null)
            {
                ...
                //PieSeriesLabel pl = new PieSeriesLabel();

                //pl.Position = PieSeriesLabelPosition.TwoColumns;
                ...
                //{
                //    series.Points.Add(new SeriesPoint(dtChart2.Rows[i]["불량원인"].ToString(), new double[] { Convert.ToDouble(dtChart2.Rows[i]["부적합율"]) }));
                //}
                DevExpressLib.SetChartPieSeries(devChart2, "", "불량원인", "부적합율", "{A}: {V:n2}");
                //devChart2.Series.Add(series);
                //devChart2.Legend.Visibility = DevExpress.Utils.DefaultBoolean.False;

                //devChart2.PaletteName = "Blue Warm";
                devChart2.Legend.Visibility = DevExpress.Utils.DefaultBoolean.True;
                devChart2.Series[0].LabelsVisibility = DevExpress.Utils.DefaultBoolean.False;
