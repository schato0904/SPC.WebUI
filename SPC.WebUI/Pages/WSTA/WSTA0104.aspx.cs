...
{
    public partial class WSTA0104 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WSTA0104"];
            }
            set
            {
                Session["WSTA0104"] = value;
            }
        }
        ...
        DataTable dtGrid1
        {
            get
            {
                return (DataTable)Session["WSTA0104_1"];
            }
            set
            {
                Session["WSTA0104_1"] = value;
            }
        }
        #endregion
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WSTABiz biz = new WSTABiz())
            {
                ...
                oParamDic.Add("F_YYYY", GetWeekYear());
                oParamDic.Add("F_FROMWK", GetWeekFrom());
                oParamDic.Add("F_TOWK", GetWeekTO());
                oParamDic.Add("F_WORKCD", GetWorkPOPCD());
                oParamDic.Add("F_ITEMCD", GetItemCD());
                oParamDic.Add("F_SERIALNO", this.txtSERIALNO.Value.ToString());
                ds = biz.QWK03A_WSTA0104_LST(oParamDic, out errMsg);
            }
            ...
            //{
            //    dtPivotTable.Columns[i].ColumnName = dtPivotTable.Columns[i].ColumnName + "Week";
            //}
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart1 != null)
            {
                ...
                DevExpress.XtraCharts.XYDiagram diagram = (DevExpress.XtraCharts.XYDiagram)devChart1.Diagram;
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 주별분석정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
