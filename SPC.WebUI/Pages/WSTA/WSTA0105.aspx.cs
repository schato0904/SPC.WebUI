...
{
    public partial class WSTA0105 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WSTA0105"];
            }
            set
            {
                Session["WSTA0105"] = value;
            }
        }
        DataTable dtGrid1
        {
            get
            {
                return (DataTable)Session["WSTA0105_1"];
            }
            set
            {
                Session["WSTA0105_1"] = value;
            }
        }
        #endregion
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WSTABiz biz = new WSTABiz())
            {
                ...
                ds = biz.QWK03A_WSTA0105_LST(oParamDic, out errMsg);
            }
