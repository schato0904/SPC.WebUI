...
{
    public partial class WSTA0102_DACO : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WSTA0102_DACO"];
            }
            set
            {
                Session["WSTA0102_DACO"] = value;
            }
        }
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["WSTA0102_DACO_1"];
            }
            set
            {
                Session["WSTA0102_DACO_1"] = value;
            }
        }
        DataTable dtgrid1
        {
        ...
        DataTable dtgrid2
        {
            get
            {
                return (DataTable)Session["WSTA0102_DACO_2"];
            }
            set
            {
                Session["WSTA0102_DACO_2"] = value;
            }
        }
        #endregion
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WSTABiz biz = new WSTABiz())
            {
                ...
                ds = biz.QWK03A_WSTA0102_LST(oParamDic, out errMsg);
            }
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart1 != null)
            {
                ...
                DevExpressLib.SetChartDiagram(devChart1, true, 0, 0, null, null, null,"{V:##}");
        ...
        protected void devChart2_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            else
            {
                ...
                using (WSTABiz biz = new WSTABiz())
                {
                    ...
                    oParamDic.Add("F_SERIALNO", oParams[3]);
                    ds = biz.QWK03A_WSTA0102_CHART_LST(oParamDic, out errMsg);
                }
                ...
                if (bExistsDataSet(ds))
                {
                    ...
                    {
                        series.Points.Add(new SeriesPoint(dtChart2.Rows[i]["F_WORKDATE"].ToString(), new double[] { Convert.ToDouble(dtChart2.Rows[i]["F_REJRATE"]) }));
                    }
