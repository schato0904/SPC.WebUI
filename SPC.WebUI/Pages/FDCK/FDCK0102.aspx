<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="FDCK0102.aspx.cs" Inherits="SPC.WebUI.Pages.FDCK.FDCK0102" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_INSPCD", s, e);
            fn_OnBatchValidate("F_INSPNM", s, e);
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {                
                var editor = s.GetEditor('F_INSPCD');
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_INSPCD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_INSPCD" Caption="점검항목코드" Width="100px">
                        <PropertiesTextEdit MaxLength="12" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_INSPNM" Caption="점검항목명" Width="400px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                        <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataColumn>                    
                    <dx:GridViewDataTextColumn FieldName="F_SORTNO" Caption="순번" Width="80px">
                    </dx:GridViewDataTextColumn>
