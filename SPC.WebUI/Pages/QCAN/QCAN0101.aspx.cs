...
{
    public partial class QCAN0101 : WebUIBasePage
    {
        ...
        Int32 QWK04A_ADTR0402_CNT()
        {
            using (QCANBiz biz = new QCANBiz())
            {
                ...
                totalCnt = biz.QWK03A_QCAN0101_CNT(oParamDic);
            }
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (QCANBiz biz = new QCANBiz())
            {
                ...
                ds = biz.QWK03A_QCAN0101_LST(oParamDic, out errMsg);
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid2.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 품목별공정능력정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
