<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="QCAN0103.aspx.cs" Inherits="SPC.WebUI.Pages.QCAN.QCAN0103" %>
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-2 control-label">관리한계</label>
                        <div class="col-sm-3">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewBandColumn Caption="규격">
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="F_MAX"  Caption="USL" Width="70px" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" ClientInstanceName="F_CAUSECD" >
                                    </PropertiesTextEdit>                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_MIN" Caption="LSL" Width="70px"   >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" ClientInstanceName="F_CONTENTS" />
                                    <CellStyle HorizontalAlign="Left" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_STANDARD" Caption="CL" Width="70px" >
                    ...
                    <dx:GridViewBandColumn Caption="관리한계">
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="F_UCLX"  Caption="UCL" Width="70px" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false">
                                    </PropertiesTextEdit>                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_LCLX" Caption="LCL" Width="70px"   >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false"/>
                                    <CellStyle HorizontalAlign="Left" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_UCLR" Caption="R" Width="70px" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                            </Columns>
                        </dx:GridViewBandColumn>

                    <dx:GridViewDataColumn FieldName="F_GBNM" Caption="구분" Width="70px"  />

                    <dx:GridViewBandColumn Caption="공정능력">
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="F_DATA1"  Caption="1" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" >
                                    </PropertiesTextEdit>                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA2" Caption="2" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2"  >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA3" Caption="3" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA4" Caption="4" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA5" Caption="5" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA6" Caption="6" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA7" Caption="7" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA8" Caption="8" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA9" Caption="9" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA10" Caption="10" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA11" Caption="11" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn FieldName="F_DATA12" Caption="12" Width="70px" Visible="false" PropertiesTextEdit-DisplayFormatString="n2" >
                                    <PropertiesTextEdit ConvertEmptyStringToNull="false" />                            
                                </dx:GridViewDataTextColumn>
                            </Columns>
                    </dx:GridViewBandColumn>
             ...
             <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품목코드"  Width="150px" />
                    <dx:GridViewDataColumn FieldName="F_ITEMNM" Caption="품목명"     >
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_BANNM" Caption="반명"  Width="120px"  />
                    <dx:GridViewDataColumn FieldName="F_INSPDETAIL" Caption="검사항목"  >
