...
{
    public partial class QCAN0106 : WebUIBasePage
    {
        ...
        DataSet dsGrid
        {
            get
            {
                return (DataSet)Session["QCAN0106"];
            }
            set
            {
                Session["QCAN0106"] = value;
            }
        }
        #endregion
        ...
        void QWK04A_QCAN0106_LST()
        {
            ...
            using (QCANBiz biz = new QCANBiz())
            {
                ...
                ds = biz.QWK04A_QCAN0106_LST(oParamDic, out errMsg);
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 항목별품질정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
