...
{
    public partial class WERD0202 : WebUIBasePage
    {
        ...
        Int32 PRIN1002_IN01M_CNT()
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                totalCnt = biz.WERD0202_CNT(oParamDic);
            }
        ...
        void PRIN1002_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                oParamDic.Add("F_WORKCD", GetWorkPOPCD1());
                oParamDic.Add("F_ITEMCD", GetItemCD1());
                ds = biz.WERD0202_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, PRIN1002_IN01M_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            PRIN1002_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            PRIN1002_LST(nPageSize, nCurrPage, true);
            devGridExporter.WriteXlsToResponse(String.Format("공정불량등록조회_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
            ...
            if (e.SummaryProcess == DevExpress.Data.CustomSummaryProcess.Finalize)
            {
                ...
                switch (item.FieldName)
                {
                    ...
                    case "F_NGQTY":
                        ...
                        break;
                    case "F_PPM":
                        e.TotalValue = Math.Round(totalNgCnt * 1000000.0 / totalPrdCnt,0).ToString();;
                        break;
                    case "F_NGRATE":
