...
{
    public partial class WERD0308 : WebUIBasePage
    {
        ...
        {
            new ASPxGridViewCellMerger(devGrid, "F_USERID|F_USERNM");
        }
        #endregion
        ...
        Int32 WERD0308_CNT()
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                totalCnt = biz.WERD0308_CNT(oParamDic);
            }
        ...
        void WERD0308LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                oParamDic.Add("F_TODT", this.ucDate.GetToDt());
                oParamDic.Add("F_USERID", ucUser.GetValue());
                ds = biz.WERD0308_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, WERD0308_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            WERD0308LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            WERD0308LST(nPageSize, nCurrPage, true);
            devGridExporter.WriteXlsToResponse(String.Format("작업자별집계현황_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
        ...
        protected void devGrid_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            ...
            if (e.SummaryProcess == DevExpress.Data.CustomSummaryProcess.Calculate)
            {
                ...
                totalLossamt += Convert.ToInt32(grid.GetRowValues(currRow, "F_LOSSAMT"));
            }
            ...
            if (e.SummaryProcess == DevExpress.Data.CustomSummaryProcess.Finalize)
            {
                ...
                switch (item.FieldName)
                {
                    ...
                    case "F_NGQTY":
                        ...
                        break;
                    case "F_LOSSAMT":
                        e.TotalValue = totalLossamt;
                        break;
                    case "F_NGRATE":
                        totalRate = totalNgCnt * 100.0 / totalPrdCnt;

                        if (!double.IsNaN(totalNgCnt))
                            e.TotalValue = Math.Round(totalRate,2);
                        break;
                    case "F_PPM":
                        totalRate = Math.Round(totalNgCnt * 1000000.0 / totalPrdCnt,0);
