...
{
    public partial class WERD3001 : WebUIBasePage
    {
        ...
        {
            new ASPxGridViewCellMerger(devGrid2, "F_WORKNM|F_PRODUCTQTY|F_INSPQTY|F_NGQTY|F_NGRATE|F_PPM|F_LOSSAMT");
        }
        ...
        Int32 PRIN3001_CNT(int nSchGbn)
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                if (nSchGbn == 0)
                {
                    totalCnt = biz.WERD0301_WORK_CNT(oParamDic);
                }
                else
                {
                    totalCnt = biz.WERD0301_NG_CNT(oParamDic);
                }
            }
        ...
        void PRIN3001_LST(int nPageSize, int nCurrPage, int nSchGbn, bool bCallback, bool bPrint = false)
        {
            string errMsg = String.Empty;
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                if (nSchGbn == 0)
                {
                    ds = biz.WERD0301_WORK_LST(oParamDic, out errMsg);
                }
                else
                {
                    ds = biz.WERD0301_NG_LST(oParamDic, out errMsg);
                }
            }
            ...
            else if (bPrint)
            {
                ...
                devGridExporter.WriteXlsToResponse(String.Format("공정별부적합집계({0})[{1} ~ {2}]", title, ucDate.GetFromDt(), ucDate.GetToDt())
            ...
            else
            {
                ...
                else
                {
                    ...
                    grid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, PRIN3001_CNT(nSchGbn));
                }
            }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            PRIN3001_LST(nPageSize, nCurrPage, nSchGbn, true);
        }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            PRIN3001_LST(PRIN3001_CNT(nSchGbn), 1, nSchGbn, false, true);
        }
        #endregion
