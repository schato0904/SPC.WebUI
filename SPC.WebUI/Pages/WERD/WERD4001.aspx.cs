...
{
    public partial class WERD4001 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WERD4001"];
            }
            set
            {
                Session["WERD4001"] = value;
            }
        }
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["WERD4001_1"];
            }
            set
            {
                Session["WERD4001_1"] = value;
            }
        }
        DataTable dtChart3
        {
            get
            {
                return (DataTable)Session["WERD4001_TYPE"];
            }
            set
            {
                Session["WERD4001_TYPE"] = value;
            }
        }
        DataTable dtChart4
        {
            get
            {
                return (DataTable)Session["WERD4001_2"];
            }
            set
            {
                Session["WERD4001_2"] = value;
            }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                devChart1.JSProperties["cpResult"] = "";

                devChart2.JSProperties["cpResultCode"] = "";
                devChart2.JSProperties["cpResultMsg"] = "";
                devChart2.JSProperties["cpResult"] = "";
        ...
        void WERD4001_LST()
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                ds = biz.WERD4001_LST(oParamDic, out errMsg);
            }
        ...
        protected void devChart2_Drawing()
        {
            ...
            if (dtChart2 != null)
            {
                ...
                {
                    series.Points.Add(new SeriesPoint(dtChart2.Rows[i]["F_TYPENM"].ToString(), new double[] { Convert.ToDouble(dtChart2.Rows[i]["F_COUNT"]) }));
                }
        ...
        protected void devGrid_HtmlRowPrepared(object sender, DevExpress.Web.ASPxGridViewTableRowEventArgs e)
        {
            ...
            GridViewDataRowStyle row = new GridViewDataRowStyle();
