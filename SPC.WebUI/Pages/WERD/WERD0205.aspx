<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD0205.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD0205" %>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_BANCD" Caption="반코드" Width="80px"  CellStyle-HorizontalAlign="Center"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_BANNM" Caption="반명" Width="100px"  CellStyle-HorizontalAlign="Left"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_LINECD" Caption="라인코드" Width="80px"  CellStyle-HorizontalAlign="Center"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_LINENM" Caption="라인명" Width="100px"  CellStyle-HorizontalAlign="Left"></dx:GridViewDataColumn>
                ...
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="F_BANCD" Visible="false" />
                    <dx:ASPxSummaryItem FieldName="F_BANNM" Visible="false" />
                    <dx:ASPxSummaryItem FieldName="F_LINECD" Visible="false" />
                    <dx:ASPxSummaryItem FieldName="F_LINENM" Visible="false" />
