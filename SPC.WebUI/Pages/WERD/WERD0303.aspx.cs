...
{
    public partial class WERD0303 : WebUIBasePage
    {
        ...
        {
            // new ASPxGridViewCellMerger(devGrid1, "F_MODELCD|F_MODELNM|F_WORKNM|F_ITEMNM|F_PRODUCTQTY|F_INSPQTY|F_NGQTY|F_NGRATE|F_LOSSAMT");
            new ASPxGridViewCellMerger(devGrid2, "F_MODELCD|F_MODELNM|F_WORKNM|F_ITEMNM|F_PRODUCTQTY|F_INSPQTY|F_NGQTY|F_NGRATE|F_PPM|F_LOSSAMT");
        }
        ...
        Int32 WERD0303_CNT(int nSchGbn)
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                if (nSchGbn == 0)
                {
                    totalCnt = biz.WERD0303_WORK_CNT(oParamDic);
                }
                else
                {
                    totalCnt = biz.WERD0303_NG_CNT(oParamDic);
                }
            }
        ...
        void WERD0303_LST(int nPageSize, int nCurrPage, int nSchGbn, bool bCallback, bool bPrint = false)
        {
            string errMsg = String.Empty;
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                if (nSchGbn == 0)
                {
                    ds = biz.WERD0303_WORK_LST(oParamDic, out errMsg);
                }
                else
                {
                    ds = biz.WERD0303_NG_LST(oParamDic, out errMsg);
                }
            }
            ...
            else if (bPrint)
            {
                ...
                devGridExporter.WriteXlsToResponse(String.Format("모델별부적합집계({0})[{1} ~ {2}]", title, ucDate.GetFromDt(), ucDate.GetToDt())
            ...
            else
            {
                ...
                else
                {
                    ...
                    grid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, WERD0303_CNT(nSchGbn));
                }
            }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            WERD0303_LST(nPageSize, nCurrPage, nSchGbn, true);
        }

        #endregion

        #region devGrid_CustomSummaryCalculate
        protected void devGrid_CustomSummaryCalculate(object sender, DevExpress.Data.CustomSummaryEventArgs e)
        {
            ...
            if (e.SummaryProcess == DevExpress.Data.CustomSummaryProcess.Finalize)
            {
                ...
                {
                    totalRate = Math.Round(totalNgTypeCnt * 100.0 / totalPrdCnt, 2);

                    if (!double.IsNaN(totalRate))
                        e.TotalValue = totalRate;
                }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            WERD0303_LST(WERD0303_CNT(nSchGbn), 1, nSchGbn, false, true);
        }
        #endregion
