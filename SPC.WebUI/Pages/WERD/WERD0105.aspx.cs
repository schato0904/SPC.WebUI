...
{
    public partial class WERD0105 : WebUIBasePage
    {
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 불량원인정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
