...
{
    public partial class WERD0203 : WebUIBasePage
    {
        ...
        {
            //new ASPxGridViewCellMerger(devGrid, "F_WORKNM|F_PRODUCTQTY|F_INSPQTY|F_NGQTY|F_NGRATE|F_LOSSAMT");
            //new ASPxGridViewCellMerger(devGrid, "F_ITEMCD|F_ITEMNM");
            //new ASPxGridViewCellMerger(devGrid, "F_WORKNM|F_PRODUCTQTY|F_INSPQTY|F_NGQTY|F_NGRATE|F_PPM");
        }
        #endregion
        ...
        Int32 WERD0203IN01M_CNT()
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                totalCnt = biz.WERD0203_CNT(oParamDic);
            }
        ...
        void WERD0203LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                oParamDic.Add("F_TODT", this.ucDate.GetToDt());
                oParamDic.Add("F_ITEMCD", GetItemCD());
                ds = biz.WERD0203_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, WERD0203IN01M_CNT());
                }
            }
            devGrid.DataBind();
        }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            WERD0203LST(nPageSize, nCurrPage, true);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            WERD0203LST(nPageSize, nCurrPage, true);
            devGridExporter.WriteXlsToResponse(String.Format("품목별검사현황_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
