...
{
    public partial class WERD5001_DACO : WebUIBasePage
    {
        ...
        void WERD5001_DACO_LST()
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                oParamDic.Add("F_GBN", "");
                ds = biz.WERD5001_DACO_LST(oParamDic, out errMsg);
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.UpdateValues.Count > 0)
            {
                foreach (var Value in e.UpdateValues)
                {
                    ...
                    oParamDic.Add("F_COMPCD", gsCOMPCD);
                    oParamDic.Add("F_FACTCD", gsFACTCD);
                    oParamDic.Add("F_USERID", (Value.Keys["F_USERID"] ?? "").ToString());
                    oParamDic.Add("F_CODE", (Value.NewValues["F_AUTHCD"] ?? "").ToString());
                    oParamDic.Add("F_INSUSER", gsUSERID);

                    oSPs[idx] = "USP_WERD5001_DACO_INSUPD";
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                bExecute = biz.WERD5001_DACO_PROC(oSPs, oParameters, out resultMsg);
            }
