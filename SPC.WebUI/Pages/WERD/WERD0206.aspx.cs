...
{
    public partial class WERD0206 : WebUIBasePage
    {
        ...
        Int32 WERD0206_CNT()
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                totalCnt = biz.WERD0206_CNT(oParamDic);
            }
        ...
        void WERD0206LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                oParamDic.Add("F_TODT", this.ucDate.GetToDt());
                oParamDic.Add("F_USERID", ucUser.GetValue());
                ds = biz.WERD0206_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, WERD0206_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            WERD0206LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            WERD0206LST(nPageSize, nCurrPage, true);
            devGridExporter.WriteXlsToResponse(String.Format("작업자별검사현황_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
