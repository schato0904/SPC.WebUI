...
{
    public partial class WERD0205 : WebUIBasePage
    {
        ...
        {
            new ASPxGridViewCellMerger(devGrid, "F_BANCD|F_BANNM|F_LINECD|F_LINENM|F_WORKCD|F_WORKNM");
        }
        #endregion
        ...
        Int32 WERD0205IN01M_CNT()
        {
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                totalCnt = biz.WERD0205_CNT(oParamDic);
            }
        ...
        void WERD0205LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                oParamDic.Add("F_TODT", this.ucDate.GetToDt());
                oParamDic.Add("F_WORKCD", GetWorkCD());
                ds = biz.WERD0205_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, WERD0205IN01M_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            WERD0205LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            WERD0205LST(nPageSize, nCurrPage, true);
            devGridExporter.WriteXlsToResponse(String.Format("공정별검사현황_{0}", DateTime.Today.ToShortDateString()), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
