...
{
    public partial class LTRK0401 : WebUIBasePage
    {
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0} ~ {1}]{2} 완제품기간별입고현황", GetFromDt(), GetToDt(), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
