...
{
    public partial class LTRK0301 : WebUIBasePage
    {
        ...
        void QPM11_LST()
        {
            ...
            using (LTRKBiz biz = new LTRKBiz())
            {
                ...
                ds = biz.QPM11_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_CustomColumnDisplayText(object sender, DevExpress.Web.ASPxGridViewColumnDisplayTextEventArgs e)
        {
            ...
            if (e.Column.FieldName.Equals("F_INSPRESULT"))
            {
                e.EncodeHtml = false;
                e.DisplayText = !e.Value.ToString().Equals("0") ? @"<span style='color:red;'>불합격</span>" : @"<span style='color:blue;'>합격</span>";
            }
        ...
        protected void devGridExporter_RenderBrick(object sender, DevExpress.Web.ASPxGridViewExportRenderingEventArgs e)
        {
            ...
            if (devGridDataColumn != null
                && (devGridDataColumn.FieldName.Equals("F_INSPRESULT") || devGridDataColumn.FieldName.Equals("F_STATUS"))
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0} ~ {1}]{2} 자재기간별입고현황", GetFromDt(), GetToDt(), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
