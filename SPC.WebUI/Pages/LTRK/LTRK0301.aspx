<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="LTRK0301.aspx.cs" Inherits="SPC.WebUI.Pages.LTRK.LTRK0301" %>
    ...
    <div class="container">
        <div class="search">
            <table class="contentTable">
                ...
                <tr>
                    ...
                    <td class="tdLabel">입고LOT</td>
                    <td class="tdInput">
                        <dx:ASPxTextBox ID="srcF_INLOTNO" ClientInstanceName="srcF_INLOTNO" runat="server" Width="100%" />
                    </td>
                </tr>
                <tr>
                    <td class="tdLabel">품목</td>
                    <td class="tdInput tdContentR" colspan="3">
                        <ucCTF:Item ID="ucItem" runat="server" />
                    </td>
                    <td class="tdInput tdContentLR" colspan="3"></td>
                    <td class="tdInput tdContentL" style="color:red;">
                        <dx:ASPxCheckBox ID="chkISENABLED" ClientInstanceName="chkISENABLED" runat="server" Checked="true" CssClass="font-bold" Text="삭제한 입고현황제외" />
                    </td>
                </tr>
            </table>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_INNO" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_MAKEDATE" Caption="제조일" Width="80px" />
                    ...
                    <dx:GridViewDataColumn FieldName="F_INLOTNO" Caption="입고로트" Width="120px" />
                    ...
                    <dx:GridViewDataSpinEditColumn FieldName="F_INCNT" Caption="입고수량" Width="70px">
                        <CellStyle HorizontalAlign="Right"></CellStyle>
                        <PropertiesSpinEdit DisplayFormatString="#,##0.#" />
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataColumn FieldName="F_UNITNM" Caption="단위" Width="70px" />
                    <dx:GridViewDataColumn FieldName="F_INSPUSER" Caption="검사자" Width="80px" />
                    <dx:GridViewDataColumn FieldName="F_INSPRESULT" Caption="검사결과" Width="70px" />
                    <dx:GridViewDataColumn FieldName="F_INSPMETHODNM" Caption="검사방법" Width="100px" />
                    <dx:GridViewDataSpinEditColumn FieldName="F_INSPCNT" Caption="검사수량" Width="100px">
                        <CellStyle HorizontalAlign="Right"></CellStyle>
                        <PropertiesSpinEdit DisplayFormatString="#,##0.#" />
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataColumn FieldName="F_GUBNNM" Caption="품목분류" Width="120px" />
