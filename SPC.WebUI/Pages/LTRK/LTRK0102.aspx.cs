...
{
    public partial class LTRK0102 : WebUIBasePage
    {
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 검사방법정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
