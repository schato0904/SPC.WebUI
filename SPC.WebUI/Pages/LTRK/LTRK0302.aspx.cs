...
{
    public partial class LTRK0302 : WebUIBasePage
    {
        ...
        void QCM99_LST()
        {
            ...
            using (LTRKBiz biz = new LTRKBiz())
            {
                ...
                oParamDic.Add("F_VENDORTP", "AAE402");
        ...
        void QPM12_LST()
        {
            ...
            using (LTRKBiz biz = new LTRKBiz())
            {
                ...
                oParamDic.Add("F_INLOTNO", srcF_INLOTNO.Text);
                oParamDic.Add("F_ORDERNO", srcF_ORDERNO.Text);
                oParamDic.Add("F_ISINPUT", (ddlF_ISINPUT.SelectedItem.Value ?? "").ToString());
        ...
        {
            DevExpressLib.GetBoolString(new string[] { "F_ISINPUT" }, "O", "X", e);
        ...
        protected void devGridExporter_RenderBrick(object sender, DevExpress.Web.ASPxGridViewExportRenderingEventArgs e)
        {
            ...
            if (devGridDataColumn != null
                && (devGridDataColumn.FieldName.Equals("F_ISINPUT") || devGridDataColumn.FieldName.Equals("F_STATUS"))
                && e.RowType == DevExpress.Web.GridViewRowType.Data)
            {
                e.Text = GlobalFunction.StripHtml(e.Text);
                e.TextValue = e.Text;
            }
            else if (devGridDataColumn != null
                && devGridDataColumn.FieldName.Equals("F_WORKCD")
                && e.RowType == DevExpress.Web.GridViewRowType.Data)
            {
                e.TextValue = e.Text;
            }
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0} ~ {1}]{2} 자재기간별출고현황", GetFromDt(), GetToDt(), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
