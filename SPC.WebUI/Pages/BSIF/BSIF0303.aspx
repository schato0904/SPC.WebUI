<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0303.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0303" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_OnNewClick() {
            //devGrid.AddNewRow();
            var pPage = './Popup/BSIF0303_1POP.aspx?TITLE=검사기준관리&CRUD=CRDSZ&KEYFIELDS=|||' + fn_GetCastText('hidWORKCD') + '|' + fn_GetCastText('hidINSPECTION') + "|I";
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품목코드" Width="140px" FixedStyle="Left" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_ITEMNM" Caption="품목명" Width="180px" FixedStyle="Left" PropertiesEditType="TextBox">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_INSPNM" Caption="검사분류" Width="70px" FixedStyle="Left" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_BANNM" Caption="반명" Width="100px" FixedStyle="Left" PropertiesEditType="TextBox">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_LINENM" Caption="라인명" Width="100px" FixedStyle="Left" PropertiesEditType="TextBox">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명" Width="150px" FixedStyle="Left" PropertiesEditType="TextBox">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_DISPLAYNO" Caption="검사<br />순서" Width="50px" FixedStyle="Left" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_INSPDETAIL" Caption="검사항목" Width="150px" FixedStyle="Left" PropertiesEditType="TextBox">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    ...
                    <dx:GridViewBandColumn Name="F_INSPECTION_STANDARDS" Caption="검사기준">
                        <Columns>
                            ...
                            <dx:GridViewDataColumn FieldName="F_MIN" Caption="하한값" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_MAX" Caption="상한값" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_ZERO" Caption="Zero" Width="40px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_ZIG" Caption="보정치" Width="70px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_DATAUNIT" Caption="구분" Width="60px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_QCYCLENM" Caption="QC검사주기" Width="90px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_JCYCLENM" Caption="현장검사주기" Width="90px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                        </Columns>
                    </dx:GridViewBandColumn>
                    <dx:GridViewBandColumn Name="F_INSPECTION_METHOD" Caption="검사방법">
                        <Columns>
                            <dx:GridViewDataColumn FieldName="F_SIRYO" Caption="시료수" Width="50px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_RANKNM" Caption="수준" Width="40px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_MEASURE" Caption="측정기기" Width="130px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Left" />
                            </dx:GridViewDataColumn>
                        </Columns>
                    </dx:GridViewBandColumn>
                    <dx:GridViewBandColumn Name="F_QUALITY" Caption="품질목표">
                        <Columns>
                            <dx:GridViewDataColumn FieldName="F_UCLX" Caption="UCLX" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_LCLX" Caption="LCLX" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_UCLR" Caption="UCLR" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_TMAX" Caption="TMAX" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_TMIN" Caption="TMIN" Width="60px" PropertiesEditType="TextBox">
                                <CellStyle HorizontalAlign="Right" />
                            </dx:GridViewDataColumn>
                        </Columns>
                    </dx:GridViewBandColumn>
                    <dx:GridViewBandColumn Name="F_TOOLBAR" Caption="측정기준">
                        <Columns>
                            <dx:GridViewDataColumn FieldName="F_PORT" Caption="측정포트" Width="100px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_CHANNEL" Caption="측정채널" Width="70px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                            <dx:GridViewDataColumn FieldName="F_GETDATA" Caption="측정방법" Width="100px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                        </Columns>
                    </dx:GridViewBandColumn>
                    <dx:GridViewDataColumn FieldName="F_SERIALNO" Caption="일련<br />번호" Width="50px" PropertiesEditType="TextBox"></dx:GridViewDataColumn>
                </Columns>
                <Templates>
                    <EditForm>
