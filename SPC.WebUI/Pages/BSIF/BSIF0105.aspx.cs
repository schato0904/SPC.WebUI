...
{
    public partial class BSIF0105 : WebUIBasePage
    {
        ...
        protected void devGrid_Init(object sender, EventArgs e)
        {
            ...
            comboBox = devGrid.Columns["F_IPADDRESS"] as DevExpress.Web.GridViewDataComboBoxColumn;
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.InsertValues.Count > 0)
            {
                foreach (var Value in e.InsertValues)
                {
                    ...
                    oParamDic.Add("F_CODENMKR", (Value.NewValues["F_CODENM"] ?? "").ToString());
                    oParamDic.Add("F_CODENMUS", (Value.NewValues["F_CODENM"] ?? "").ToString());
                    oParamDic.Add("F_CODENMCN", (Value.NewValues["F_CODENM"] ?? "").ToString());
                    oParamDic.Add("F_REMARK", "");
                    oParamDic.Add("F_IPADDRESS", (Value.NewValues["F_IPADDRESS"] ?? "").ToString());
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 설비분류정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
