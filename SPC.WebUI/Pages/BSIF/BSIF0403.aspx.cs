...
{
    public partial class BSIF0403 : WebUIBasePage
    {
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 불량조치코드정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
