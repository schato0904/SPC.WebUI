...
{
    public partial class BSIF0702 : WebUIBasePage
    {
        ...
        #region 경광등 사용설정 정보를 구한다
        void QCDALRAMUSE_LST()
        {
            string errMsg = String.Empty;
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                ds = biz.QCDALRAMUSE_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                bExecute = biz.PROC_QCDALRAMUSE_BATCH(oSPs, oParameters, out resultMsg);
            }
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 경광등사용정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
