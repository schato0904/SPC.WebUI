...
{
    public partial class BSIF0903 : WebUIBasePage
    {
        ...
        {
            var PARTNERNM = schF_PARTNERNM.Text;
            ...
            oParamDic.Add("F_PARTNERNM", PARTNERNM);
            oParamDic.Add("F_STATUS", "1");

            // 히스토그램을 구한다
            using (BSIFBiz biz = new BSIFBiz())
            {
                ds = biz.PARTNER_LST(oParamDic, out errMsg);
            }
        ...
        {
            string errMsg = String.Empty;
            var partcd = schF_PARTNERCD.Text;
            if (string.IsNullOrWhiteSpace(partcd)) return;
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                oParamDic.Add("F_PARTNER", partcd);

                ds = biz.QCD01_PARTNER_LST(oParamDic, out errMsg);
            }
        ...
        DataTable CM16M_LST_1(string F_ITEMCDVALUES)
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                ds = biz.QCD01_PARTNER_MERGE_LST(oParamDic, out errMsg);
            }
        ...
        {
            string errMsg = String.Empty;
            var F_PROCCD = schF_PARTNERCD.Text;
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                ds = biz.GetDatSet(oParamDic, out errMsg, "USP_QCD01_LST");
            }
        ...
        #region 저장
        void CM16M_INS(out string[] procResult)
        {
            bool bExecute = false;
            ...
            if (string.IsNullOrWhiteSpace(this.schF_PARTNERCD.Text)) return;
            ...
            oDic.Add("F_PARTNERVALUES", schF_PARTNERCD.Text);
            oDic.Add("F_USER", gsUSERNM);

            oSPs[0] = "USP_QCD01_PARTNER_INS";
