...
{
    public partial class BSIF0904 : WebUIBasePage
    {
        ...
        void SYCOD01_LST()
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                ds = biz.BSIF0903_FOSECO_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                bExecute = biz.PROC_QCD41_BATCH(oSPs, oParameters, out resultMsg);
            }
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 거래처별품목조회", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
