...
{
    public partial class BSIF0902 : WebUIBasePage
    {
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.DeleteValues.Count > 0)
            {
                foreach (var Value in e.DeleteValues)
                {
                    ...
                    oSPs[idx] = "USP_SYCOD01_DEL_FOSECO";
                    oParameters[idx] = (object)oParamDic;
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 불량원인코드정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
