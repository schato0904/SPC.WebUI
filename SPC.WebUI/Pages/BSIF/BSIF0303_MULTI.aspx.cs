...
{
    public partial class BSIF0303_MULTI : WebUIBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if ((String.IsNullOrEmpty(hidGridAction.Text) || hidGridAction.Text.Equals("false")))
            {
                ...
                GetQCD34_LST(ucPager.GetPageSize(), CurrPage, false);
            }
        }
        #endregion
        ...
        {
            AspxCombox_DataBind(this.ddlINSPITEM);
        }
        #endregion
        ...
        Int32 GetQCD34_CNT()
        {
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                oParamDic.Add("F_MEAINSPCD", ddlINSPITEM.Value == null ? "" : this.ddlINSPITEM.Value.ToString());
        ...
        /// <param name="ComboBoxID">string</param>
        /// <param name="CommonCode">string</param>
        void AspxCombox_DataBind(object comboBox)
        {
            string errMsg = String.Empty;
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                ds = biz.QCD33_LST(oParamDic, out errMsg);
            }

            DevExpress.Web.ASPxComboBox ddlComboBox = comboBox as DevExpress.Web.ASPxComboBox;
            ddlComboBox.TextField = "F_INSPDETAIL";
            ddlComboBox.ValueField = "F_MEAINSPCD";
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.InsertValues.Count > 0)
            {
                foreach (var Value in e.InsertValues)
                {
                    ...
                    oParamDic.Add("F_SIRYO", (Value.NewValues["F_SIRYO"] ?? "").ToString());
