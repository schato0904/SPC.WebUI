<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0303_1POP.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.Popup.BSIF0303_1POP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            fn_ucItemSetValue("<%=keyFields[0]%>");
            fn_OnSetUCWork("<%=keyFields[3]%>");

            devGrid.PerformCallback("FIRST");
        });
        ...
        function fn_OnSaveClick() {
            ...
            if (txtMode.GetText() == "EDIT" || txtMode.GetText() == "DELETE") {
                pPage = rootURL + 'Pages/BSIF/Popup/BSIF0303_HIS.aspx' +
                        '?TITLE=검사기준수정이력등록' +
                        '&KEYFIELDS=' + encodeURIComponent(txtITEMCD.GetText()) + '|' + encodeURIComponent(txtITEMNM.GetText()) + '|' + txtWORKCD.GetText() + '|' + encodeURIComponent(txtWORKNM.GetText()) + '|' + txtSERIALNO.GetText() + '|' + encodeURIComponent(txtINSPDETAIL.GetText()) + '|' + txtINSPCD.GetText() +
                        '&CRUD=S';
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        <div class="form-horizontal divEditForm">
            ...
            <div class="form-group">
                <dx:ASPxTextBox ID="FIRSTchk" ClientInstanceName="FIRSTchk" runat="server" ClientVisible="false">
