...
{
    public partial class BSIF0501_WGROUPPOP : WebUIBasePage
    {
        ...
        #region 공정코드 정보를 불러온다
        void QCD74_LST(string strBancd,string strLinecd, DevExpress.Web.ASPxComboBox comboBox)
        {
            string errMsg = String.Empty;
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                oParamDic.Add("F_FACTCD", gsFACTCD);
                oParamDic.Add("F_BANCD", strBancd);
                oParamDic.Add("F_LINECD", strLinecd);
                oParamDic.Add("F_STATUS", "1");
        ...
        #region PC별 라인 목록을 구한다
        void QCDPCWGROUP_LST()
        {
            string errMsg = String.Empty;
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                oParamDic.Add("F_COMPCD", gsCOMPCD);
                oParamDic.Add("F_FACTCD", gsFACTCD);
                oParamDic.Add("F_PCNO", keyFields[0]);

                ds = biz.QCDPCWGROUP_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                bExecute = biz.PROC_QCDPCWGROUP_BATCH(oSPs, oParameters, out resultMsg);
            }
        ...
        #region ddlWORK1Edit_DataBound
        /// <summary>
        /// ddlWORK1Edit_DataBound
        /// </summary>
        /// <param name="sender">object</param>
        /// <param name="e">EventArgs</param>
        protected void ddlWORK1Edit_DataBound(object sender, EventArgs e)
        {
            DevExpress.Web.ASPxComboBox comboBox = sender as DevExpress.Web.ASPxComboBox;
            comboBox.Items.Insert(0, new DevExpress.Web.ListEditItem() { Text = "선택하세요", Value = "", Selected = true });
        }
        ...
        #region ddlWORK1Edit_Callback
        /// <summary>
        /// ddlLINEEdit_Callback
        /// </summary>
        /// <param name="sender">object</param>
        /// <param name="e">CallbackEventArgsBase</param>
        protected void ddlWORK1Edit_Callback(object sender, DevExpress.Web.CallbackEventArgsBase e)
        {
            string[] oParam = e.Parameter.Split('|');
            DevExpress.Web.ASPxComboBox comboBox = sender as DevExpress.Web.ASPxComboBox;
            comboBox.Items.Clear();
            QCD74_LST(oParam[0],oParam[1], comboBox);
            comboBox.DataBind();

            if (!String.IsNullOrEmpty(oParam[2]))
                comboBox.SelectedIndex = comboBox.Items.FindByValue(oParam[2]).Index;
            else
                comboBox.SelectedIndex = 0;
        }
        #endregion
