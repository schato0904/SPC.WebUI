<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0501.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0501" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                ...
                //fn_OnControlDisableBox(s.GetEditor('F_PCNM'), null);
            } else {
                fn_OnControlEnableComboBox(s.GetEditor('F_PCNO'), true);
                //fn_OnControlEnableBox(s.GetEditor('F_PCNM'), null);
            }
        }
        ...
        function fn_AddLineClick(s, e) {
            ...
            fn_OnPopupPCLINEAdd(devGrid.GetRowKey(e.visibleIndex));
        }
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_PCNM" Caption="PC명" Width="150px" >
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>                    
                    <dx:GridViewDataCheckColumn FieldName="F_USEYN" Caption="경광등<br />사용여부" Width="70px" />
