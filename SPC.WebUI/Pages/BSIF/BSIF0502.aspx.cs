...
{
    public partial class BSIF0502 : WebUIBasePage
    {
            ...
            if (count > 0)
            {
                foreach (DataRow dr in dt.Rows)
                {
                    if (dr["F_GBN"].ToString() == "y"){
                        ...
                        oParamDic.Add("F_PCNM", (dr["F_PCNM"] ?? "").ToString());                        
                        oParamDic.Add("F_POSITION", (dr["F_POSITION"] ?? "").ToString());
                        oParamDic.Add("F_POSITION_W", (dr["F_POSITION_W"] ?? "").ToString());
                        oParamDic.Add("F_STATUS", (dr["F_STATUS"] ?? "").ToString());
                        oParamDic.Add("F_USEYN", (dr["F_USEYN"] ?? "").ToString());
