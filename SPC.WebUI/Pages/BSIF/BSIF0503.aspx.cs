...
{
    public partial class BSIF0503 : WebUIBasePage
    {
        ...
        void SYUSR01_QCD012_LST()
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                ds = biz.SYUSR01_QCD012_LST(oParamDic, out errMsg);
            }
        ...
        void QCD012_LST_EDIT()
        {
            ...
            using (BSIFBiz biz = new BSIFBiz())
            {
                ...
                ds = biz.QCD012_LST_EDIT(oParamDic, out errMsg);
            }
