...
{
    public partial class BSIF0205_BORGWARNER : WebUIBasePage
    {
        ...
        void QCD01_LST()
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                ds = biz.GetQCD01_LST_BORGWARNER(oParamDic, out errMsg);
            }
        ...
        {
            if (!e.Column.FieldName.Equals("F_MODELCD") && !e.Column.FieldName.Equals("F_VENDORCD")) return;
            ...
            if (e.Column.FieldName.Equals("F_VENDORCD"))
            {
                DevExpress.Web.ASPxComboBox comboBox = e.Editor as DevExpress.Web.ASPxComboBox;
                ...
                using (CommonBiz biz = new CommonBiz())
                {
                    ...
                    ds = biz.QCM99_LST_BORGWARNER(oParamDic, out errMsg);
                }

                comboBox.TextField = "F_VENDORNM";
                comboBox.ValueField = "F_VENDORCD";
                comboBox.DataSource = ds;
                comboBox.DataBind();
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.InsertValues.Count > 0)
            {
                foreach (var Value in e.InsertValues)
                {
                    ...
                    oParamDic.Add("F_VENDORCD", (Value.NewValues["F_VENDORCD"] ?? "").ToString());
                    ...
                    oSPs[idx] = "USP_QCD01_INS_BORGWARNER";
            ...
            if (e.UpdateValues.Count > 0)
            {
                foreach (var Value in e.UpdateValues)
                {
                    ...
                    oSPs[idx] = "USP_QCD01_UPD_BORGWARNER";
                    oParameters[idx] = (object)oParamDic;
            ...
            if (e.DeleteValues.Count > 0)
            {
                foreach (var Value in e.DeleteValues)
                {
                    ...
                    oSPs[idx] = "USP_QCD01_DEL_BORGWARNER";
                    oParameters[idx] = (object)oParamDic;
        ...
        protected void devGrid_AutoFilterCellEditorInitialize(object sender, DevExpress.Web.ASPxGridViewEditorEventArgs e)
        {
            if (!e.Column.FieldName.Equals("F_MODELCD")
                ...
                && !e.Column.FieldName.Equals("F_GROUP")
                && !e.Column.FieldName.Equals("F_VENDORCD")) return;
            ...
            else if (e.Column.FieldName.Equals("F_VENDORCD"))
            {
                DevExpress.Web.ASPxComboBox ddlComboBox = e.Editor as DevExpress.Web.ASPxComboBox;
                string errMsg = String.Empty;
                ...
                ddlComboBox.TextField = "F_VENDORNM";
                ddlComboBox.ValueField = "F_VENDORCD";
                ddlComboBox.DataSource = ds;
                ddlComboBox.DataBind();
        ...
        protected void devGrid_DataBound(object sender, EventArgs e)
        {
            ...
            var combo2 = devGrid.Columns["F_VENDORCD"] as DevExpress.Web.GridViewDataComboBoxColumn;
            combo2.PropertiesComboBox.TextField = "F_VENDORNM";
            combo2.PropertiesComboBox.ValueField = "F_VENDORCD";
            combo2.PropertiesComboBox.DataSource = ds;
