<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="DIOF0107.aspx.cs" Inherits="SPC.WebUI.Pages.DIOF.DIOF0107" %>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                OnInitNewRow="devGrid_InitNewRow" OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CODE" Caption="설비점검조치유형코드" Width="70px">
                        <Settings AllowSort="True" />
                        <PropertiesTextEdit MaxLength="2">
                            <ClientSideEvents KeyPress="fn_ValidateOnlyNumberAbs" />
                        </PropertiesTextEdit>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewBandColumn Name="F_CODENM" Caption="설비점검조치유형명">
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMKR" Caption="설비점검조치유형명(한글)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <Settings AllowSort="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMUS" Caption="설비점검조치유형명(영문)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <PropertiesTextEdit ConvertEmptyStringToNull="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMCN" Caption="설비점검조치유형명(중문)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <PropertiesTextEdit ConvertEmptyStringToNull="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                        </Columns>
