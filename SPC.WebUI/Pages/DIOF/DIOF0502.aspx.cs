...
{
    public partial class DIOF0502 : WebUIBasePage
    {
        ...
        void RetrieveList()
        {
            ...
            using (FDCKBiz biz = new FDCKBiz())
            {
                ...
                oParamDic.Add("F_LINECD", schF_LINECD.GetValue());
                oParamDic.Add("F_MACHKIND", schF_MACHKIND.GetValue());
                oParamDic.Add("F_MACHIDX", (schF_MACHIDX.Value ?? "0").ToString());
        ...
        protected void devGrid_CustomColumnDisplayText(object sender, DevExpress.Web.ASPxGridViewColumnDisplayTextEventArgs e)
        {
            ...
            if (e.Column.FieldName.Equals("F_INSPIDX")
                || e.Column.FieldName.Equals("F_CYCLECD")
                || e.Column.FieldName.Equals("F_NUMBER")
                || e.Column.FieldName.Equals("F_CHASU")
                || e.Column.FieldName.Equals("F_BANNM")
                || e.Column.FieldName.Equals("F_LINENM")
                || e.Column.FieldName.Equals("F_MACHCD")
                || e.Column.FieldName.Equals("F_MACHNM")
                || e.Column.FieldName.Equals("F_INSPNO")
                || e.Column.FieldName.Equals("F_INSPNM")) return;
        ...
        {
            // Tooltip 출력
            string[] sTooltipFields = { "F_BANNM", "F_LINENM", "F_MACHNM" };
            ...
            if (e.DataColumn.FieldName.Equals("F_INSPIDX")
                || e.DataColumn.FieldName.Equals("F_CYCLECD")
                || e.DataColumn.FieldName.Equals("F_CYCLENM")
                || e.DataColumn.FieldName.Equals("F_NUMBER")
                || e.DataColumn.FieldName.Equals("F_CHASU")
                || e.DataColumn.FieldName.Equals("F_BANNM")
                || e.DataColumn.FieldName.Equals("F_LINENM")
                || e.DataColumn.FieldName.Equals("F_MACHCD")
                || e.DataColumn.FieldName.Equals("F_MACHNM")
                || e.DataColumn.FieldName.Equals("F_INSPNO")
                || e.DataColumn.FieldName.Equals("F_INSPNM")) return;
