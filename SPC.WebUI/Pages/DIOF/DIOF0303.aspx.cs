...
{
    public partial class DIOF0303 : WebUIBasePage
    {
        ...
        {
            AspxCombox_DataBind(srcF_HISTTPCD, "AAG5");
        }
        #endregion
        ...
        void RetrieveList()
        {
            ...
            using (FDCKBiz biz = new FDCKBiz())
            {
                ...
                oParamDic.Add("F_HISTTPCD", (srcF_HISTTPCD.Value ?? "").ToString());
                oParamDic.Add("F_LANGTP", gsLANGTP);
                ds = biz.QCD_MACH26_LST3(oParamDic, out errMsg);
            }
