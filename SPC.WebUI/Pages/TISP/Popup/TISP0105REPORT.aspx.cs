...
{
    public partial class TISP0105REPORT : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DataTable dtChart1 = (DataTable)Session["TISP0105_1"];
            DataTable dtChart2 = (DataTable)Session["TISP0105_2"];
            DataTable dtChart3 = (DataTable)Session["TISP0105_3"];
            ...
            else
            {
                ...
                TISP0105RPT report = new TISP0105RPT(oParams, dtChart1, dtChart2, dtChart3, imgChartH);
