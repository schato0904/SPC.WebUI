...
{
    public partial class TISP0105 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["TISP0105_1"];
            }
            set
            {
                Session["TISP0105_1"] = value;
            }
        }
        ...
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["TISP0105_2"];
            }
            set
            {
                Session["TISP0105_2"] = value;
            }
        }
        ...
        DataTable dtChart3
        {
            get
            {
                return (DataTable)Session["TISP0105_3"];
            }
            set
            {
                Session["TISP0105_3"] = value;
            }
        }
        #endregion
        ...
        void ChartData()
        {
            ...
            {
                ds = biz.TISP0105_ANAL(oParamDic, out errMsg);
            }
            ...
            if (true == bExecute1)
            {
                using (TISPBiz biz = new TISPBiz())
                {
                    ds = biz.TISP0105_CHART(oParamDic, out errMsg);
                }
