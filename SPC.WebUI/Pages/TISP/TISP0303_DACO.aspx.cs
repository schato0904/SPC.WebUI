...
{
    public partial class TISP0303_DACO : WebUIBasePage
    {
        ...
        #region Data조회
        void QWK08A_TISP0303_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK08A_TISP0303_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            QWK08A_TISP0303_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
