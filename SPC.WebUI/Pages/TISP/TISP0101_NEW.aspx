<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0101_NEW.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0101_NEW" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnImgChartDoCallback(chartObj, callbackObj, _width, _height, visibleIndex) {
            var oParams = _width + '|' + _height + '||' + chartParams;
        ...
        function fn_RowDbClick(s, e) {
            ...
            var KeyField = fn_GetCastText('hidCOMPCD') + '|' + fn_GetCastText('hidFACTCD') + '|' + hidUCFROMDT.GetText() + '|' + hidUCTODT.GetText() + '|' + rowKeys;

            fn_OnPopupEQMonitoring(KeyField);
        }

        function fn_OnCustomButtonClick(visibleIndex, oParams) {
            chartParams = oParams;
            devImage1.SetImageUrl('<%#Page.ResolveUrl("~/Resources/images/blank.png")%>');
            fn_OnImgChartResized(devImage1, devCallbackPanel1, chartResized1, chartWidth, chartHeight1, visibleIndex);
        }
    </script>
</asp:Content>
                ...
                <tr>
                    <td>
                        ...
                        <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn Caption="차트보기" UnboundType="String" Width="70px">
                                    <DataItemTemplate>
                                        <dx:ASPxHyperLink ID="btnViewChart" runat="server" Text="조회" Font-Underline="true" OnInit="btnViewChart_Init" />
                                    </DataItemTemplate>
                                ...
                                <dx:GridViewDataColumn FieldName="F_NGCNT" Caption="규격이탈" >
                                    <CellStyle HorizontalAlign="Right" />
                                </dx:GridViewDataColumn>
