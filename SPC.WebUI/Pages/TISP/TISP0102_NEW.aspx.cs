...
{
    public partial class TISP0102_NEW : WebUIBasePage
    {
        ...
        DataSet dsGrid
        {
            get
            {
                return (DataSet)Session["TISP0102"];
            }
            set
            {
                Session["TISP0102"] = value;
            }
        }
        #endregion
        ...
        void QWK08A_TISP0102_LST_FOR_NSUMDATE()
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK08A_TISP0102_LST_FOR_NSUMDATE(oParamDic, out errMsg);
            }
        ...
        {
            QWK08A_TISP0102_LST_FOR_NSUMDATE();
