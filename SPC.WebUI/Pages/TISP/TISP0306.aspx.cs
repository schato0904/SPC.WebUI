...
{
    public partial class TISP0306 : WebUIBasePage
    {
        ...
        Int32 TISP0306_CNT()
        {
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                oParamDic.Add("F_QRCODE", schF_QRCODE.Text.ToString());
                totalCnt = biz.TISP0306_CNT(oParamDic);
            }
        ...
        #region Data조회
        void TISP0306_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.TISP0306_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, TISP0306_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            TISP0306_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        {
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} Data조회(QR)", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
