...
{
    public partial class TISP0001 : WebUIBasePage
    {
        ...
        void QCDSHEWHART_LST()
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.TISP0001_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.UpdateValues.Count > 0)
            {
                foreach (var Value in e.UpdateValues)
                {
                    ...
                    oParamDic.Add("F_NOTICE", (Value.NewValues["F_NOTICE"] ?? "").ToString());

                    oSPs[idx] = "USP_TISP0001_UPD";
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                bExecute = biz.TISP0001_UPD(oSPs, oParameters, out resultMsg);
            }
