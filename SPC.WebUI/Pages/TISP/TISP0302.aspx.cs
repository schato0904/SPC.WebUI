...
{
    public partial class TISP0302 : WebUIBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                MACH_WRONGGUN_TISP0302_LST(ucPager.GetPageSize(), CurrPage, false);
            }
            if (!IsPostBack)
            {                
                // 페이지 초기화
        ...
        #region Data총갯수
        Int32 MACH_WRONGGUN_TISP0302_CNT()
        {
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                totalCnt = biz.MACH_WRONGGUN_TISP0302_CNT(oParamDic);
            }
        ...
        #region 공정이상 리스트
        void MACH_WRONGGUN_TISP0302_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.MACH_WRONGGUN_TISP0302_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, MACH_WRONGGUN_TISP0302_CNT());
                }
            }
        }
        #endregion
        ...
        void MACH_WRONGGUN_TISP0302_EXCEL()
        {
            string errMsg = String.Empty;
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                oParamDic.Add("F_LINECD", GetLineCD());
                oParamDic.Add("F_WORKCD", GetWorkCD());
                oParamDic.Add("F_PAGESIZE", MACH_WRONGGUN_TISP0302_CNT().ToString());
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.UpdateValues.Count > 0)
            {
                foreach (var Value in e.UpdateValues)
                {
                    ...
                    oSPs[idx] = "USP_MACH_WRONGGUN_TISP0302_UPD";
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                bExecute = biz.MACH_WRONGGUN_TISP0302_UPD(oSPs, oParameters, out resultMsg);
            }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            CurrPage = nCurrPage;
            MACH_WRONGGUN_TISP0302_LST(nPageSize, CurrPage, true);
            devGrid.DataBind();
        }
        #endregion
