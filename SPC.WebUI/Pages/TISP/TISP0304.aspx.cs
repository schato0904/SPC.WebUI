...
{
    public partial class TISP0304 : WebUIBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                // 작업표준서 목록을 구한다
                QWK08A_TISP0304_LST(ucPager.GetPageSize(), CurrPage, Page.IsCallback);
            }
        ...
        Int32 QWK08A_TISP0304_CNT()
        {
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                totalCnt = biz.QWK08A_TISP0304_CNT(oParamDic);
            }
        ...
        #region Data조회
        void QWK08A_TISP0304_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK08A_TISP0304_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK08A_TISP0304_CNT());
                    devGrid.DataBind();
                }
            }
        }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            CurrPage = nCurrPage;
            QWK08A_TISP0304_LST(nPageSize, nCurrPage, true);
        }
        #endregion
        ...
        protected void devGrid_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                if (DevExpressLib.devCheckBox(devGrid, "chkDELETE").Checked)
                    bExecute = biz.QWK08A_TISP0304_DEL(oParamDic);
                else
                    bExecute = biz.QWK08A_TISP0304_UPD(oParamDic);
            }
            ...
            if (true == bExecute)
            {
                QWK08A_TISP0304_LST(ucPager.GetPageSize(), CurrPage, false);
            }
        }
        #endregion
        ...
        protected void devGrid_RowDeleting(object sender, DevExpress.Web.Data.ASPxDataDeletingEventArgs e)
        {
            ...
            oParamDic.Add("F_COMPCD", gsCOMPCD);
            oParamDic.Add("F_FACTCD", gsFACTCD);
            oParamDic.Add("F_WORKDATE", e.Values["F_WORKDATE"] == null ? "" : e.Values["F_WORKDATE"].ToString());
