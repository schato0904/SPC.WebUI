...
{
    public partial class TISP0401_NEW : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["TISP0401"];
            }
            set
            {
                Session["TISP0401"] = value;
            }
        }
        DataTable dtGrid1
        {
            get
            {
                return (DataTable)Session["TISP0401_1"];
            }
            set
            {
                Session["TISP0401_1"] = value;
            }
        }
        #endregion
        ...
        #region Data조회
        void QWK08A_TISP0401_LST_FOR_NSUMDATE()
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK08A_TISP0401_LST_FOR_NSUMDATE(oParamDic, out errMsg);
            }
        ...
        protected void devChart1_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            if (dtChart1 == null)
            {
                QWK08A_TISP0401_LST_FOR_NSUMDATE();
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 주별경향분석", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
