<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0001_SINGYE.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0001" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {                
                var editor = s.GetEditor('F_WORKCD');
                fn_OnControlDisableBox(editor, null);
                var editor = s.GetEditor('F_WORKNM');
                fn_OnControlDisableBox(editor, null);
            } else {
                var editor = s.GetEditor('F_WORKCD');
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_NOTICE" Caption="공지사항" Width="550px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                </Columns>
            </dx:ASPxGridView>
