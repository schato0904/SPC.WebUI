...
{
    public partial class TISP0301 : WebUIBasePage
    {
        ...
        void QWK08A_TISP0301_LST()
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK08A_TISP0301_LST(oParamDic, out errMsg);
            }
        ...
        #region Data 상세 조회
        void QWK08A_TISP0301_DETAIL_LST(string[] param)
        {
            string errMsg = String.Empty;
        ...
        protected void devGrid_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            e.Cell.Attributes.Add("onclick", "OnCellOver(this, '" + colIdx + "', '" + rowIdx + "','" + rowcnt + "',devGrid);");
        ...
        protected void devGrid2_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            QWK08A_TISP0301_DETAIL_LST(Param);
        }
        #endregion
