...
{
    public partial class TISP0502 : WebUIBasePage
    {
        ...
        DataSet dsGrid1
        {
            get
            {
                return (DataSet)Session["TISP0502_1"];
            }
            set
            {
                Session["TISP0502_1"] = value;
            }
        }
        DataSet dsGrid2
        {
            get
            {
                return (DataSet)Session["TISP0502_2"];
            }
            set
            {
                Session["TISP0502_2"] = value;
            }
        }
        #endregion
        ...
        void QWK08A_TISP0502_LST()
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK08A_TISP0502_LST(oParamDic, out errMsg);
            }
        ...
        void QWK08A_TISP0502_DETAIL_LST(string[] param)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK08A_TISP0502_DETAIL_LST(oParamDic, out errMsg);
            }
        ...
        {
            // Tooltip 출력
            string[] sTooltipFields = { "F_ITEMNM", "F_WORKNM", "F_ITEMCD", "F_REMARK" };
