...
{
    public partial class TISP0401 : WebUIBasePage
    {
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                ds = biz.QWK03A_TISP0401_LST(oParamDic, out errMsg);
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 주별수율정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
