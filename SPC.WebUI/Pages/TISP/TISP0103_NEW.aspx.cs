...
{
    public partial class TISP0103_NEW : WebUIBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (gsVENDOR)
            {
                devGrid.Columns["F_COMPNM"].Visible = false;
            }
        }
        #endregion
        ...
        Int32 QWK09A_TISP0103_CNT()
        {
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                if (!gsVENDOR)
                    totalCnt = biz.QWK09A_TISP0103_CNT_MST_NSUMDATE(oParamDic);
                else
                    totalCnt = biz.QWK09A_TISP0103_CNT_NSUMDATE(oParamDic);
            }
        ...
        void QWK09A_TISP0103_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (TISPBiz biz = new TISPBiz())
            {
                ...
                if (!gsVENDOR)
                    ds = biz.QWK09A_TISP0103_LST_MST_NSUMDATE(oParamDic, out errMsg);
                else
                    ds = biz.QWK09A_TISP0103_LST_NSUMDATE(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            if (e.DataColumn.FieldName.Equals("F_ERRQTY"))
            {
                e.Cell.ForeColor = System.Drawing.Color.Red;
            }
            else if (e.DataColumn.FieldName.Equals("F_OVRQTY"))
            {
        ...
        protected void devGrid_CustomColumnDisplayText(object sender, DevExpress.Web.ASPxGridViewColumnDisplayTextEventArgs e)
        {
            ...
            if (e.Column.FieldName.Equals("F_CNT")
               || e.Column.FieldName.Equals("F_GOODQTY")
               || e.Column.FieldName.Equals("F_ERRQTY")
               || e.Column.FieldName.Equals("F_OVRQTY")
               || e.Column.FieldName.Equals("F_PPM"))
            {
        ...
        protected void devGrid_DataBound(object sender, EventArgs e)
        {
            int i = 0;
            if (!gsVENDOR)
                devGrid.Columns["F_COMPNM"].VisibleIndex = i++;
            devGrid.Columns["F_BANNM"].VisibleIndex = i++;
            devGrid.Columns["F_LINENM"].VisibleIndex = i++;
            devGrid.Columns["F_WORKNM"].VisibleIndex = i++;
            devGrid.Columns["F_ITEMCD"].VisibleIndex = i++;
            devGrid.Columns["F_ITEMNM"].VisibleIndex = i++;
            devGrid.Columns["F_INSPCNT"].VisibleIndex = i++;
            devGrid.Columns["F_CNT"].VisibleIndex = i++;
            devGrid.Columns["F_GOODQTY"].VisibleIndex = i++;
            devGrid.Columns["F_ERRQTY"].VisibleIndex = i++;
            devGrid.Columns["F_OVRQTY"].VisibleIndex = i++;
        }
        #endregion
