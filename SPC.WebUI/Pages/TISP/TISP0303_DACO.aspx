<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0303_DACO.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0303_DACO" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_WORKDATE" Caption="검사일자"  Width="105px"  />
                    <dx:GridViewDataColumn FieldName="F_WORKTIME" Caption="검사시간" Width="105px"    />
                    <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품목코드"  Width="200px" />
                    ...
                    <dx:GridViewDataColumn FieldName="F_MEASURE" Caption="측정값"  Width="85px"  >
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_TAGAKNO" Caption="작업지시번호" Width="185px" />
