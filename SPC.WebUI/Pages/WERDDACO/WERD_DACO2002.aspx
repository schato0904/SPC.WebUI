<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD_DACO2002.aspx.cs" Inherits="SPC.WebUI.Pages.WERDDACO.WERD_DACO2002" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_AdjustSize() {
            ...
            var Width = parseInt((($(".search").width()) / 100), 10);
            chartWidth = Width * 70
            ...
            <table class="tblContents" style="width: 100%;">
                ...
                <tr>
                    <td style="height: 290px; padding-top: 10px;" colspan="2">
                        ...
                        <p>하단의 업체를 클릭하시면 해당하는 업체의 품목 점유율을 볼 수 있습니다.</p>
                        <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="true" Width="100%"
                            KeyFieldName="F_COMPANYCD;F_COMPANYNM" EnableViewState="false" EnableRowsCache="false"
