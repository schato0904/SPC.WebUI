...
{
    public partial class WERD_DACO2002 : WebUIBasePage
    {
        ...
        DataTable dtChart1
        {
            get
            {
                return (DataTable)Session["WERD_DACO2002"];
            }
            set
            {
                Session["WERD_DACO2002"] = value;
            }
        }
        DataTable dtChart2
        {
            get
            {
                return (DataTable)Session["WERD_DACO2002_1"];
            }
            set
            {
                Session["WERD_DACO2002_1"] = value;
            }
        }
        DataTable dtgrid1
        {
            get
            {
                return (DataTable)Session["WERD_DACO2002_2"];
            }
            set
            {
                Session["WERD_DACO2002_2"] = value;
            }
        }
        DataTable dtgrid2
        {
            get
            {
                return (DataTable)Session["WERD_DACO2002_3"];
            }
            set
            {
                Session["WERD_DACO2002_3"] = value;
            }
        }
        #endregion
        ...
        #region Data조회
        void WERD_DACO2002_LST(bool bCallback)
        {
            ...
            using (WERDBiz biz = new WERDBiz())
            {
                ...
                ds = biz.WERD_DACO2002_LST(oParamDic, out errMsg);
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            devGrid.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 업체별 Worst 정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
        ...
        protected void devChart2_CustomCallback(object sender, DevExpress.XtraCharts.Web.CustomCallbackEventArgs e)
        {
            ...
            else
            {
                ...
                using (WERDBiz biz = new WERDBiz())
                {
                    ...
                    oParamDic.Add("F_TODT", GetToDt());
                    oParamDic.Add("F_COMPANYCD", oParams[2]);
                    oParamDic.Add("F_GUBN", this.rdoGBN.SelectedItem.Value.ToString());
                    oParamDic.Add("F_UNIT", this.rdoUNIT.SelectedItem.Value.ToString());
                    oParamDic.Add("F_BAN", GetBanCD());
                    ds = biz.WERD_DACO2002_LST2(oParamDic, out errMsg);
                }
                ...
                if (bExistsDataSet(ds))
                {
                    ...
                    {
                        series.Points.Add(new SeriesPoint(dtChart2.Rows[i]["F_ITEMNM"].ToString(), new double[] { Convert.ToDouble(dtChart2.Rows[i]["F_REJRATE"]) }));
                    }
