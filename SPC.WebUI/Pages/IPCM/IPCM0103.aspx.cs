...
{
    public partial class IPCM0103 : WebUIBasePage
    {
        ...
        protected void devGrid_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            else if (e.DataColumn.FieldName.Equals("F_PROGRESS"))
            {
                if (e.CellValue != null)
                {
                    if (e.CellValue.ToString().Equals("2"))
                    {
                        e.Cell.Text = "미완료";
                        e.Cell.ForeColor = System.Drawing.Color.Red;
                        e.Cell.Font.Bold = true;
        ...
        {
            //QWK04A_ADTR0103_LST();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 품질이상확인정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
