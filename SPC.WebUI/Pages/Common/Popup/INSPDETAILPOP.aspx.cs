...
{
    public partial class INSPDETAILPOP : WebUIBasePage
    {
        ...
        #region 검사항목목록
        void INSPDETAIL_LST(string parentParams)
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                ds = biz.INSPDETAIL_LST(oParamDic, out errMsg);
            }
