...
{
    public partial class MACHPOP : WebUIBasePage
    {
        ...
        void GetRequest()
        {
            txtMACHCD.Text = Request.QueryString.Get("MACHCD") ?? "";
        }
        #endregion
        ...
        #region 품목검색 목록
        void GetMACH14_POPUP_LST(string parentParams)
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                oParamDic.Add("F_MACHCD", txtMACHCD.Text);
                ds = biz.GetMACH14_POPUP_LST(oParamDic, out errMsg);
        ...
        {
            // 품목검색 목록
            GetMACH14_POPUP_LST(e.Parameters);
        }
        #endregion
