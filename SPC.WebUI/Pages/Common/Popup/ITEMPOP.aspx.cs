...
{
    public partial class ITEMPOP : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            hidDATE.Text = (Request.QueryString.Get("FROMDT") ?? "") + "|" + (Request.QueryString.Get("TODT") ?? "");
        ...
        void GetQCD01_POPUP_LST(string parentParams)
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                if (hidOpenType.Text.Equals("INS") || hidOpenType.Text.Equals("T") || hidOption.Text.Equals("T"))
                {
                    oParamDic.Add("F_BANCD", GetBanCD());
                    oParamDic.Add("F_LINECD", GetLineCD());
                    oParamDic.Add("F_ITEMCD", txtITEMCD.Text);
                    oParamDic.Add("F_ITEMNM", txtITEMNM.Text);
                ...
                else
                {
                    ...
                    oParamDic.Add("F_STATUS", "1");
                    oParamDic.Add("F_FROMDT", (hidDATE.Text.Split('|')[0]) ?? "");
                    oParamDic.Add("F_TODT", (hidDATE.Text.Split('|')[1]) ?? "");
                    oParamDic.Add("F_SEARCHGBN", (hidSEARCHGBN.Text) ?? "0");
                    ...
                    DevExpress.Web.GridViewDataColumn column2 = new DevExpress.Web.GridViewDataColumn() { FieldName = "F_LINENM", Caption = "라인명", Width = Unit.Parse("100") };
