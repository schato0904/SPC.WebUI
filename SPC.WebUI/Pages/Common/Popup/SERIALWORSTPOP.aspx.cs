...
{
    public partial class SERIALWORSTPOP : WebUIBasePage
    {
        ...
        protected string sParams = String.Empty;
        Int32 totalCnt = 0;
        #endregion
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            new ASPxGridViewCellMerger(devGrid, "F_WORKDATE|F_WORKTIME");
        ...
        void GetRequest()
        {
            sParams = Request.QueryString.Get("KEYFIELDS");
        }
        #endregion
        ...
        Int32 QWK03A_POPUP_CNT()
        {
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                totalCnt = biz.QWK03A_WSTA0102_DATA_CNT(oParamDic);
            }
        ...
        #region 측정목록(팝업용)
        void QWK03A_POPUP_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                ds = biz.QWK03A_WSTA0102_DATA_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                {
                    // Pager Setting
                    ucPager.TotalItems = QWK03A_POPUP_CNT();
                    ucPager.PagerDataBind();
                }
                else
                {
                    devGrid.JSProperties["cpResultCode"] = "pager";
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK03A_POPUP_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            // 검사기준목록을 구한다
            QWK03A_POPUP_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
