<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="ITEMPOP.aspx.cs" Inherits="SPC.WebUI.Pages.Common.Popup.ITEMPOP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnSearchClick() {
            ...
            var ItemList = "<%=CTF.Web.Framework.Helper.CommonHelper.GetAppSectionsString("ItemList")%>";
            hidSEARCHGBN.SetText(ItemList);
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
                    <dx:ASPxTextBox ID="hidDATE" ClientInstanceName="hidDATE" runat="server" Text="" ClientVisible="false" />
                    <dx:ASPxTextBox ID="hidSEARCHGBN" ClientInstanceName="hidSEARCHGBN" runat="server" Text="0" ClientVisible="false" />
                    <label class="col-sm-2 control-label">반</label>
                    <div class="col-sm-3 control-label">
                        <ucCTF:BanPop ID="ucBan" runat="server" Width="100%" targetCtrls="ddlLINE"/>
                    </div>
                    ...
                    <label class="col-sm-2 control-label">
                        <a href="#" onclick="fn_OnSearchClick_All()" class="btn btn-default btn-sm">전체조회</a>
                    </label>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-3 control-label">
                        <dx:ASPxTextBox ID="txtITEMNM" ClientInstanceName="txtITEMNM" runat="server" Width="100%"></dx:ASPxTextBox>
                    </div>
                </div>
            </div>
        </div>
