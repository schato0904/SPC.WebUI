...
{
    public partial class PLCM1001 : WebUIBasePage
    {
        ...
        {
            get { return Session["PLCM1001_Grid"] as DataTable; }
            set { Session["PLCM1001_Grid"] = value; }
        }

        // 우측목록
        DataTable CachedData1
        {
            get { return Session["PLCM1001_Grid1"] as DataTable; }
            set { Session["PLCM1001_Grid1"] = value; }
        }
        #endregion
        ...
        protected Dictionary<string, string> GetRightData()
        {
            ...
            result["F_MACHNM"] = this.srcF_MACHNM.Text ?? "";
            result["F_SERIALNO"] = this.srcF_SERIALNO.Text ?? "";
            result["F_MAKER"] = this.srcF_MAKER.Text ?? "";
            result["F_MAKERMD"] = this.srcF_MAKERMD.Text ?? "";
            result["F_INYMD"] = this.srcF_INYMD.Text ?? "";
        ...
        protected DataTable GetDataLeft(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (PLCMBiz biz = new PLCMBiz())
            {
                ...
                ds = biz.USP_PLCM1001_LST1(oParamDic, out errMsg);
            }
        ...
        protected DataTable GetDataRightTop(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (PLCMBiz biz = new PLCMBiz())
            {
                ...
                oParamDic["F_FACTCD"] = gsFACTCD;
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                ds = biz.USP_PLCM1001_LST2(oParamDic, out errMsg);
            }
        ...
        protected bool InsertData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (PLCMBiz biz = new PLCMBiz())
            {
                oParamDic.Clear();
                oParamDic["F_MACHCD"] = dic.GetString("F_MACHCD");
                oParamDic["F_MACHNM"] = dic.GetString("F_MACHNM");
                oParamDic["F_SERIALNO"] = dic.GetString("F_SERIALNO");
                oParamDic["F_MAKER"] = dic.GetString("F_MAKER");
                oParamDic["F_MAKERMD"] = dic.GetString("F_MAKERMD");
                ...
                oParamDic["F_LANGTYPE"] = gsLANGTP;
                result = biz.USP_PLCM1001_INS1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool DeleteData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (PLCMBiz biz = new PLCMBiz())
            {
                ...
                result = biz.USP_PLCM1001_DEL1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
        ...
        protected bool UpdateData(Dictionary<string, string> dic, out string errMsg)
        {
            ...
            using (PLCMBiz biz = new PLCMBiz())
            {
                ...
                result = biz.USP_PLCM1001_UPD1(oParamDic, out errMsg);
            }
            return result;
        }
        #endregion
