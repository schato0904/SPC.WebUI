...
{
    public partial class INSP0201 : WebUIBasePage
    {
        ...
        DataSet dsGrid
        {
            get
            {
                return (DataSet)Session["INSP0201"];
            }
            set
            {
                Session["INSP0201"] = value;
            }
        }
        #endregion
        ...
        void INS01_INSP0201_LST()
        {
            ...
            using (INSPBiz biz = new INSPBiz())
            {
                ...
                oParamDic.Add("F_LOTNO2", txtLOTNO2.Text);
                oParamDic.Add("F_EONO", txtEONO.Text);
                oParamDic.Add("F_LANGTP", gsLANGTP);

                ds = biz.INS01_INSP0201_LST(oParamDic, out errMsg);
            }
