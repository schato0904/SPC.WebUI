...
{
    public partial class INSP0201REPORT_CHUNIL : WebUIBasePage
    {
        ...
        void INS_ALL_GET()
        {
            ...
            using (INSPBiz biz = new INSPBiz())
            {
                ...
                ds = biz.INS_ALL_GET_CHUNIL(oParamDic, out errMsg);
            }
        ...
        void LoadReportUserControl()
        {
            ...
            {
                reportControl = Page.LoadControl("~/Resources/report/form/chunileng/report.ascx", dtHead, dtGroup, dtData);
            }
            else
            {
