...
{
    public partial class INSP0101POP : WebUIBasePage
    {
        ...
        void SaveReport()
        {
            ...
            foreach (string Value in hidKEY.Text.Split(','))
            {
                ...
                oParamDic.Add("F_FIRSTITEM", oParam[9]);
                oParamDic.Add("F_TAGAKNO", oParam[10]);
                oParamDic.Add("F_WORKMAN", oParam[11]);
                oSPs.Add("USP_INS02_INS");
                oParameters.Add(oParamDic);
            }
            #endregion
