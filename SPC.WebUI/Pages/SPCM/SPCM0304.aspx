<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0304.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0304" %>
            ...
            <td>
                    ...
                    <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 control-label">
                                <ucCTF:Date ID="ucDate" runat="server" MaxMonth="36" />
                            </div>
                ...
                <div class="content">
                    ...
                    <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false"  Width="100%"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="YYMMDD" Caption="재고일자" Width="100px"  CellStyle-HorizontalAlign="Center" />
                            ...
                            <dx:GridViewDataTextColumn FieldName="F_BQTY" Caption="전일재고" Width="90px" CellStyle-HorizontalAlign="Right" />
                            <dx:GridViewDataTextColumn FieldName="F_IPQTY" Caption="당일입고" Width="90px" CellStyle-HorizontalAlign="Right" />
                            <dx:GridViewDataTextColumn FieldName="F_OPQTY" Caption="당일출고" Width="90px" CellStyle-HorizontalAlign="Right" />
