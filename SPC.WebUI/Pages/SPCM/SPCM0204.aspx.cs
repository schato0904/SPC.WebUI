...
{
    public partial class SPCM0204 : WebUIBasePage
    {
        ...
        void ddlStcdBind()
        {
            ...
            ddlStcd2.DataSource = stds;
            ddlStcd2.TextField = "F_STNM";
            ddlStcd2.ValueField = "F_STCD";
            ddlStcd2.DataBind();
            ddlStcd2.SelectedIndex = 1;
        }
        ...
        {
            int idx = 0;
            int count = (e.InsertValues.Count + e.UpdateValues.Count + e.DeleteValues.Count)*2;
            ...
            if (e.InsertValues.Count > 0)
            {
                foreach (var Value in e.InsertValues)
                {
                    ...
                    oParamDic.Add("F_OTYPECD", "OP002");
                    oParamDic.Add("F_INSUSER", gsUSERNM);
                    oParamDic.Add("F_TOSTCD", (this.ddlStcd2.Value ?? "").ToString());
                    ...
                    oParamDic.Add("F_ITCD", (Value.NewValues["F_ITCD"] ?? "").ToString());
                    oParamDic.Add("F_IPQTY", (Value.NewValues["F_OPQTY"] ?? "").ToString());
                    oParamDic.Add("F_PRICE", "");
                    oParamDic.Add("F_SUM", "");
                    oParamDic.Add("F_CSCD", "");
                    oParamDic.Add("F_REMARK", (Value.NewValues["F_REMARK"] ?? "").ToString());
                    oParamDic.Add("F_STCD", (this.ddlStcd2.Value ?? "").ToString());
                    oParamDic.Add("F_IPDT", GetFromDt());
                    oParamDic.Add("F_ITYPECD", "IP002");
                    oParamDic.Add("F_INSUSER", gsUSERNM);
                    oParamDic.Add("F_FRSTCD", (this.ddlStcd.Value ?? "").ToString());
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 창고이동정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
