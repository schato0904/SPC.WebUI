...
{
    public partial class SPCM0303 : WebUIBasePage
    {
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 부족품목정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
