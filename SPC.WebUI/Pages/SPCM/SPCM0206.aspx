<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0206.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0206" %>
    ...
    <div class="container">
            ...
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
                    ...
                    <div class="col-sm-2 control-label">
                        <dx:ASPxRadioButtonList ID="chk_gbn" ClientInstanceName="chk_gbn" runat="server"
                            RepeatDirection="Horizontal" Paddings-Padding="0px" Border-BorderStyle="None">
                            <Items>
                                <dx:ListEditItem Value="A" Text="전체" />
                                <dx:ListEditItem Value="I" Text="입고" />
                                <dx:ListEditItem Value="O" Text="출고" />
                            </Items>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false"  Width="100%"
                ...
                <ClientSideEvents Init="fn_OnGridInit" EndCallback="fn_OnEndCallback1" CallbackError="fn_OnCallbackError"  />
                <Templates>
                    <StatusBar>
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_STNM" Caption="창고"     Width="80px"  CellStyle-HorizontalAlign="Center" />
                    <dx:GridViewDataTextColumn FieldName="F_AILBONO" Caption="입/출고번호" Width="80px"  CellStyle-HorizontalAlign="Center" />
                    ...
                    <dx:GridViewDataTextColumn FieldName="TYPENM" Caption="입/출고유형" Width="90px" CellStyle-HorizontalAlign="Center" />
                    <dx:GridViewDataTextColumn FieldName="F_APDT" Caption="입/출고일자" Width="90px" CellStyle-HorizontalAlign="Right" />
                    <dx:GridViewDataTextColumn FieldName="F_AQTY" Caption="입/출고수량" Width="90px" CellStyle-HorizontalAlign="Right" />
                    <dx:GridViewDataColumn FieldName="F_REMARK" Caption="비고" Width="300px" CellStyle-HorizontalAlign="Left" />
                </Columns>
            </dx:ASPxGridView>
