...
{
    public partial class SPCM0304 : WebUIBasePage
    {
        ...
        void SPCM0304D_LST()
        {
            ...
            using (SPCMBiz biz = new SPCMBiz())
            {
                ...
                ds = biz.SPCM0304D_LST(oParamDic, out errMsg);
            }
        ...
        {
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 일수불현황정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
