...
{
    public partial class ADTR0601EXPORT : WebUIBasePage
    {
        ...
        string sTRANSFLAG = String.Empty;
        string sMEASUREGBN = String.Empty;
        ...
        void GetRequest()
        {
            ...
            sTRANSFLAG = Request.QueryString.Get("pTRANSFLAG") ?? "";
            sMEASUREGBN = Request.QueryString.Get("pMEASUREGBN") ?? "";
        }
        #endregion
        ...
        Int32 QWK04A_ADTR0601_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_TRANSFLAG", sTRANSFLAG);
                oParamDic.Add("F_MEASUREGBN", sMEASUREGBN);
        ...
        #region Data조회
        void QWK04A_ADTR0601_LST()
        {
            string errMsg = String.Empty;
            Int32 nCount = QWK04A_ADTR0601_CNT();
            ...
            if (nCount > 0)
            {
                ...
                else
                {
                    ...
                    devGridExporter.WriteXlsToResponse(String.Format("HIPIS전송DATA({0}~{1})",
