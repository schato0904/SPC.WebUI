...
{
    public partial class ADTR0402EXPORTPOLYTEC : WebUIBasePage
    {
        ...
        string sMOLDNO = String.Empty;
        string sTAGAKNO = String.Empty;
        ...
        void GetRequest()
        {
            ...
            sMOLDNO = Request.QueryString.Get("pMOLDNO") ?? "";
            sTAGAKNO = Request.QueryString.Get("pTAGAKNO") ?? "";
        }
        #endregion
        ...
        Int32 QWK04A_ADTR0402_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_MOLDNO", sMOLDNO);
                oParamDic.Add("F_TAGAKNO", sTAGAKNO);
                if (!this.gsVENDOR)  // 마스터
                {
