<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0301.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0301" %>
    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_WORKDATE;F_PCNM;F_USERID;F_TIMEGUBUN" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>                        
                        ...
                        <dx:GridViewDataColumn FieldName="F_TIMEGUBUN" Caption="작업시간" Width="70px" />                     
                        ...
                        <dx:GridViewDataColumn FieldName="F_USERNM" Caption="인수자" Width="90px" />
                        <dx:GridViewDataColumn FieldName="F_TAKEOVERMAN" Caption="인계자" Width="90px" />
                        <dx:GridViewDataColumn FieldName="F_MEMO" Caption="인수인계내용" Width="300px" />                        

                        <dx:GridViewDataColumn FieldName="F_PCNM"  Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_USERID"  Visible="false" />
                    </Columns>                
                </dx:ASPxGridView>
