...
{
    public partial class ADTR0402_POLYTEC : WebUIBasePage
    {
        ...
        Int32 QWK04A_ADTR0402_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_MOLDNO", (this.txtMOLDNO.Text ?? "").ToString());
                oParamDic.Add("F_TAGAKNO", (this.txtTAGAKNO.Text ?? "").ToString());
