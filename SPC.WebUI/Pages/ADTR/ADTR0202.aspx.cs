...
{
    public partial class ADTR0202 : WebUIBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                QWKWRONGREPORT_ADTR0202_LST(ucPager.GetPageSize(), CurrPage, false);
            }
            if (!IsPostBack)
            {                
                // 페이지 초기화
        ...
        #region Data총갯수
        Int32 QWKWRONGREPORT_ADTR0202_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                totalCnt = biz.QWKWRONGREPORT_ADTR0202_CNT(oParamDic);
            }
        ...
        #region 공정이상 리스트
        void QWKWRONGREPORT_ADTR0202_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QWKWRONGREPORT_ADTR0202_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWKWRONGREPORT_ADTR0202_CNT());
                }
            }
        }
        #endregion
        ...
        void QWKWRONGREPORT_ADTR0202_EXCEL()
        {
            string errMsg = String.Empty;
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_LINECD", GetLineCD());
                oParamDic.Add("F_WORKCD", GetWorkCD());
                oParamDic.Add("F_PAGESIZE", QWKWRONGREPORT_ADTR0202_CNT().ToString());
                oParamDic.Add("F_CURRPAGE", "1");

                ds2 = biz.QWKWRONGREPORT_ADTR0202_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_BatchUpdate(object sender, DevExpress.Web.Data.ASPxDataBatchUpdateEventArgs e)
        {
            ...
            if (e.UpdateValues.Count > 0)
            {
                foreach (var Value in e.UpdateValues)
                {
                    ...
                    oParamDic.Add("F_RETURNCHECK", (Value.NewValues["F_RETURNCHECK"] ?? "").ToString());
                    oParamDic.Add("F_RETURNDATE", (Value.NewValues["F_RETURNCHECK"] ?? "").ToString() == "" ? "" : DateTime.Now.ToString("yyyy-MM-dd"));
                    oParamDic.Add("F_RETURNMAN", gsUSERNM);

                    oSPs[idx] = "USP_QWKWRONGREPORT_ADTR0202_UPD";
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                bExecute = biz.QWKWRONGREPORT_ADTR0202_UPD(oSPs, oParameters, out resultMsg);
            }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            CurrPage = nCurrPage;
            QWKWRONGREPORT_ADTR0202_LST(nPageSize, CurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        {
            QWKWRONGREPORT_ADTR0202_EXCEL();
            devGrid2.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 이상통보정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
