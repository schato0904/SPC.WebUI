...
{
    public partial class ADTR0402_CHUNIL : WebUIBasePage
    {
        ...
        Int32 QWK04A_ADTR0402_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_ITEMCD", GetItemCD_CHUNIL());
                ...
                {
                    totalCnt = biz.QWK04A_ADTR0402_CNT_CHUNIL(oParamDic);
                }
        ...
        public string GetItemCD_CHUNIL(string UserCtlNm = "ucItem")
        {
            ...
            {
                DevExpress.Web.ASPxTextBox _hidTextBox = _UserControl.FindControl("txtITEMCD") as DevExpress.Web.ASPxTextBox;
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                {
                    ds = biz.QWK04A_ADTR0402_LST_CHUNIL(oParamDic, out errMsg);
                }
            }
