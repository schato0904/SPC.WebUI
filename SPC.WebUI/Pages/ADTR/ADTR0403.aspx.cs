...
{
    public partial class ADTR0403 : WebUIBasePage
    {
        ...
        Int32 QWK04A_ADTR0403_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_FROMDT", GetFromDt() + " 00:00:00");
                oParamDic.Add("F_TODT", GetToDt() + " 23:23:59");
                oParamDic.Add("F_ITEMCD", GetItemCD());                
                oParamDic.Add("F_WORKCD", GetWorkPOPCD());
                oParamDic.Add("F_SERIALNO", this.txtSERIALNO.Text ?? "");
                totalCnt = biz.QWK04A_ADTR0403_CNT(oParamDic);
            }
        ...
        #region Data조회
        void QWK04A_ADTR0403_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QWK04A_ADTR0403_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK04A_ADTR0403_CNT());
                }
            }
        }
        #endregion
        ...
        void QWK04A_ADTR0403_EXCEL()
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_WORKCD", GetWorkPOPCD());
                oParamDic.Add("F_SERIALNO", this.txtSERIALNO.Text ?? "");
                oParamDic.Add("F_PAGESIZE", QWK04A_ADTR0403_CNT().ToString());
        ...
        {
            // Tooltip 출력
            string[] sTooltipFields = { "F_ITEMNM", "F_WORKNM", "F_INSPDETAIL","F_CONTENTS"};
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            QWK04A_ADTR0403_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        protected void devGrid_HtmlRowPrepared(object sender, DevExpress.Web.ASPxGridViewTableRowEventArgs e)
        {
            ...
            string strJudge = e.GetValue("F_MODIFYGB").ToString();
        ...
        {
            QWK04A_ADTR0403_EXCEL();
            devGrid2.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} Data수정이력정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
