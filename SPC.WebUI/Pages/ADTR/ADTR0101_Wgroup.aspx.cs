...
{
    public partial class ADTR0101_Wgroup : WebUIBasePage
    {
        ...
        protected string GifURL = String.Empty;
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            GifURL = Page.ResolveUrl(String.Format("~/API/Common/Gathering/Download.ashx?code={0}&name={1}&gbn={2}", gsCOMPCD, "monitering_anim.gif", "monitoring"));
            iconURL = Page.ResolveUrl("~/Resources/icons/");

            if (CommonHelper.GetAppSectionsString("BulletSize").Equals("14"))
                arrBullet = new string[] { "blue.gif", "gray.gif", "green.gif", "red.gif" };
        ...
        void QCDPCNM_ADTR0101_LST()
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QCDPCWGROUP_ADTR0101_LST(oParamDic, out errMsg);
            }
