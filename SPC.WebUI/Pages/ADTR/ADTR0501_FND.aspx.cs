...
{
    public partial class ADTR0501_FND : WebUIBasePage
    {
        ...
        Int32 ADTR0501_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                totalCnt = biz.ADTR0501_CNT_FND(oParamDic);
            }
        ...
        #region 자주검사횟수조회
        void ADTR0501_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.ADTR0501_LST_FND(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, ADTR0501_CNT());
                }
            }
        }
        #endregion
        ...
        void ADTR0501_EXCEL()
        {
            ...
            {
                oParamDic.Clear();
                oParamDic.Add("F_PAGESIZE", ADTR0501_CNT().ToString());
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            ADTR0501_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
