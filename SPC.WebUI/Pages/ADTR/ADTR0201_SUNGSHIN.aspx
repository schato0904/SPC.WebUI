<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0201_SUNGSHIN.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0201_SUNGSHIN" %>
        ...
        <div class="content">
                ...
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>           
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_UHYO1" Caption="유효성1차" Width="200px"   >
                            <CellStyle HorizontalAlign="Left" />
                            <PropertiesTextEdit ConvertEmptyStringToNull="false" />
                        </dx:GridViewDataTextColumn>   
                        <dx:GridViewDataTextColumn FieldName="F_UHYO2" Caption="유효성2차" Width="200px"   >
                            <CellStyle HorizontalAlign="Left" />
                            <PropertiesTextEdit ConvertEmptyStringToNull="false" />
                        </dx:GridViewDataTextColumn>   
                        <dx:GridViewDataTextColumn FieldName="F_UHYO3" Caption="유효성3차" Width="200px"   >
                            <CellStyle HorizontalAlign="Left" />
                            <PropertiesTextEdit ConvertEmptyStringToNull="false" />
                        </dx:GridViewDataTextColumn>   
