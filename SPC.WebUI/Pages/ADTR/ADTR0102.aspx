<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0102.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0102" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OnRowDblClick(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                ...
                var ToDt = hidUCTODT.GetText();

                fn_OnPopupLineMonitoring(fn_GetCastText('hidCOMPCD') + '|' + fn_GetCastText('hidFACTCD') + '|' + rowKeys + '|' + FromDt + '|' + ToDt);
            }
        }
    </script>
</asp:Content>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="INSP_CNT" Caption="검사항목수" Width="90px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="ALL_CNT" Caption="검사횟수" Width="90px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="OK_CNT" Caption="합격수" Width="90px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="NG_CNT" Caption="규격이탈" Width="90px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="OC_CNT" Caption="관리이탈" Width="90px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_RERATE" Caption="불량률" Width="60px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_PPM" Caption="PPM" Width="90px">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
            ...
            <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                OnInitNewRow="devGrid_InitNewRow" OnHtmlDataCellPrepared="devGrid_HtmlDataCellPrepared"
                OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText">
                <Styles>
                    <Header Font-Bold="true" HorizontalAlign="Center"></Header>
                    <Cell HorizontalAlign="Center" Font-Size="9pt" Wrap="False" CssClass="truncated" ></Cell>
