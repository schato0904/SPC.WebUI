...
{
    public partial class ADTR0102POP : WebUIBasePage
    {
        ...
        protected string[] keyFields = new string[3];
        #endregion
        ...
        #region 라인모니터링 팝업 조회
        void QWK04A_ADTR0102_POPUP_LST()
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QWK04A_ADTR0102_POPUP_LST(oParamDic, out errMsg);
            }
