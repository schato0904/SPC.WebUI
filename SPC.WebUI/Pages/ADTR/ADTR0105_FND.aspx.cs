...
{
    public partial class ADTR0105_FND_Work : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            new ASPxGridViewCellMerger(devGrid2, "F_WORKCD|F_WORKNM");
        ...
        protected void devGrid_HtmlDataCellPrepared(object sender, DevExpress.Web.ASPxGridViewTableDataCellEventArgs e)
        {
            ...
            if (e.DataColumn.FieldName.Equals("F_ITEMCD") && e.CellValue.ToString().Length > 0)
            {
                ...
                e.Cell.Attributes.Add("ondblclick", String.Format("fn_OnPopupMonitoringWork('{0}|{1}|{2}|{3}|{4}')", gsCOMPCD, gsFACTCD, GetFromDt(), GetFromDt(), sWORKCD));
            }
            else
            {
