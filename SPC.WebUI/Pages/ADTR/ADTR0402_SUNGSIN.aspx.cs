...
{
    public partial class ADTR0402_SUNGSIN : WebUIBasePage
    {
        ...
        Int32 QWK04A_ADTR0402_CNT()
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                oParamDic.Add("F_MEAINSPCD", (this.txtMEAINSPCD.Text ?? "").ToString());

                totalCnt = biz.GetDatSet_Count(oParamDic, "QWK04A_ADTR0402_CNT_SUNGSIN");
        ...
        void QWK04A_ADTR0402_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (CommonBiz biz = new CommonBiz())
            {
                ...
                ds = biz.GetDatSet(oParamDic, out outMsg, "QWK04A_ADTR0402_LST_SUNGSIN");
            }
