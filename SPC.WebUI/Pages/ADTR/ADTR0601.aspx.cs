...
{
    public partial class ADTR0601 : WebUIBasePage
    {
        ...
        {
            AspxCombox_DataBind(this.ddlTRANSFLAG, "AAF1");
            AspxCombox_DataBind(this.ddlMEASRUE, "AAF2");
            this.ddlMEASRUE.SelectedIndex = 0;
        ...
        Int32 QWK04A_ADTR0601_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_TRANSFLAG", (this.ddlTRANSFLAG.Value ?? "").ToString());
                oParamDic.Add("F_MEASUREGBN", (this.ddlMEASRUE.Value ?? "").ToString());
                oParamDic.Add("F_JUDGE", (this.ddlJUDGE.Value ?? "").ToString());
                totalCnt = biz.QWK04A_ADTR0601_CNT(oParamDic);
        ...
        #region Data조회
        void QWK04A_ADTR0601_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QWK04A_ADTR0601_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK04A_ADTR0601_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
        {
            ...
            //((DevExpress.Web.GridViewDataSpinEditColumn)devGrid.DataColumns["F_SEQNO"]).PropertiesSpinEdit.ClientSideEvents.Init = "fn_OnControlDisibleBox";
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            QWK04A_ADTR0601_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
