...
{
    public partial class ADTR0301 : WebUIBasePage
    {
        ...
        #region Data총갯수
        Int32 QWKTAKEOVER_ADTR0301_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                totalCnt = biz.QWKTAKEOVER_ADTR0301_CNT(oParamDic);
            }
        ...
        #region 공정이상 리스트
        void QWKTAKEOVER_ADTR0301_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QWKTAKEOVER_ADTR0301_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWKTAKEOVER_ADTR0301_CNT());
                }
            }
        }
        #endregion
        ...
        void QWKTAKEOVER_ADTR0301_EXCEL()
        {
            string errMsg = String.Empty;
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_LINECD", GetLineCD());
                oParamDic.Add("F_WORKCD", GetWorkCD());
                oParamDic.Add("F_PAGESIZE", QWKTAKEOVER_ADTR0301_CNT().ToString());
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            CurrPage = nCurrPage;
            QWKTAKEOVER_ADTR0301_LST(nPageSize, CurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        {
            QWKTAKEOVER_ADTR0301_EXCEL();
            devGrid2.DataBind();
            devGridExporter.WriteXlsToResponse(String.Format("[{0}]{1} 인수인계정보", DateTime.Today.ToString("yyyyMMdd"), gsCOMPNM), new DevExpress.XtraPrinting.XlsExportOptionsEx { ExportType = DevExpress.Export.ExportType.WYSIWYG });
        }
        #endregion
