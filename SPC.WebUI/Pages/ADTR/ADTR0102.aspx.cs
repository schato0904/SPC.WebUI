...
{
    public partial class ADTR0102 : WebUIBasePage
    {
        ...
        #region 라인별 측정 갯수를 구한다
        Int32 QWK04A_ADTR0102_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                if (!gsVENDOR)
                    totalCnt = biz.QWK04A_ADTR0102_CNT_MST(oParamDic);
                else
                    totalCnt = biz.QWK04A_ADTR0102_CNT(oParamDic);
            }
        ...
        void QWK04A_ADTR0102_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                if (!gsVENDOR)
                    ds = biz.QWK04A_ADTR0102_LST_MST(oParamDic, out errMsg);
                else
                    ds = biz.QWK04A_ADTR0102_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK04A_ADTR0102_CNT());
                }
        ...
        void QWK04A_ADTR0102_EXCEL(int cnt)
        {
            string errMsg = String.Empty;
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                oParamDic.Add("F_LINECD", GetLineCD());
                oParamDic.Add("F_WORKCD", GetWorkCD());
                oParamDic.Add("F_PAGESIZE", cnt.ToString());
                oParamDic.Add("F_CURRPAGE", "1");

                if (!gsVENDOR)
                    ds2 = biz.QWK04A_ADTR0102_LST_MST(oParamDic, out errMsg);
                else
                    ds2 = biz.QWK04A_ADTR0102_LST(oParamDic, out errMsg);
            }
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            // 라인별 측정 데이터 구한다
            QWK04A_ADTR0102_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
        ...
        {
            QWK04A_ADTR0102_EXCEL(QWK04A_ADTR0102_CNT());
            devGrid2.DataBind();
