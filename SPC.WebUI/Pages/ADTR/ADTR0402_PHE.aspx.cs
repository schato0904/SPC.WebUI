...
{
    public partial class ADTR0402_PHE : WebUIBasePage
    {
        ...
        Int32 QWK04A_ADTR0402_PHE_CNT()
        {
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                totalCnt = biz.QWK04A_ADTR0402_PHE_CNT(oParamDic);
        ...
        #region Data조회
        void QWK04A_ADTR0402_PHE_LST(int nPageSize, int nCurrPage, bool bCallback)
        {
            ...
            using (ADTRBiz biz = new ADTRBiz())
            {
                ...
                ds = biz.QWK04A_ADTR0402_PHE_LST(oParamDic, out errMsg);
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    devGrid.JSProperties["cpResultMsg"] = String.Format("PAGESIZE={0};CURRPAGE={1};ITEMSCNT={2}", nPageSize, nCurrPage, QWK04A_ADTR0402_PHE_CNT());
                }
            }
        }
        #endregion
        ...
        protected void devGrid_CustomCallback(object sender, DevExpress.Web.ASPxGridViewCustomCallbackEventArgs e)
        {
            ...
            QWK04A_ADTR0402_PHE_LST(nPageSize, nCurrPage, true);
            devGrid.DataBind();
        }
        #endregion
