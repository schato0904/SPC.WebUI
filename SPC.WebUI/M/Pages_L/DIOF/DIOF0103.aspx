<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIOF0103.aspx.cs" Inherits="SPC.WebUI.M.Pages_L.DIOF.DIOF0103" %>
...
<head runat="server">
    ...
    <script>
        ...
        function fn_Search() {
            $("#divTable").remove()
            $("#content").append('<div id="divTable"><table class="cell-border" cellspacing="0" style="width: 200%; font-size: 9pt" class="display" id="DataGrid" cellspacing="0"><thead><tr><th>점검<br>부위</th><th>점검<br>항목</th><th>점검<br>내용</th><th>점검<br>방법</th><th>점검<br>규격</th><th>점검<br>결과</th><th>판정</th></tr></thead></table></div>')
            ...
            $('#DataGrid').dataTable({
                ...
                "ajax": {
                    ...
                    "data": { 'MACHIDX': '01', 'DATE': '2017-11-03' },
                    "dataType": "json",
                    "dataSrc": "data",
