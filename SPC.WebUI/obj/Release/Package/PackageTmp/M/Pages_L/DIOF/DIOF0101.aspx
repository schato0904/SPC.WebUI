<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DIOF0101.aspx.cs" Inherits="SPC.WebUI.M.Pages_L.DIOF.DIOF0101" %>
                ...
                "columns": [
                                ...
                                },
                                {
                                    ...
                                    "render": function (data, type, row, meta) {
                                        ...
                                        return "<input type=button value=조회 onclick=fn_DataTableClick('" + data + "') />"
                                    }
                                }
                ],
                "select": true
                    ...
                    <table style="width:100%">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td></td>
                                <td>
                                    <input data-mini="true" type="button" id="btnSearch" value="검색" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <select data-mini="true" name="teamLst" id="teamLst"></select>
                                </td>
                                <td>
                                    <label for="lineLst">라인</label></td>
                                <td>
                                    <select data-mini="true" name="lineLst" id="lineLst"></select>
                                </td>
                            </tr>
                        </tbody>
                    </table>
