<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucNgTypeRow.ascx.cs" Inherits="SPC.WebUI.Resources.controls.userControl.ucNgTypeRow" %>
<table style="width:100%;border-collapse:collapse;border:1px solid darkgrey;height:30px;background-color:#c9c9c9;margin-top:-1px;">
    <tr style="height:100%;">
        <td style="width:60%;border:1px solid darkgrey;text-align:center;height:100%;">
            <dx:ASPxTextBox ID="txtF_NGTYPENM" runat="server" Width="100%" HorizontalAlign="Center" ClientSideEvents-Init="fn_OnControlDisable" Border-BorderStyle="None" Height="100%"></dx:ASPxTextBox>
            <dx:ASPxTextBox ID="txtF_NGTYPECD" runat="server" ClientVisible="false"></dx:ASPxTextBox>
        </td>
