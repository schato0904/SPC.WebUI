<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM5002_SAMSUNG.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM5002_SAMSUNG" %>
<%-- 주조기 모니터링 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_AdjustSize() {
            ...
            //fnASPxGridView_ReHeight(devGrid2);
            $('#div1').height(h);
            $('#div2').height(h);
            fnASPxGridView_ReHeight_ByContainer(devGrid1);
            ...
            <div id="divRightBody" style="width:30%;float:left;height:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_TEMP01" Caption="금형온도" Width="40%"/>
            ...
            <div id="divRightBody2" style="width:30%;float:left;height:100%;">
                <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_WAITTIME" Caption="응고시간" Width="40%"/>
                    </Columns>
                </dx:ASPxGridView>
