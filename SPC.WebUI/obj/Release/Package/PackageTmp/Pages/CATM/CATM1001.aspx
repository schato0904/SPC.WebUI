<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1001.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1001" %>
<%-- 공통코드관리 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">        // 사용자 정의 함수
        ...
        function SetClear(isFirst) {
            ...
            srcF_RANK.SetValue(hidLastF_RANK.GetValue() + 1);
        ...
        function SetValue(data) {
            ...
            if (typeof data.F_RANK != 'undefined') {
                srcF_RANK.SetValue(data.F_RANK);
                var F_RANK = parseInt(data.F_RANK || '0', 10);
                hidLastF_RANK.SetValue(Math.max(F_RANK, hidLastF_RANK.GetValue()));
            }
        ...
        function fn_OnEndCallback(s, e) {
            ...
            switch (s) {
                case devGrid:
                    break;
                case devGrid1:
                    var F_RANK = typeof (s.cpF_RANK) != 'undefined' ? parseInt(s.cpF_RANK || '0', 10) : 0;
                    hidLastF_RANK.SetValue(F_RANK);
                    if (GetPageMode() == 'NEW') {
                        srcF_RANK.SetValue(F_RANK + 1);
                    }
                    break;
            }
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
        ...
        <div id="divLeft" style="width:29%;float:left;">
            ...
            <div id="divLeftBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_CODEGROUP;F_CODEGROUPNM" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_CODEGROUP" Caption="그룹코드" Width="100px" />
                        <dx:GridViewDataColumn FieldName="F_CODEGROUPNM" Caption="그룹코드명" Width="200px"/>
                    </Columns>
                </dx:ASPxGridView>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="srcF_CODEGROUPNM" ClientInstanceName="srcF_CODEGROUPNM" ClientEnabled="false" Width="100%">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                                <dx:ASPxTextBox runat="server" ID="srcF_CODEGROUP" ClientInstanceName="srcF_CODEGROUP" ClientEnabled="false" Width="100%" ClientVisible="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                            </div>
                        </td>
            ...
            <div id="divMiddle" style="margin-bottom:10px;">
                <table class="InputTable" style="margin-bottom: 5px;width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="srcF_CODENM" ClientInstanceName="srcF_CODENM" ClientEnabled="false" Width="100%" MaxLength="100">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="srcF_RANK" ClientInstanceName="srcF_RANK" ClientEnabled="false" Width="100%" MaxLength="3">
                        ...
                        <td class="tdContent" colspan="3">
                            <div style="width:100%;float:left;">
                                <dx:ASPxTextBox runat="server" ID="srcF_REMARK" ClientInstanceName="srcF_REMARK" ClientEnabled="false" Width="100%" MaxLength="50">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_RANK" Caption="표시순번" Width="90px"/>
    ...
    <div id="divHidden" style="display:none;">
        ...
        <dx:ASPxSpinEdit runat="server" ID="hidLastF_RANK" ClientInstanceName="hidLastF_RANK" ClientVisible="false" NumberType="Integer" Number="0">
        </dx:ASPxSpinEdit>
