<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2203.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2203" %>
<%-- 월수불현황 --%>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_INCNT" Caption="당월입고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_OUTCNT" Caption="당월출고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
