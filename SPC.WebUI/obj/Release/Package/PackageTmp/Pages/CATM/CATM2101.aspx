<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2101.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2101" %>
<%-- 원재료 입고등록 --%>
            ...
            <div id="divMiddle" style="margin-bottom:10px;">
                <table class="InputTable" style="margin-bottom: 5px;width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                ...
                                <%--<dx:ASPxTextBox runat="server" ID="srcF_INSTOCKNO" ClientInstanceName="srcF_INSTOCKNO" ClientEnabled="false" Width="100%" ClientVisible="false" Text="0">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>--%>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <%--<dx:ASPxTextBox runat="server" ID="srcF_INCNT" ClientInstanceName="srcF_INCNT" ClientEnabled="false" Width="100%">
