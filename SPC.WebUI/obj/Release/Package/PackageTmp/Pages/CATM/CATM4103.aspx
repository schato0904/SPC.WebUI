<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM4103.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM4103" %>
<%-- 금형수리이력 조회 --%>
        ...
        <div id="divRight" style="width:100%;">
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_SEQ" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_FIXYMD" Caption="수리일자" Width="120px"/>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_FIXTYPENM" Caption="수리유형" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_FIXCOST" Caption="수리비용" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_FIXDAYS" Caption="수리기간" Width="120px"/>
