<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1202_SAMSUNG.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1202_SAMSUNG" %>
<%-- 작업지시서 조회 --%>
        ...
        <div id="divRight" style="width:100%;">
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <ucCTF:SYCOD01 runat="server" id="schF_STATUSCD" ClientInstanceName="schF_STATUSCD" F_CODEGROUP="47" nullText="--전체--"></ucCTF:SYCOD01>
                            </div>
                        </td>
                    </tr>
                </table>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        <dx:GridViewDataColumn FieldName="No" Caption="No" Width="4%" />
                        <dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />
                        <dx:GridViewDataTextColumn FieldName="F_WORKNO" Caption="작업지시번호" Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_PLANYMD" Caption="지시일" Width="8%"/>
                        <dx:GridViewDataTextColumn FieldName="F_WORKNO_SEQ" Caption="작업순서" Width="6%"/>
                        <dx:GridViewDataTextColumn FieldName="F_LOTNO" Caption="Lot No." Width="8%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MACHNM" Caption="설비명" Width="8%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MELTNM" Caption="보온로" Width="8%"/>
                        <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="생산품번" Width="10%"/>
                        <%--<dx:GridViewDataTextColumn FieldName="F_MOLDNO" Caption="금형번호" Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_MOLDNTH" Caption="금형차수" Width="60px"/>
                        <dx:GridViewDataTextColumn FieldName="F_CAVITY" Caption="Cavity" Width="60px"/>--%>
                        <dx:GridViewDataSpinEditColumn FieldName="F_PLANCOUNT" Caption="지시수량" Width="8%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRODCOUNT" Caption="생산수량" Width="8%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataTextColumn FieldName="F_STATUSNM" Caption="상태" Width="8%"/>
                        <%--<dx:GridViewDataTextColumn FieldName="F_SDATETIME" Caption="지시시작시간" Width="132px"/>
                        <dx:GridViewDataTextColumn FieldName="F_EDATETIME" Caption="지시종료시간" Width="132px"/>--%>
                        <dx:GridViewDataTextColumn FieldName="F_MEMO" Caption="비고" CellStyle-HorizontalAlign="Left" Width="14%"/>
                    </Columns>
                </dx:ASPxGridView>
