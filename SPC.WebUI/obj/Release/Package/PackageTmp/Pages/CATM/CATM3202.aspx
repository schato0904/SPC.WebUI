<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM3202.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM3202" %>
<%-- 제품별 출하현황 조회 --%>
    ...
    <div class="container">
        <div id="divRight" style="width:100%;">
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:75%;">
                    <colgroup>
                        <col style="width: 11%" />
                        <col style="width: 22%" />
                        <col style="width: 11%" />
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxComboBox runat="server" ID="schF_CUSTCD" ClientInstanceName="schF_CUSTCD" IncrementalFilteringMode="None" ValueType="System.String" >
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxComboBox>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_OUTYMD" Caption="출하일자" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_CUSTNM" Caption="출하처" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_OUTORDERNO" Caption="출하지시번호" Width="120px"/>
                        <dx:GridViewDataColumn     FieldName="F_WORKNO"     Caption="작업지시번호" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_ORDERNO" Caption="발주번호" Width="120px"/>
                        <dx:GridViewDataTextColumn FieldName="F_LOTNO" Caption="LOT번호" Width="120px"/>
