<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1201_SAMSUNG.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1201_SAMSUNG" %>
<%-- 작업지시서등록 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnPrintClick() {
            ...
            fn_OnPopRptCATM1201(TITLE, F_WORKNO, '');
        }

        // 부품식별표 팝업창 열기
        function fn_OnPopRptCATM1201(TITLE, F_WORKNO, parentCallbackName) {
            var PopParam = {
                'F_WORKNO': F_WORKNO
            };
            pPage = './Popup/PopRptCATM1201_SAMSUNG.aspx' +
        ...
        <div id="divLeft" style="width:29%;float:left;">
            ...
            <div id="divLeftBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        <dx:GridViewDataColumn FieldName="No" Caption="No" Width="30%"/>
                        <%--<dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />--%>
                        <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품번" Width="70%" />
                        <%--<dx:GridViewDataColumn FieldName="F_MOLDNO" Caption="금형번호" Width="150px"/>
        ...
        <div id="divRight" style="width:70%;float:left;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_PLANCOUNT" ClientInstanceName="srcF_PLANCOUNT" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="10000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false" DisplayFormatString="{0:#,0}">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        <dx:GridViewDataColumn FieldName="No" Caption="No" Width="8%" />
                        <dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />
                        <dx:GridViewDataTextColumn FieldName="F_PLANYMD" Caption="지시일" Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_WORKNO_SEQ" Caption="작업순서" Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_WORKNO" Caption="작업지시번호" Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MACHNM" Caption="설비명" Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_LOTNO" Caption="Lot No." Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="생산품번" Width="12%"/>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_PLANCOUNT" Caption="지시수량" Width="10%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}" />
                        <dx:GridViewDataTextColumn FieldName="F_MELTNM" Caption="보온로" Width="10%"/>
                        <dx:GridViewDataTextColumn FieldName="F_STATUSNM" Caption="상태" Width="10%"/>
                    </Columns>
                </dx:ASPxGridView>
