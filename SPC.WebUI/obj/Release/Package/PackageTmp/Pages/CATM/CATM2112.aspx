<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2112.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2112" %>
<%-- 원재료 출고등록 --%>
        ...
        <div id="divLeft" style="width:29%;float:left;">
            ...
            <div id="divLeftBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_ITEMCD;F_ITEMNM;F_INSTOCKNO" EnableViewState="false" EnableRowsCache="false"
