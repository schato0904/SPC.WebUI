<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="IPCM0103POP.aspx.cs" Inherits="SPC.WebUI.Pages.IPCM.Popup.IPCM0103POP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_AdjustSize() {
            ...
            $("#divStep1").height(height - parseInt($("#divStep2").height()) - parseInt($("#divStep3").height()) - 10);
        }
        ...
        function fn_OnValidate() {
            if (bSaveUsed.GetValue() == '9') {
                alert('이미 완료처리된 품질이상입니다');
                return false;
            }
            if (bSaveUsed.GetValue() != '1') {
                alert('품질이상 제기자만 완료처리를 할 수 있습니다');
                return false;
            }
            if (!rdoIMPROVE.GetValue() || rdoIMPROVE.GetValue() == '') {
                alert('개선여부를 선택하세요!!');
                rdoIMPROVE.Focus();
                return false;
            }
    ...
    <div class="container">
        ...
        <div class="content">
            <dx:ASPxCallbackPanel ID="devCallbackPanel" ClientInstanceName="devCallbackPanel" runat="server"
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <dx:ASPxTextBox ID="bSaveUsed" ClientInstanceName="bSaveUsed" runat="server" Text="0" ClientVisible="false" />
                        <div id="divStep3" class="form-horizontal" style="overflow-x: hidden; overflow-y: hidden;">
                            <div class="form-group" style="padding: 0px 10px 0px 10px;">
                                <label class="col-sm-12 bg-success font-bold" style="height: 30px; padding-top: 9px;">이상대책내용</label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">개선여부</label>
                                <div class="col-sm-2">
                                    <dx:ASPxRadioButtonList ID="rdoIMPROVE" ClientInstanceName="rdoIMPROVE" runat="server" RepeatDirection="Horizontal" Paddings-Padding="0px" Border-BorderStyle="None">
                                        <Items>
                                            <dx:ListEditItem Value="1" Text="개선" />
                                            <dx:ListEditItem Value="0" Text="미개선" />
                                        </Items>
                                    </dx:ASPxRadioButtonList>
                                </div>
                                <label class="col-sm-1 control-label">비고</label>
                                <div class="col-sm-8">
                                    <dx:ASPxTextBox ID="txtCFTXT1" ClientInstanceName="txtCFTXT1" runat="server" Width="100%"
                        ...
                        <div id="divStep2" class="form-horizontal" style="overflow-x: hidden; overflow-y: hidden;">
                            <div class="form-group" style="padding: 0px 10px 0px 10px;">
                                <label class="col-sm-12 bg-info font-bold" style="height: 30px; padding-top: 9px;">이상대책내용(수정할 수 없습니다)</label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 control-label">회신자</label>
                                <div class="col-sm-2">
                                    <dx:ASPxTextBox ID="txtRSUSNM" ClientInstanceName="txtRSUSNM" runat="server" Width="100%"
                                        class="form-control input-sm">
                                    </dx:ASPxTextBox>
                                </div>
                                <label class="col-sm-1 control-label">첨부파일</label>
                                <div class="col-sm-2">
                                    <dx:ASPxTextBox ID="txtRSFILE" ClientInstanceName="txtRSFILE" ClientVisible="false" runat="server" Width="100%" class="form-control input-sm" />
                                    <button class="btn btn-sm btn-warning" style="width: 100%; padding: 3px 0px;" onclick="fn_AttachFileOpenReadOnly('품질이상대책', 'F', 'T', 'txtRSFILE'); return false;">
