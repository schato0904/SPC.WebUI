<%@ Page Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD0302.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD0302" %>
    ...
    <div class="container">
            ...
            <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="False"  Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명"  Width="14%">
                     ...
                     <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품목코드"  Width="11%">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_ITEMNM" Caption="품목명"  Width="17%">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
        ...
        <div class="content" id="prinDiv2" style="display:none;">
            <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="False"  Width="100%"
                ...
                <ClientSideEvents Init="fn_OnGridInit" EndCallback="fn_OnGridEndCallback" CallbackError="fn_OnCallbackError"/>
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="F_NUMBER" Caption="No." Width="30" Visible="false" ></dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명"  Width="10%">
                        <CellStyle HorizontalAlign="Left" />
                       
                    </dx:GridViewDataColumn>
                     <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품목코드"  Width="8%">
                        <CellStyle HorizontalAlign="Left"  />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_ITEMNM" Caption="품목명"  Width="13%">
                        <CellStyle HorizontalAlign="Left"  />
                         <FooterTemplate>
                            <span>합계</span>
                        </FooterTemplate>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_INSPQTY" Caption="검사수량"  Width="7%">
                        <CellStyle HorizontalAlign="Right"  />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_NGQTY" Caption="부적합수량"  Width="7%">
                        <CellStyle HorizontalAlign="Right"  />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_NGRATE" Caption="부적합률(%)"  Width="7%">
                        <CellStyle HorizontalAlign="Right"  />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataTextColumn FieldName="F_PPM" Caption="PPM"  Width="7%">
                        <CellStyle HorizontalAlign="Right" />
                        <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_LOSSAMT" Caption="손실금액(원)" Width="7%">
                        <CellStyle HorizontalAlign="Right"  />
                        <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_WORKCD" Visible="false" ></dx:GridViewDataTextColumn>
                </Columns>
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="F_NUMBER" SummaryType="Custom" Visible="false" />
                    <dx:ASPxSummaryItem FieldName="F_PRODUCTQTY" SummaryType="Custom" DisplayFormat="{0:n0}" />
