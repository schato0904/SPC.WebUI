<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0203.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0203" %>
                    ...
                    <div class="content">
                        ...
                        <dx:ASPxTreeList ID="devTree" ClientInstanceName="devTree" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:TreeListDataColumn FieldName="F_NQTY" Visible="false" />
                            </Columns>
                    ...
                    <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            <div class="form-group">
                                ...
                                <label class="col-sm-1 control-label">출고유형</label>
                                <div class="col-sm-2 control-label">
                                    <dx:ASPxComboBox ID="ddlOtype" ClientInstanceName="ddlOtype" runat="server" Width="100%"
                                        IncrementalFilteringMode="None" CssClass="NoXButton">
                                    </dx:ASPxComboBox>
                                </div>
                            </div>
                        ...
                        <div class="content">
                            ...
                            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false"  Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn FieldName="F_NQTY" Caption="재고수량" Width="100px" CellStyle-HorizontalAlign="Right" />
                                    <dx:GridViewDataTextColumn FieldName="F_OPQTY" Caption="출고수량" Width="90px" CellStyle-HorizontalAlign="Right">
                    ...
                    <div class="content">
                        <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="F_OPDT"       Caption="출고일자"      Width="100px"       CellStyle-HorizontalAlign="Center" />
                                ...
                                <dx:GridViewDataTextColumn FieldName="F_OPQTY"  Caption="출고수량"      Width="80px"        CellStyle-HorizontalAlign="Right" PropertiesTextEdit-DisplayFormatInEditMode="true" PropertiesTextEdit-DisplayFormatString="n0" PropertiesTextEdit-MaskSettings-Mask="n0"  />
