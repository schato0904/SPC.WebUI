<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0104.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0104" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_ITTYPECD", s, e);
            fn_OnBatchValidate("F_ITTYPENM", s, e);
        }

        // BatchEditStartEditing
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                var editor = s.GetEditor('F_ITTYPECD');
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_ITTYPECD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_ITTYPECD" Caption="품목분류코드" Width="100px">
                        <PropertiesTextEdit MaxLength="5" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_ITTYPENM" Caption="품목분류명" Width="200px">
