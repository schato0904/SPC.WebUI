<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0102.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0102" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_CSCD", s, e);
            fn_OnBatchValidate("F_CSNM", s, e);
        }

        // BatchEditStartEditing
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                var editor = s.GetEditor('F_CSCD');
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_CSCD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CSCD" Caption="거래처코드" Width="100px">
                        <PropertiesTextEdit MaxLength="10" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_CSNM" Caption="거래처명" Width="200px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_CLOCATION" Caption="주소" Width="300px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_CNUMBER" Caption="전화번호" Width="100px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
