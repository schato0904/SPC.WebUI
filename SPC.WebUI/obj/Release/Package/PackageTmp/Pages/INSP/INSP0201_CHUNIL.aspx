<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="INSP0201_CHUNIL.aspx.cs" Inherits="SPC.WebUI.Pages.INSP.INSP0201_CHUNIL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnDeleteClick() {
            if (!confirm('선택한 검사성적서를 삭제하시겠습니까?')) { return false; }
            fn_Delete();
            devGrid.PerformCallback();
        }
        ...
        function fn_OnCustomButtonClick(s, e) {
            ...
            fn_OnPopupInspectionReportView_CHUNIL(oParams[0], oParams[1], oParams[2]);
        }
        ...
        function fn_Delete() {
            ...
            var Groupcd = selectedKeys[0].split('|');

            devCallback.PerformCallback(Groupcd[0]);
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F; width:80%;">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="80%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn FieldName="F_DATE" Caption="작업일시" Width="150px"/>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CUSTOMNM" Caption="납품업체" CellStyle-HorizontalAlign="Left" Visible="false" />
                    <dx:GridViewDataTextColumn FieldName="F_REPORTNM" Caption="성적서양식명" CellStyle-HorizontalAlign="Left" Visible="false" />
                    <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="품번" Width="160px" />
                    <dx:GridViewDataTextColumn FieldName="F_ITEMNM" Caption="품명" CellStyle-HorizontalAlign="Left" Width="160px" />
                    <dx:GridViewDataTextColumn FieldName="F_TSERIALNO" Caption="시료군" CellStyle-HorizontalAlign="Right" Width="160px" />
                    <dx:GridViewDataTextColumn FieldName="F_EONO" Caption="비고" CellStyle-HorizontalAlign="Left" Width="160px" />
                    <dx:GridViewDataTextColumn FieldName="F_LOTNO2" Caption="LOT번호" Visible="false"/>
                    <dx:GridViewDataTextColumn FieldName="F_EONO" Caption="E/0" Visible="false"/>
                    <dx:GridViewDataTextColumn FieldName="F_QUANTITY" Caption="납품수(시료수)" Visible="false"/>
