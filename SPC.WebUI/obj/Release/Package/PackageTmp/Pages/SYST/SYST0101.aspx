<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SYST0101.aspx.cs" Inherits="SPC.WebUI.Pages.SYST.SYST0101" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CODE" Caption="부서코드" Width="70px">
                        <Settings AllowSort="True" />
                        <PropertiesTextEdit MaxLength="2">
                            <ClientSideEvents KeyPress="fn_ValidateOnlyNumberAbs" />
                        </PropertiesTextEdit>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewBandColumn Name="F_CODENM" Caption="부서명">
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMKR" Caption="부서명(한글)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <Settings AllowSort="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMUS" Caption="부서명(영문)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <PropertiesTextEdit ConvertEmptyStringToNull="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMCN" Caption="부서명(중문)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <PropertiesTextEdit ConvertEmptyStringToNull="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                        </Columns>
