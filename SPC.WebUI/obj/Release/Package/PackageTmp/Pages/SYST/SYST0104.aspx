<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SYST0104.aspx.cs" Inherits="SPC.WebUI.Pages.SYST.SYST0104" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CODE" Caption="직위코드" Width="70px">
                    ...
                    <dx:GridViewBandColumn Name="F_CODENM" Caption="부서명">
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMKR" Caption="직위명(한글)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <Settings AllowSort="True" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMUS" Caption="직위명(영문)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <PropertiesTextEdit ConvertEmptyStringToNull="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_CODENMCN" Caption="직위명(중문)" Width="180px">
                                <CellStyle HorizontalAlign="Left"></CellStyle>
                                <PropertiesTextEdit ConvertEmptyStringToNull="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
                        </Columns>
