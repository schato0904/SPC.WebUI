<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WSTA0106.aspx.cs" Inherits="SPC.WebUI.Pages.WSTA.WSTA0106" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_AdjustSize() {
            ...
            chartWidth = Math.round(Width * 0.7,2);
            chartWidth2 = Math.round(Width * 0.3,2);
    ...
    <div class="container">
        ...
        <div class="content">
             <table class="tblContents" style="width: 100%;">
                ...
                <tr>
                    <td style="vertical-align: top;padding-top: 10px;width:100%">
