<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WSTA0102.aspx.cs" Inherits="SPC.WebUI.Pages.WSTA.WSTA0102" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_grid(s, e) {
            ...
            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr[id$=DXDataRow3]>td:gt(0)').each(function (idx) {
