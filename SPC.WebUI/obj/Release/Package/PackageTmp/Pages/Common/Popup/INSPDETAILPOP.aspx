<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="INSPDETAILPOP.aspx.cs" Inherits="SPC.WebUI.Pages.Common.Popup.INSPDETAILPOP" %>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_MEAINSPCD;F_INSPDETAIL;F_STANDARD;F_MAX;F_MIN;F_UCLX;F_LCLX;F_UCLR;F_SIRYO;F_ITEMCD;F_FREEPOINT" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_FREEPOINT" Visible="false" ></dx:GridViewDataColumn>
                </Columns>
            </dx:ASPxGridView>
