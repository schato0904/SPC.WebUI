<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0601.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0601" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnExcelClick() {
            var _url = './Export/ADTR0601EXPORT.aspx';
            ...
            _url += '&pTRANSFLAG=' + fn_GetCastSelectedItemValue('ddlTRANSFLAG');
            _url += '&pMEASUREGBN=' + fn_GetCastSelectedItemValue('ddlMEASRUE');
            window.open(_url);
        }
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {                
                ...
                fn_OnControlDisibleBox(editor, null);                
            } else {
                var editor = s.GetEditor('F_BANCD');
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-1 control-label">
                        <dx:ASPxComboBox ID="ddlJUDGE" ClientInstanceName="ddlJUDGE" runat="server" Width="100%"
                            ...
                            <ClientSideEvents Init="fn_OnControlDisible" />
                        </dx:ASPxComboBox>
                    </div>
                    <label class="col-sm-1 control-label">전송유무</label>
                    <div class="col-sm-1">
                        <dx:ASPxComboBox ID="ddlTRANSFLAG" ClientInstanceName="ddlTRANSFLAG" runat="server" Width="100%"
                            IncrementalFilteringMode="None" CssClass="NoXButton">
                            <ClientSideEvents Init="fn_OnControlDisible" />
                        </dx:ASPxComboBox>
                    </div>
                    <label class="col-sm-1 control-label">측정구분</label>
                    <div class="col-sm-1">
                        <dx:ASPxComboBox ID="ddlMEASRUE" ClientInstanceName="ddlMEASRUE" runat="server" Width="100%"
                            IncrementalFilteringMode="None" CssClass="NoXButton">
                            <ClientSideEvents Init="fn_OnControlDisible" />
                        </dx:ASPxComboBox>
                    </div>
