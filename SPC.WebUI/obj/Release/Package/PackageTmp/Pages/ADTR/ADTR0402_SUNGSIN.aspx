<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0402_SUNGSIN.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0402_SUNGSIN" %>
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">완제품명</label>
                    <div class="col-sm-2 control-label">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_LOTNO" Caption="완제품명"  Width="100px"  />
                    <dx:GridViewDataColumn FieldName="F_TAGAKNO" Caption="원자재 Lot"  Width="100px"  />
