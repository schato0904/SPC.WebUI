<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0502.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0502" %>
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
                    ...
                    <div class="col-sm-1 control-label">
                        <dx:ASPxTextBox ID="txt_Workman" ClientInstanceName="txt_Workman" runat="server" Width="100%" class="form-control input-sm" MaxLength="20"  />
                    </div>
                </div>                
            </div>
        </div>
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="T01"  Caption="8" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T02"  Caption="9" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T03"  Caption="10" Width="32px"  />
                    <dx:GridViewDataColumn FieldName="T04"  Caption="11" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T05"  Caption="12" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T06"  Caption="13" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T07"  Caption="14" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T08"  Caption="15" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T09"  Caption="16" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T10"  Caption="17" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T11"  Caption="18" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T12"  Caption="19" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T13"  Caption="20" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T14"  Caption="21" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T15"  Caption="22" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T16"  Caption="23" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T17"  Caption="24" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T18"  Caption="1" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T19"  Caption="2" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T20"  Caption="3" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T21"  Caption="4" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T22"  Caption="5" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T23"  Caption="6" Width="32px" />
                    <dx:GridViewDataColumn FieldName="T24"  Caption="7" Width="32px" />
