<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0302.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0302" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnRowDblClick(s, e) {
            //alert(devGrid.GetRowKey(e.visibleIndex))
        }

        function fn_OpenTISP01POP(s,e) {
            var visibleIndex = e.visibleIndex
            ...
            parent.fn_OnDeleteTab('TISP01POP', parent.fn_OnGetTabObject('TISP01POP'));
            parent.parent.doCreateTab('MM07|MM0701|TISP|TISP01POP|품질종합현황|RP|1', oParams);
    ...
    <div class="container">
        ...
        <div class="content">
                ...
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_ITEMCD;F_ITEMNM;F_WORKCD;F_WORKNM;F_MEAINSPCD;F_INSPDETAIL;F_SERIALNO;F_SIRYO;F_FREEPOINT;F_STANDARD;F_MAX;F_MIN;F_WORKDATE;F_WORKTIME;F_PCNAME;F_MEASNO" EnableViewState="false" EnableRowsCache="false"
                    OnCustomCallback="devGrid_CustomCallback" OnHtmlDataCellPrepared="devGrid_HtmlDataCellPrepared"
                    OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText" OnHtmlRowPrepared="devGrid_HtmlRowPrepared" OnBatchUpdate="devGrid_BatchUpdate" >
                    <Styles>
                    ...
                    <ClientSideEvents Init="fn_OnGridInit" EndCallback="fn_OnGridEndCallback" CallbackError="fn_OnCallbackError" RowClick="fn_OnRowDblClick"   CustomButtonClick="fn_OpenTISP01POP"
                    ...
                    <Columns>      
                        ...
                        <dx:GridViewDataColumn FieldName="F_PCNAME"  Visible="false" />
