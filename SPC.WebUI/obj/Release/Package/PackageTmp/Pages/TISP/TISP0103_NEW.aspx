<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0103_NEW.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0103_NEW" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OnRowDblClick(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                ...
                fn_OnPopupLineMonitoringTISP(rowKeys + '|' + FromDt + '|' + ToDt);
            }
        }
    </script>
</asp:Content>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                KeyFieldName="F_COMPCD;F_FACTCD;F_ITEMCD;F_WORKCD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <%--여기서부터 히든 필드--%>
                    <dx:GridViewDataColumn FieldName="F_COMPCD" Caption="업체코드" Visible="false" />
            ...
            <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                SettingsBehavior-AllowSelectSingleRowOnly="true" SettingsBehavior-AllowSelectByRowClick="true" SettingsBehavior-AllowSort="true"
                KeyFieldName="F_COMPCD;F_FACTCD;F_ITEMCD;F_WORKCD" EnableViewState="false" EnableRowsCache="false" Visible="false"
                OnInitNewRow="devGrid_InitNewRow" OnCustomCallback="devGrid_CustomCallback" OnHtmlDataCellPrepared="devGrid_HtmlDataCellPrepared"
                OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText">
                <Styles>
                    <Header Font-Bold="true" HorizontalAlign="Center"></Header>
