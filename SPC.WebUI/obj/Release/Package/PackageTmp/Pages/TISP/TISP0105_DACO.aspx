<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0105_DACO.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0105_DACO" %>
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
                    <div class="col-sm-4 control-label">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8 control-label">
                                <ucCTF:Date ID="ucDate" runat="server" SingleDate="false" />
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-sm-4 control-label">                        
                        <div class="form-group">
                            <label class="col-sm-4 control-label">검사규격</label>
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">상한규격</label>
                            <div class="col-sm-6 control-label">
                        ...
                        <div class="form-group">
                            <label class="col-sm-4 control-label">하한규격</label>
                            <div class="col-sm-6 control-label">
