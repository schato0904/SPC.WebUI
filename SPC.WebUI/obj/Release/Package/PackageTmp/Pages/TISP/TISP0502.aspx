<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0502.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0502" %>
            ...
            <div class="left" >
                ...
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_CNT" Caption="항목수"  Width="80px"  >
                            <CellStyle HorizontalAlign="Right" />
                        </dx:GridViewDataColumn>
                        <dx:GridViewDataColumn FieldName="F_NGCNT" Caption="부적합수"  Width="80px"  >
                            <CellStyle HorizontalAlign="Right" />
                        </dx:GridViewDataColumn>                
                        <dx:GridViewDataColumn FieldName="F_MODIFYUSR" Caption="작업자" Width="100px"    />         
                        <dx:GridViewDataColumn FieldName="F_REMARK" Caption="사유" Width="150px"    >
