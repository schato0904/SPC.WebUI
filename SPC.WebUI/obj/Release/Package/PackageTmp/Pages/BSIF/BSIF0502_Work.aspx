<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0502_Work.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0502_Work" %>
    ...
    <script type="text/javascript">
        ...
        function fn_AddPc(pcTable) {
            ...
            $(data).each(function () {
                ...
                var newimg = $("<img src='<%=iconURL%>' id='img_" + this.F_PCNO + "' title='[No. " + this.F_PCNO + "] " + this.F_WORKNM + "' />");
