<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0205_SUNGSHIN.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0205_SUNGSHIN" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnGROUPSelectedIndexChanged(s, e) {
    ...
    <div class="container">
        <div class="search">
            <div style="color:black;background-color:white;border:1px solid #808080;padding:5px;">
                * 품목을 수불관리에 사용하려면 수불사용을 <span style="color:blue;font-weight:bold;">사용</span>으로 선택해야합니다. 또한, <span style="color:blue;font-weight:bold;">품목구분/단위/안정재고</span>를 선택 또는 입력해야합니다.<br />
                1. 품목구분 및 품목그룹은 기본정보 > 공통기본정보 > 품목구분관리 에서 등록할 수 있습니다.<br />
                2. 단위는 기본정보 > 공통기본정보 > 품목단위관리 에서 등록할 수 있습니다.
            </div>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" 
                KeyFieldName="F_ITEMCD;F_ITEMNM" EnableViewState="False" EnableRowsCache="False" Width="100%"
                OnInit="devGrid_Init" OnBatchUpdate="devGrid_BatchUpdate" OnInitNewRow="devGrid_InitNewRow" OnCustomCallback="devGrid_CustomCallback"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="품목코드" Width="180px">
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CODENO" Caption="구품번" Width="150px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_MODELCD" Name="F_MODELCD" Caption="기종코드" Width="130px" >
                    ...
                    <dx:GridViewDataCheckColumn FieldName="F_MACHSTND" Caption="수불사용" Width="70px" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_GUBN" Caption="품목구분" Width="100px" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_GROUP" Caption="품목그룹" Width="100px" EditFormSettings-Visible="False" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_UNIT" Caption="단위" Width="100px" />
                    <dx:GridViewDataTextColumn FieldName="F_DESIGN" Caption="보관장소" Width="150px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataSpinEditColumn FieldName="F_DANGA" Caption="안정재고" Width="120px">
                        <Settings AllowAutoFilter="False" />
                        <CellStyle HorizontalAlign="Right"></CellStyle>
                        <PropertiesSpinEdit DisplayFormatString="#,##0.#" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false" ConvertEmptyStringToNull="false" />
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataCheckColumn FieldName="F_STATUS" Caption="사용" Width="60px" />
                    <dx:GridViewCommandColumn Caption="라인등록" Width="70px"  >
                        <CustomButtons>                            
                            <dx:GridViewCommandColumnCustomButton Text="등록" ID="btnAddLine" />
                        </CustomButtons>
                    </dx:GridViewCommandColumn>
                    <dx:GridViewCommandColumn Caption="도면등록" Width="70px"  >
                        <CustomButtons>                            
