<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0204.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0204" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_MODELCD" Caption="기종코드" Width="80px">
                        <PropertiesTextEdit MaxLength="20" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_MODELNM" Caption="기종명" Width="200px">
