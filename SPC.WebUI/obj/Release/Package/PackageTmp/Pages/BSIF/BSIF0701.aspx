<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0701.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0701" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_HOUR", s, e);
            fn_OnBatchValidate("F_MINUTE", s, e);
        }

        // BatchEditStartEditing
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {                
                var editor = s.GetEditor('F_HOUR');
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_HOUR" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataSpinEditColumn FieldName="F_HOUR" Caption="시간" Name="F_HOUR" Width="100px">
                        <PropertiesSpinEdit NumberType="Integer" MinValue="0" MaxValue="24" SpinButtons-ShowIncrementButtons="false" >
                            <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                        </PropertiesSpinEdit>
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataSpinEditColumn FieldName="F_MINUTE" Caption="분" Name="F_MINUTE" Width="150px">
                        <PropertiesSpinEdit NumberType="Integer" MinValue="0" MaxValue="60" SpinButtons-ShowIncrementButtons="false" >
                            <SpinButtons ShowIncrementButtons="False"></SpinButtons>
                        </PropertiesSpinEdit>
                    </dx:GridViewDataSpinEditColumn>                  
                </Columns>
