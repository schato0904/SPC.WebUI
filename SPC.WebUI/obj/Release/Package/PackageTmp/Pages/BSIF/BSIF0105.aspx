<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0105.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0105" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            ...
            fn_OnBatchValidate("F_CODENM", s, e);
            fn_OnBatchValidate("F_IPADDRESS", s, e);
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_CODE" EnableViewState="false" EnableRowsCache="false"
                OnInit="devGrid_Init" OnBatchUpdate="devGrid_BatchUpdate" OnInitNewRow="devGrid_InitNewRow"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CODE" Caption="품목구분코드" Width="100px">
                        <PropertiesTextEdit MaxLength="4" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_CODENM" Caption="품목구분명" Width="200px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_RANK" Caption="순서" Width="80px">
                        <CellStyle HorizontalAlign="Center"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_IPADDRESS" Caption="품목그룹" Width="100px" />
