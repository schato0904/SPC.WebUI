<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0205_BORGWARNER.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0205_BORGWARNER" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="품목코드" Width="200px">
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="F_VENDORCD" Name="F_VENDORCD" Caption="거래처" Width="100px">
                        <PropertiesComboBox ConvertEmptyStringToNull="false">
                        </PropertiesComboBox>
                        <Settings AllowSort="True" />
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataCheckColumn FieldName="F_MACHSTND" Caption="수불사용" Visible="false" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_GUBN" Caption="품목구분" Visible="false" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_GROUP" Caption="품목그룹" Visible="false" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_UNIT" Caption="단위" Visible="false" />
                    <dx:GridViewDataTextColumn FieldName="F_DESIGN" Caption="보관장소" Visible="false">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataSpinEditColumn FieldName="F_DANGA" Caption="안정재고" Visible="false">
