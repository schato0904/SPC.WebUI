<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ANLS0302_foseco.aspx.cs" Inherits="SPC.WebUI.Pages.ANLS.ANLS0302_foseco" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_AdjustSize() {
            ...
            devGrid1.SetHeight(280);

            devGrid2.SetWidth(parseInt($(".search").width() - 1, 10));
            devGrid2.SetHeight(280);
                    ...
                    <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-7 control-label">시제품 DATA</label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">&nbsp;&nbsp;</label>
                                <div class="col-sm-7">
                                    <ucCTF:Date runat="server" id="ucDate" MonthOnly="true" MaxMonth="12" Visible="false" />
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <td style="width:33%;">
                <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-7 control-label">LINE DATA</label>
                            </div>
                            <div class="form-group">
        ...
        <td style="width:33%;">
             <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-7 control-label">품질 DATA</label>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">분석기간</label>
                                <div class="col-sm-7">
                                 ...
                                 <td style="height: 290px; padding-top: 10px;">
                                    ...
                                    <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                                        ...
                                        <ClientSideEvents Init="fn_OnGridInit" EndCallback="fn_OnGrid1EndCallback" CallbackError="fn_OnCallbackError" />
                                            <Columns>
                                                <dx:GridViewDataColumn FieldName="F_GB"  Caption="구분" Width="60px"   />
                                                <dx:GridViewDataColumn FieldName="F_CP" Caption="CP"  Width="60px"   >
                                                    <CellStyle HorizontalAlign="Right" />
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataColumn FieldName="F_CPK" Caption="CPK"  Width="60px"   >
                                                    <CellStyle HorizontalAlign="Right" />
                                                </dx:GridViewDataColumn>
                                                <dx:GridViewDataColumn FieldName="F_RANGE" Caption="RANGE"  Width="60px"   >
                                                    <CellStyle HorizontalAlign="Right" />
                                                </dx:GridViewDataColumn>
                                            </Columns>
                                    </dx:ASPxGridView>
                     ...
                     <td style="height: 290px; padding-top: 10px;">
                        ...
                        <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <ClientSideEvents Init="fn_OnGridInit" EndCallback="fn_OnGrid2EndCallback" CallbackError="fn_OnCallbackError" />
                                <Columns>
                                    <dx:GridViewDataColumn FieldName="F_YMNM"  Caption="년월" Width="60px"   />
                                    ...
                                    <dx:GridViewDataColumn FieldName="F_RANGE" Caption="RANGE"  Width="80px"   >
                                        <CellStyle HorizontalAlign="Right" />
                                    </dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn FieldName="F_AVG" Caption="평균값"  Width="80px"   >
                                        <CellStyle HorizontalAlign="Right" />
                                    </dx:GridViewDataColumn>
                                </Columns>
                        </dx:ASPxGridView>
