<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0102_NEW.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0102_NEW" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnRowDblClick(s, e) {
            ...
            parent.fn_OnDeleteTab('TISP01POP_NEW', parent.fn_OnGetTabObject('TISP01POP_NEW'));
            parent.parent.doCreateTab('MM07|MM0701|TISP|TISP01POP_NEW|전수측정경향|RP|1', oParams);
        }
    </script>
</asp:Content>
