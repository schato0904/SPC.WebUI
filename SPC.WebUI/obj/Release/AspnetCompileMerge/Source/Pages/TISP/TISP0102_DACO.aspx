<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0102_DACO.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0102_DACO" %>
            ...
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">                
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3 control-label">
                        <ucCTF:Date runat="server" id="ucDate" DateTimeOnly="false" SingleDate="false"  />
                    </div>                    
                    ...
                    <div class="col-sm-3 control-label">
                        ...
                        <div class="control-label" style="float: left; width: 50%;" >
                            <dx:ASPxComboBox ID="ddlGrade" runat="server" ClientInstanceName="ddlGrade" ValueField="F_GBN" >
        ...
        <div class="content">
            <section class="panel panel-default" style="height: 100%;">
                ...
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <SettingsBehavior AllowSort="true" ColumnResizeMode="Control" AllowSelectSingleRowOnly="true" AllowSelectByRowClick="false"/>
                    ...
                    <Columns>
                       ...
                       <%-- <dx:GridViewDataColumn FieldName="F_WORKDATE" Caption="일자" Visible="false">
                            <CellStyle HorizontalAlign="Right" />
                        </dx:GridViewDataColumn>--%>
                        

                        <%--<dx:GridViewDataColumn FieldName="F_STATUSNM" Visible="false" />--%>
