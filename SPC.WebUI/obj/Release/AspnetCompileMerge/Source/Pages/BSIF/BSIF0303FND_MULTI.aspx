<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0303FND_MULTI.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0303FND_MULTI" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            ...
            if (editRowIndex >= 0) {
                ...
                fn_OnControlAddAttr(s.GetEditor('F_ITEMCD'), null, 'ondblclick', "fn_OnPopupItemSearch('FORM')");
            }
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_BANCD" Caption="반" Width="40px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_LINECD" Caption="라인" Width="40px">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewBandColumn Caption="공정">
                        <Columns>
