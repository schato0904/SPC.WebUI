<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0403.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0403" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_CODE" Caption="불량조치코드" Width="100px">
                        <PropertiesTextEdit MaxLength="5" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_CODENM" Caption="불량조치명" Width="200px">
