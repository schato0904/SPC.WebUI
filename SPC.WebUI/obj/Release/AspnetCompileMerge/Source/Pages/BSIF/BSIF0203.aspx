<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0203.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0203" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            ...
            fn_OnBatchValidate("F_WORKCD1", s, e);
            fn_OnBatchValidate("F_WORKCD2", s, e);
            fn_OnBatchValidate("F_WORKNM", s, e);
        }
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                ...
                fn_OnControlDisableBox(s.GetEditor('F_WORKCD1'), null);
                fn_OnControlDisableBox(s.GetEditor('F_WORKCD2'), null);
                ...
                fn_OnControlDisableBox(s.GetEditor('F_WORKCD1'), null);
                fn_OnControlEnableBox(s.GetEditor('F_WORKCD2'), null);
            }
        }
        ...
        function fn_OnLINECDEditorSelectedIndexChanged(s, e) {
            ...
            devGrid.GetEditor("F_WORKCD1").SetText(P_BANCD + P_LINECD);
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_LINENM" Caption="라인명" Width="180px"  ReadOnly="true">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewBandColumn Caption="공정코드">
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="F_WORKCD1" Name="F_WORKCD1" Caption="공정코드" Width="70px" HeaderStyle-CssClass="WORKGRID" ReadOnly="true" >
                                <PropertiesTextEdit MaxLength="4" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_WORKCD2" Name="F_WORKCD2" Caption="공정코드" Width="70px" HeaderStyle-CssClass="WORKGRID">
                                <PropertiesTextEdit MaxLength="4" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
                    </dx:GridViewBandColumn>                    
                    <dx:GridViewDataTextColumn FieldName="F_WORKNM" Caption="공정명">
                        <CellStyle HorizontalAlign="Left"></CellStyle>                        
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_MACHGUBUN" Name="F_MACHGUBUN" Caption="설비구분" Width="120px" >
                        <PropertiesComboBox>
                            <Items>
                                <dx:ListEditItem Text="자주검사" Value="1" />
                                <dx:ListEditItem Text="샘플게더링" Value="2" />
                                <dx:ListEditItem Text="전수설비" Value="3" />
                                <dx:ListEditItem Text="3차원" Value="4" />
                                <dx:ListEditItem Text="치형" Value="5" />
                            </Items>                            
                        </PropertiesComboBox>
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_EQUIPCD" Caption="설비" Width="150px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataComboBoxColumn>
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="F_PCNM" Name="F_PCNM" Caption="PC명" Width="70px">
                        <Settings AllowSort="True" />                        
                    </dx:GridViewDataComboBoxColumn>
