<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="FITM0202.aspx.cs" Inherits="SPC.WebUI.Pages.FITM.FITM0202" %>
    ...
    <div class="container">
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">초품사유</label>
                    <div class="col-sm-2 control-label">
                        <ucCTF:FourM ID="ucFourM" runat="server"  />
                    </div>
                </div>
                <div class="form-group">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_BANNM" Caption="반명"  Width="80px"  />
                    <dx:GridViewDataColumn FieldName="F_LINENM" Caption="라인명"  Width="80px"  />
                    ...
                    <dx:GridViewDataColumn FieldName="F_FOURNMKR" Caption="초품사유"  Width="80px" />
                    <dx:GridViewDataColumn FieldName="F_FIRSTITENM" Caption="초품구분"  Width="120px" />
                    <dx:GridViewDataColumn FieldName="F_INSPDETAIL" Caption="검사항목" Width="150px" >
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_MEASURE" Caption="측정값"  Width="100px" >
                        <CellStyle HorizontalAlign="Right"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_ERR" Caption="오차범위"  Width="70px"  >
                        <CellStyle HorizontalAlign="Right"></CellStyle>
                    </dx:GridViewDataColumn>
