<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0402_CHUNIL.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0402_CHUNIL" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnExcelClick() {
            ...
            //_url += '&pMEAINSPCD=' + fn_GetCastValue('txtMEAINSPCD');
            _url += '&pMEAINSPCD=' + fn_GetCastValue('txtUCINSPITEMCD');
        ...
        function fn_MeainspPopUP(s, e) {
            var inputElement = txtMEAINSPCD.GetInputElement();
            if (!inputElement.disabled) {

                if (!txtMEAINSPCD.GetText() || txtMEAINSPCD.GetText() == '') {
    ...
    <div class="container">
                    ...
                    <div class="col-sm-2">
                       <%-- <div style="float: left; width: 40%; padding-right: 3px;">
                            <dx:ASPxTextBox ID="txtMEAINSPCD" ClientInstanceName="txtMEAINSPCD" runat="server" Width="100%" class="form-control input-sm"
                                OnInit="txtMEAINSPCD_Init" ClientSideEvents-LostFocus="fn_INSPfocusout">
                            </dx:ASPxTextBox>
                        </div>
                        ...
                        <ucCTF:Inspdetail ID="ucInspectionItem" runat="server" />
                    </div>
                </div>
            </div>
        </div>
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    <dx:GridViewCommandColumn Caption="SPC분석" Width="70px" FixedStyle="Left" >
                        <CustomButtons>                            
                            <dx:GridViewCommandColumnCustomButton ID="보기" />
                        </CustomButtons>
                    </dx:GridViewCommandColumn>
                    <dx:GridViewDataColumn FieldName="F_WORKNM"  Caption="공정명" Width="180px" FixedStyle="Left" >
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_WORKDATE" Caption="검사일자"  Width="80px" FixedStyle="Left" />
                    <dx:GridViewDataColumn FieldName="F_WORKTIME" Caption="검사시간" Width="80px" FixedStyle="Left" />
                    <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품목코드"  Width="150px" FixedStyle="Left" />
                    <dx:GridViewDataColumn FieldName="F_ITEMNM" Caption="품목명" Width="200px" FixedStyle="Left" >
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
