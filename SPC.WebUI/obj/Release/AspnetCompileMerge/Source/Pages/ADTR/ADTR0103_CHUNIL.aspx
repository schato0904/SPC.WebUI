<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0103_CHUNIL.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0103_CHUNIL" %>
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">시료수</label>
                    <div class="col-sm-2 control-label">
                        <div class="control-label" style="float: left; width: 50%;">
                            <dx:ASPxTextBox ID="srcSiryo" ClientInstanceName="srcSiryo" runat="server" Text="30" HorizontalAlign="Right" Width="80%"></dx:ASPxTextBox>
                        </div>
                        <div class="control-label" style="float: left; width: 50%;">
                            <label style="float: left;">이상</label>
                        </div>
                    </div>
                </div>
            </div>
