<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WKSD0101_MULTI.aspx.cs" Inherits="SPC.WebUI.Pages.WKSD.WKSD0101_MULTI" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnSettingWorks(TEXT) {
            hidWorkcd.SetText(TEXT);
        }
                    ...
                    <EditForm>
                        <div class="form-horizontal divEditForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <div style="float: left; width: 30%; padding-right: 3px;">
