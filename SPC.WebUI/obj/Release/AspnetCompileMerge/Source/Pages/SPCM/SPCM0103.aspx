<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0103.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0103" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_OTYPECD", s, e);
            fn_OnBatchValidate("F_OTYPENM", s, e);
        }

        // BatchEditStartEditing
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                var editor = s.GetEditor('F_OTYPECD');
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_OTYPECD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_OTYPECD" Caption="출고유형코드" Width="100px">
                        <PropertiesTextEdit MaxLength="5" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_OTYPENM" Caption="출고유형명" Width="200px">
