<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="DIOF0303.aspx.cs" Inherits="SPC.WebUI.Pages.DIOF.DIOF0303" %>
    ...
    <div class="container">
            ...
            <table class="contentTable">
                ...
                <tr>
                    ...
                    <td class="tdInput tdContentR">
                        <dx:ASPxComboBox ID="srcF_HISTTPCD" ClientInstanceName="srcF_HISTTPCD" runat="server" Width="100%"
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_REGDT" Caption="일시" Width="80px" />
                    <dx:GridViewDataColumn FieldName="F_HISTTPNM" Caption="구분" Width="50px" />
