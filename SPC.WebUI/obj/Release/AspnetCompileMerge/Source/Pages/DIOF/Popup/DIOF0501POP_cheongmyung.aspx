<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="DIOF0501POP_cheongmyung.aspx.cs" Inherits="SPC.WebUI.Pages.DIOF.Popup.DIOF0501POP_cheongmyung" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnSaveClick() {
            if (!devGridResp.batchEditApi.HasChanges())
                alert('변경된 사항이 없습니다');
            else {
                devGridResp.UpdateEdit();
            }
        }
    ...
    <div class="container">
        ...
        <div class="paging">
            ...
            <dx:ASPxGridView ID="devGridResp" ClientInstanceName="devGridResp" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_ROWNUM;F_OCCURDT;F_REMEDYIDX;F_INSPIDX;F_MACHIDX;F_NUMBER" EnableViewState="false" EnableRowsCache="false"
                OnCustomCallback="devGridResp_CustomCallback" 
                OnHtmlDataCellPrepared="devGridResp_HtmlDataCellPrepared"
                OnDataBound="devGridResp_DataBound"
                 OnBatchUpdate="devGridResp_BatchUpdate"
                 >
                <Styles>
                    <Header Font-Bold="true" HorizontalAlign="Center"></Header>
                    <Cell HorizontalAlign="Center" Font-Size="9pt" Wrap="False" CssClass="truncated" Cursor="pointer"></Cell>
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_ROWNUM" Caption="No" Width="40px" EditFormSettings-Visible="False" />
                    <dx:GridViewDataColumn FieldName="F_OCCURDT" Caption="점검일" Width="80px" EditFormSettings-Visible="False" />
                    <dx:GridViewDataColumn FieldName="F_INSPNM" Caption="항목명" Width="180px" EditFormSettings-Visible="False">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_NGTYPE" Caption="이상유형" Width="80px" >
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataTextColumn FieldName="F_NGREMK" Caption="이상내역" Width="250px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_USERNM" Caption="등록자" Width="100px" EditFormSettings-Visible="False">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    ...
                    <dx:GridViewDataColumn FieldName="F_RESPUSER" Caption="조치자" Width="100px" EditFormSettings-Visible="False" >
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_RESPDT" Caption="완료일" Width="100px" EditFormSettings-Visible="False" />
                    <dx:GridViewDataComboBoxColumn FieldName="F_STATUS" Caption="진행상태" Width="70px"  />
