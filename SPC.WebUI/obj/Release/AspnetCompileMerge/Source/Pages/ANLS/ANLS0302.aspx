<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ANLS0302.aspx.cs" Inherits="SPC.WebUI.Pages.ANLS.ANLS0302" %>
                    ...
                    <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-7 control-label">T/O DATA</label>
                            </div>
                            <div class="form-group">
                     ...
                     <td style="height: 290px; padding-top: 10px;">
                        ...
                        <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <ClientSideEvents Init="fn_OnGridInit" EndCallback="fn_OnGrid2EndCallback" CallbackError="fn_OnCallbackError" />
                                <Columns>
                                    <dx:GridViewDataColumn FieldName="F_YMNM"  Caption="연월" Width="60px"   />
