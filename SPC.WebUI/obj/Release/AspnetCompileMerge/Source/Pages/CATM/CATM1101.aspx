<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1101.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1101" %>
<%-- 설비정보관리 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">        // 사용자 정의 함수
        ...
        function SetPageEnable(enable) {
            ...
            srcF_MACHTYPECD.SetEnabled(enable);
        ...
        function SetValue(data) {
            ...
            if (typeof data.F_MACHTYPECD != 'undefined') srcF_MACHTYPECD.SetValue(data.F_MACHTYPECD);
        ...
        <div id="divRight" style="width:100%;float:left;">
            ...
            <div id="divRightTop" style="margin-bottom:10px;">
                <table class="InputTable" style="margin-bottom: 5px;width:100%;">
                    ...
                    <tr>
                        <td class="tdTitle">설비분류</td>
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <%--<dx:ASPxTextBox runat="server" ID="srcF_MACHTYPECD" ClientInstanceName="srcF_MACHTYPECD" ClientEnabled="false" Width="100%">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" RequiredField-IsRequired="true" ValidateOnLeave="true" RequiredField-ErrorText="필수항목입니다.">
                                    </ValidationSettings>
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>--%>
                                <ucCTF:SYCOD01 runat="server" id="srcF_MACHTYPECD" ClientInstanceName="srcF_MACHTYPECD" F_CODEGROUP="40" nullText="--선택하세요--" IsRequired="true"></ucCTF:SYCOD01>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_SERIALNO" Caption="Serial No." Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_MAKER" Caption="제조사" Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_MAKEYMD" Caption="제조년월" Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_INYMD" Caption="도입년월" Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_MACHTYPENM" Caption="설비분류" Width="90px"/>
                        <dx:GridViewDataColumn FieldName="F_USEYN" Caption="가동여부" Width="90px"/>
