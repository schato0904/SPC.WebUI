<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM5001.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM5001" %>
<%-- 보온로 모니터링 --%>
            ...
            <div id="divRightBody" style="width:30%;float:left;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_WORKTIME" Caption="작업시간" Width="30%"/>
                        <dx:GridViewDataTextColumn FieldName="F_TEMP01" Caption="보온로온도" Width="30%"/>
                        <dx:GridViewDataTextColumn FieldName="F_TEMP02" Caption="분위기온도" Width="30%"/>
                    </Columns>
                </dx:ASPxGridView>
