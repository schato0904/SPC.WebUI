<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2104.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2104" %>
<%-- 입출고이력 조회 --%>
        ...
        <div id="divRight" style="width:100%;">
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdTitle">입출고구분</td>
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxComboBox runat="server" ID="schF_INOUT" ClientInstanceName="schF_INOUT" IncrementalFilteringMode="None" ValueType="System.String" >
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                    <Items>
                                        <dx:ListEditItem Value="ALL" Text="--전체--" Selected="true" />
                                        <dx:ListEditItem Value="IN" Text="입고" />
                                        <dx:ListEditItem Value="OUT" Text="출고" />
                                    </Items>
                                </dx:ASPxComboBox>
                            </div>
                        </td>
                        <td class="tdTitle">원재료구분</td>
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxComboBox runat="server" ID="schF_GUBUNCD" ClientInstanceName="schF_GUBUNCD" IncrementalFilteringMode="None" ValueType="System.String" >
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                    <Items>
                                        <dx:ListEditItem Value="" Text="--전체--" Selected="true" />
                                        <dx:ListEditItem Value="01" Text="원재료" />
                                        <dx:ListEditItem Value="02" Text="중자" />
                                        <dx:ListEditItem Value="03" Text="기타" />
                                    </Items>
                                </dx:ASPxComboBox>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdContentL" colspan="4">&nbsp;</td>
                    </tr>
                </table>
            </div>
            <div style="clear:both;"></div>
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_STOCKNO" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataDateColumn FieldName="F_STDDATE" Caption="입출고일시" Width="140px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss"/>
                        <dx:GridViewDataColumn FieldName="F_INOUT" Caption="입출고구분" Width="90px"/>
                        <dx:GridViewDataColumn FieldName="F_STOCKNO" Caption="입출고번호" Width="140px"/>
                        <dx:GridViewDataColumn FieldName="F_GUBUNNM" Caption="원재료구분" Width="100px"/>
                        ...
                        <dx:GridViewDataColumn FieldName="F_INOUTTYPENM" Caption="입출고유형" Width="100px"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_INCNT" Caption="입고수량" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_OUTCNT" Caption="출고수량" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_INGOT" Caption="잉곳" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_SCRAP" Caption="스크랩" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
