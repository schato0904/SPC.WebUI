<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM3001.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM3001" %>
<%-- 출하처등록 --%>
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                ...
                                <dx:ASPxTextBox runat="server" ID="srcF_CUSTTYPECD" ClientInstanceName="srcF_CUSTTYPECD" ClientEnabled="false" Width="100%" ClientVisible="false" Text="02">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxTextBox>
                            </div>
                        </td>
                        <td class="tdTitle">출하처명</td>
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_CUSTCD" Caption="출하처코드" Width="90px"/>
                        <dx:GridViewDataTextColumn FieldName="F_CUSTNM" Caption="출하처명" Width="90px"/>
