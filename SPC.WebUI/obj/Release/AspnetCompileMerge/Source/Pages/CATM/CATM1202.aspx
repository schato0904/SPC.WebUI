<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1202.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1202" %>
<%-- 작업지시서 조회 --%>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_WORKNO" Caption="작업지시번호" Width="6%"/>
                        <dx:GridViewDataTextColumn FieldName="F_PLANYMD" Caption="지시일" Width="5%"/>
                        <dx:GridViewDataTextColumn FieldName="F_WORKNO_SEQ" Caption="작업순서" Width="4%"/>
                        <dx:GridViewDataTextColumn FieldName="F_LOTNO" Caption="Lot No." Width="4%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MACHNM" Caption="설비명" Width="5%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MELTNM" Caption="보온로" Width="5%"/>
                        <dx:GridViewDataTextColumn FieldName="F_ITEMCD" Caption="생산품번" Width="7%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MOLDNO" Caption="금형번호" Width="7%"/>
                        <dx:GridViewDataTextColumn FieldName="F_MOLDNTH" Caption="금형차수" Width="4%"/>
                        <dx:GridViewDataTextColumn FieldName="F_CAVITY" Caption="Cavity" Width="3%"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_PLANCOUNT" Caption="지시수량" Width="4%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRODCOUNT" Caption="생산수량" Width="4%" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataTextColumn FieldName="F_STATUSNM" Caption="상태" Width="3%"/>
                        <dx:GridViewDataTextColumn FieldName="F_WORKER" Caption="작업자" Width="10%" CellStyle-HorizontalAlign="Left"/>
                        <dx:GridViewDataTextColumn FieldName="F_SDATETIME" Caption="지시시작시간" Width="9%"/>
                        <dx:GridViewDataTextColumn FieldName="F_EDATETIME" Caption="지시종료시간" Width="9%"/>
