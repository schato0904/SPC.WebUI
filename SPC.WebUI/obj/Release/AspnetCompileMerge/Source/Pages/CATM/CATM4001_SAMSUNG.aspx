<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM4001_SAMSUNG.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM4001_SAMSUNG" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">        // 사용자 정의 함수
        ...
        function SetClear(isFirst) {
            ...
            srcF_TEMP_STD.SetValue(0);
            srcF_TEMP_MIN.SetValue(0);
            srcF_TEMP_MAX.SetValue(0);
        ...
        function SetPageEnable(enable) {
            ...
            srcF_TEMP_STD.SetEnabled(enable);
            srcF_TEMP_MIN.SetEnabled(enable);
            srcF_TEMP_MAX.SetEnabled(enable);
        ...
        function SetValue(data) {
            ...
            if (typeof data.F_TEMP_STD != 'undefined') srcF_TEMP_STD.SetValue(data.F_TEMP_STD);
            if (typeof data.F_TEMP_MIN != 'undefined') srcF_TEMP_MIN.SetValue(data.F_TEMP_MIN);
            if (typeof data.F_TEMP_MAX != 'undefined') srcF_TEMP_MAX.SetValue(data.F_TEMP_MAX);
        ...
        <div id="divRight" style="width: 70%; float: left;">
            ...
            <div id="divRightTop" style="margin-bottom: 10px;">
                <table class="InputTable" style="margin-bottom: 5px; width: 100%;">
                    ...
                    <tr>
                        <td class="tdTitle">금형下 온도 Std.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_STANDARD" ClientInstanceName="srcF_STANDARD" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        <td class="tdTitle">금형下 온도 Min.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_MIN" ClientInstanceName="srcF_MIN" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        <td class="tdTitle">금형下 온도 Max.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_MAX" ClientInstanceName="srcF_MAX" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_SLOPETIME_STD" ClientInstanceName="srcF_SLOPETIME_STD" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        <td class="tdTitle">기울기시간 Min.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_SLOPETIME_MIN" ClientInstanceName="srcF_SLOPETIME_MIN" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        <td class="tdTitle">기울기시간 Max.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_SLOPETIME_MAX" ClientInstanceName="srcF_SLOPETIME_MAX" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_WAITTIME_STD" ClientInstanceName="srcF_WAITTIME_STD" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        ...
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_WAITTIME_MIN" ClientInstanceName="srcF_WAITTIME_MIN" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        ...
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                ...
                                <dx:ASPxSpinEdit runat="server" ID="srcF_WAITTIME_MAX" ClientInstanceName="srcF_WAITTIME_MAX" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                    ...
                    <tr>
                         <td class="tdTitle">용해로온도 Std.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                <dx:ASPxSpinEdit runat="server" ID="srcF_TEMP_STD" ClientInstanceName="srcF_TEMP_STD" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        <td class="tdTitle">용해로온도 Min.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                <dx:ASPxSpinEdit runat="server" ID="srcF_TEMP_MIN" ClientInstanceName="srcF_TEMP_MIN" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
                        <td class="tdTitle">용해로온도 Max.</td>
                        <td class="tdContent">
                            <div style="width: 100%; float: left;">
                                <dx:ASPxSpinEdit runat="server" ID="srcF_TEMP_MAX" ClientInstanceName="srcF_TEMP_MAX" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false">
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                            </div>
                        </td>
            ...
            <div id="divRightBody" style="width: 100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="금형 下온도">
                            <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="기울기시간">
                            <Columns>
                        ...
                        <dx:GridViewBandColumn Caption="용해로온도">
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="F_TEMP_STD" Caption="Std" Width="70px" />
                                <dx:GridViewDataTextColumn FieldName="F_TEMP_MIN" Caption="Min" Width="70px" />
                                <dx:GridViewDataTextColumn FieldName="F_TEMP_MAX" Caption="Max" Width="70px" />
                            </Columns>
                        </dx:GridViewBandColumn>
