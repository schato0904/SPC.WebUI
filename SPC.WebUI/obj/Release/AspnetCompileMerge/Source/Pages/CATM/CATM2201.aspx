<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2201.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2201" %>
<%-- 일별재고현황 조회 --%>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRECNT" Caption="전일재고" Width="100px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_INCNT" Caption="당일입고" Width="100px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_OUTCNT" Caption="당일출고" Width="100px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_NEEDCOUNT" Caption="적정재고" Width="100px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_REMAINS" Caption="현재고" Width="100px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataColumn FieldName="F_UNIT" Caption="단위" Width="100px"/>
                    </Columns>
                </dx:ASPxGridView>
