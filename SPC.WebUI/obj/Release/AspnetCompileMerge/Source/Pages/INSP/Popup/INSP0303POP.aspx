<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="INSP0303POP.aspx.cs" Inherits="SPC.WebUI.Pages.INSP.Popup.INSP0303POP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnSearchClick() {
            var data = '{';
            data += '"ACTION":"GET"';
            data += ',"F_QWK13IMID":"' + fn_GetCastValue('hidQWK13IMID') + '"';
            data += ',"F_REPORTTP":"' + fn_GetCastValue('hidREPORTTP') + '"';
            data += ',"F_ITEMCD":"' + fn_GetCastValue('hidITEMCD') + '"';
            data += ',"F_WORKCD":"' + fn_GetCastValue('hidWORKCD') + '"';
            data += ',"F_WORKDATE":"' + fn_GetCastValue('hidWORKDATE') + '"';
            data += '}';
        ...
        function fn_OnSaveClick() {
            if (fn_GetCastValue('hidCONFIRM') == 'true') {
                alert('확정한 검사성적서는 수정할 수 없습니다');
                return false;
            }
        ...
        function fn_OnPrintClick() {
            ...
            data += ',"F_QWK13IMID":"' + fn_GetCastValue('hidQWK13IMID') + '"';
            data += ',"F_REPORTTP":"' + fn_GetCastValue('srcF_REPORTTP') + '"';
            data += '}';
            fn_OnPopupINSPREPORT(data, fn_GetCastText('srcF_REPORTTP'), fn_GetCastValue('srcF_REPORTTP') == 'AAI115');
        }
        ...
        function fn_OnSetControlVisibility(val) {
            ...
            if (fn_GetCastValue('hidCONFIRM') == 'false') {
                switch (val) {
                ...
                fn_OnControlDisableBox(srcF_LOTNO, null);
                fn_OnControlDisableBox(srcF_WORKMAN, null);
            }
        ...
        function fn_OnCreateJsonData() {
            ...
            data += ',"F_CONFIRM":"0"';
            if (fn_GetCastSelectedItemValue('srcF_REPORTTP') == 'AAI123') {
                if (fn_GetCastValue('hidSAMPLEDATA') == '')
                    data += ',"F_EFITEMS":""';
                else
        ...
        function fn_InputData(pagedata) {
            var F_QWK13IMID = GetJsonValueByKey(pagedata, 'F_QWK13IMID', '');
            ...
            fn_SetTextValue('hidQWK13IMID', GetJsonValueByKey(pagedata, 'F_QWK13IMID', ''));
            fn_SetValue('srcF_REPORTTP', GetJsonValueByKey(pagedata, 'F_REPORTTP', ''));
            fn_SetTextValue('srcF_WORKDATE', GetJsonValueByKey(pagedata, 'F_WORKDATE', ''));
            fn_SetTextValue('srcF_ITEMCD', GetJsonValueByKey(pagedata, 'F_ITEMCD', ''));
            fn_SetTextValue('srcF_ITEMNM', GetJsonValueByKey(pagedata, 'F_ITEMNM', ''));
            fn_SetTextValue('srcF_WORKCD', GetJsonValueByKey(pagedata, 'F_WORKCD', ''));
            fn_SetTextValue('srcF_WORKNM', GetJsonValueByKey(pagedata, 'F_WORKNM', ''));
            fn_SetTextValue('srcF_LOTNO', GetJsonValueByKey(pagedata, 'F_LOTNO', ''));
            fn_SetTextValue('srcF_MOLDNO', GetJsonValueByKey(pagedata, 'F_MOLDNO', ''));
            fn_SetTextValue('srcF_WORKMAN', GetJsonValueByKey(pagedata, 'F_WORKMAN', ''));
            fn_SetTextValue('srcF_KSINFO', GetJsonValueByKey(pagedata, 'F_KSINFO', ''));
            fn_SetTextValue('srcF_TITLE', GetJsonValueByKey(pagedata, 'F_TITLE', ''));
            fn_SetTextValue('srcF_WRITER', GetJsonValueByKey(pagedata, 'F_WRITER', ''));
            fn_SetTextValue('srcF_REVIEWER', GetJsonValueByKey(pagedata, 'F_REVIEWER', ''));
            fn_SetTextValue('srcF_APPROVER', GetJsonValueByKey(pagedata, 'F_APPROVER', ''));
            fn_SetTextValue('srcF_LOTCNT', GetJsonValueByKey(pagedata, 'F_LOTCNT', ''));
            fn_SetTextValue('srcF_UNIT', GetJsonValueByKey(pagedata, 'F_UNIT', ''));
            fn_SetValue('srcF_JUDGE', GetJsonValueByKey(pagedata, 'F_JUDGE', ''));
            fn_SetTextValue('srcF_MATERIAL', GetJsonValueByKey(pagedata, 'F_MATERIAL', ''));
            fn_SetTextValue('srcF_INCNT', GetJsonValueByKey(pagedata, 'F_INCNT', ''));
            fn_SetTextValue('srcF_INUNIT', GetJsonValueByKey(pagedata, 'F_INUNIT', ''));
            fn_SetTextValue('srcF_INDATE', GetJsonValueByKey(pagedata, 'F_INDATE', ''));
            fn_SetTextValue('srcF_INITEMTITLE', GetJsonValueByKey(pagedata, 'F_INITEMTITLE', ''));
            fn_SetTextValue('srcF_INCUST', GetJsonValueByKey(pagedata, 'F_INCUST', ''));
            fn_SetTextValue('srcF_INBASENO', GetJsonValueByKey(pagedata, 'F_INBASENO', ''));
            fn_SetTextValue('srcF_ESTDATE', GetJsonValueByKey(pagedata, 'F_ESTDATE', ''));
            fn_SetTextValue('srcF_INJCUST', GetJsonValueByKey(pagedata, 'F_INJCUST', ''));
            fn_SetTextValue('srcF_INJDATE', GetJsonValueByKey(pagedata, 'F_INJDATE', ''));
            fn_SetTextValue('srcF_THERMICOUT', GetJsonValueByKey(pagedata, 'F_THERMICOUT', ''));
            fn_SetTextValue('srcF_THERMICUNIT', GetJsonValueByKey(pagedata, 'F_THERMICUNIT', ''));
            fn_SetTextValue('srcF_COVEROUT', GetJsonValueByKey(pagedata, 'F_COVEROUT', ''));
            fn_SetTextValue('srcF_COVERUNIT', GetJsonValueByKey(pagedata, 'F_COVERUNIT', ''));
            fn_SetTextValue('srcF_INTYPE', GetJsonValueByKey(pagedata, 'F_INTYPE', ''));
            fn_SetTextValue('srcF_INMATERIAL', GetJsonValueByKey(pagedata, 'F_INMATERIAL', ''));
            fn_SetTextValue('srcF_DRAWNO', GetJsonValueByKey(pagedata, 'F_DRAWNO', ''));
            fn_SetTextValue('srcF_INITEMNM', GetJsonValueByKey(pagedata, 'F_INITEMNM', ''));
            fn_SetTextValue('srcF_INTEMP', GetJsonValueByKey(pagedata, 'F_INTEMP', ''));
            fn_SetTextValue('srcF_CYCEL', GetJsonValueByKey(pagedata, 'F_CYCEL', ''));
            fn_SetTextValue('srcF_CYCELUNIT', GetJsonValueByKey(pagedata, 'F_CYCELUNIT', ''));
            fn_SetTextValue('srcF_MACHINE', GetJsonValueByKey(pagedata, 'F_MACHINE', ''));
            fn_SetTextValue('srcF_DISTRIBUTE', GetJsonValueByKey(pagedata, 'F_DISTRIBUTE', ''));
            fn_SetTextValue('srcF_THERMICCNT', GetJsonValueByKey(pagedata, 'F_THERMICCNT', ''));
            fn_SetTextValue('srcF_COATING', GetJsonValueByKey(pagedata, 'F_COATING', ''));
            fn_SetTextValue('srcF_COVERING', GetJsonValueByKey(pagedata, 'F_COVERING', ''));
            fn_SetTextValue('srcF_RAWLOTNO', GetJsonValueByKey(pagedata, 'F_RAWLOTNO', ''));
            fn_SetTextValue('srcF_INJMACHINE', GetJsonValueByKey(pagedata, 'F_INJMACHINE', ''));
            fn_SetTextValue('srcF_WIRELOTNO', GetJsonValueByKey(pagedata, 'F_WIRELOTNO', ''));
            fn_SetTextValue('srcF_MAKEDATE', GetJsonValueByKey(pagedata, 'F_MAKEDATE', ''));
            fn_SetValue('srcF_DAYNIGHT', GetJsonValueByKey(pagedata, 'F_DAYNIGHT', ''));
            fn_SetTextValue('hidCONFIRM', GetJsonValueByKey(pagedata, 'F_CONFIRM', ''));
        ...
        function fn_OnSetSampleData(data) {
            ...
            devGrid2.PerformCallback('RESET' + data);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <dx:ASPxTextBox ID="hidQWK13IMID" ClientInstanceName="hidQWK13IMID" runat="server" ClientVisible="false" />
    <dx:ASPxTextBox ID="hidREPORTTP" ClientInstanceName="hidREPORTTP" runat="server" ClientVisible="false" />
    ...
    <dx:ASPxTextBox ID="hidCONFIRM" ClientInstanceName="hidCONFIRM" runat="server" ClientVisible="false" />
