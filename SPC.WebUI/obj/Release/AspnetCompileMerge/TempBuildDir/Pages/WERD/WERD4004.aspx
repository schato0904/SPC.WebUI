<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD4004.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD4004" %>
                            ...
                            <tr>
                                <td style="height: 250px; padding-top: 5px;" colspan="2" >
                                    <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="true" Width="100%" 
                                        ...
                                        KeyFieldName="공정코드" EnableViewState="false" EnableRowsCache="false"  OnHtmlRowPrepared="devGrid_HtmlRowPrepared" OnHtmlDataCellPrepared="devGrid_HtmlDataCellPrepared"  >
                                        <Styles>
