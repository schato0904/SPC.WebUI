<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD0310.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD0310" %>
    ...
    <div class="container">
            ...
            <tr>
                ...
                <td class="tdContentR">
                    <dx:ASPxRadioButtonList ID="rdoGbn" ClientInstanceName="rdoGbn" runat="server"
                        ...
                        <Items>
                            <dx:ListEditItem Selected="true" Text="모델별집계" Value="0" />
                            <dx:ListEditItem Text="모델&품목별집계" Value="1" />
                        </Items>
        ...
        <div class="content" id="prinDiv1">
            <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="False"  Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataColumn FieldName="F_MODELCD" Caption="모델ID" Width="100" FixedStyle="Left">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_MODELNM" Caption="모델명"  Width="150" FixedStyle="Left">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
        ...
        <div class="content" id="prinDiv2" style="display:none;">
            <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="False"  Width="100%"
                KeyFieldName="F_ITEMCD;F_MODELCD" EnableViewState="False" EnableRowsCache="False"
                OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText" OnDataBound="devGrid_DataBound"
                OnCustomCallback="devGrid_CustomCallback" OnCustomSummaryCalculate="devGrid_CustomSummaryCalculate">
                <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                <Styles>
