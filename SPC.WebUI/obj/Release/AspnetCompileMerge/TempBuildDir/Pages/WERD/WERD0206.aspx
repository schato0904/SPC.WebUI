<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD0206.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD0206" %>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_USERID" Caption="검사자ID" Width="80px"  CellStyle-HorizontalAlign="Left"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_USERNM" Caption="검사자명" Width="100px"  CellStyle-HorizontalAlign="Left"></dx:GridViewDataColumn>                    
                    ...
                    <dx:GridViewDataColumn FieldName="F_TYPEWORST" Caption="부적합유형및수량(WORST5)" Width="420px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_CAUSEWORST" Caption="부적합원인및수량(WORST5)" Width="420px" CellStyle-HorizontalAlign="Left"></dx:GridViewDataColumn>
                </Columns>
                <TotalSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="F_LOTNO" DisplayFormat="합계" />
