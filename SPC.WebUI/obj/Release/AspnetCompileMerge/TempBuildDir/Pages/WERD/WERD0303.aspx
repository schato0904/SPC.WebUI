<%@ Page Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD0303.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD0303" %>
    ...
    <div class="container">
        <table class="InputTable">
            ...
            <tr>
                ...
                <td class="tdContent">
                    <ucCTF:ModelDDL ID="ucModelDDL" runat="server" ClientInstanceID="ucModelDDL" />
                </td>
                <td class="tdTitle">
                    <label>공정코드</label>
                </td>
        ...
        <div class="content" id="prinDiv1">
            <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false"  Width="100%"
                KeyFieldName="F_MODELCD;F_ITEMCD" EnableViewState="False" EnableRowsCache="False"
                ...
                <Columns>
                 <dx:GridViewDataTextColumn FieldName="F_NUMBER" Caption="No." Width="50" Visible="false" ></dx:GridViewDataTextColumn>
                     <dx:GridViewDataColumn FieldName="F_MODELCD" Caption="모델코드"  Width="11%">
                        <CellStyle HorizontalAlign="Center" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_MODELNM" Caption="모델명"  Width="15%">
                        <CellStyle HorizontalAlign="Left" />

                    </dx:GridViewDataColumn>

                    <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명"  Width="14%">
                        <FooterTemplate>
                            <span>합계</span>
                        </FooterTemplate>
                        <CellStyle HorizontalAlign="Left" />    
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_PRODUCTQTY" Caption="생산수량"  Width="10%">
                        <CellStyle HorizontalAlign="Right" />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_INSPQTY" Caption="검사수량"  Width="10%">
                        <CellStyle HorizontalAlign="Right" />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_NGQTY" Caption="부적합수량"  Width="10%">
                        <CellStyle HorizontalAlign="Right" />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_NGRATE" Caption="부적합률(%)"  Width="10%">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataTextColumn FieldName="F_PPM" Caption="PPM"  Width="10%">
                        <CellStyle HorizontalAlign="Right" />
                        <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_LOSSAMT" Caption="손실금액(원)" Width="10%">
                        <CellStyle HorizontalAlign="Right" />
                        <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                </Columns>
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="F_NUMBER" SummaryType="Custom" Visible="false" />
        ...
        <div class="content" id="prinDiv2" style="display:none;">
            <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="False"  Width="100%"
                ...
                <Columns>
                    <dx:GridViewDataTextColumn FieldName="F_NUMBER" Caption="No." Width="50" Visible="false" ></dx:GridViewDataTextColumn>
                     <dx:GridViewDataColumn FieldName="F_MODELCD" Caption="모델코드"  Width="6%">
                        <CellStyle HorizontalAlign="Center" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_MODELNM" Caption="모델명"  Width="7%">
                        <CellStyle HorizontalAlign="Left" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명"  Width="11%">
                        <CellStyle HorizontalAlign="Left" />
                        
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataTextColumn FieldName="F_ITEMNM" Caption="품목명" Width="12%">
                        <CellStyle HorizontalAlign="Left" />
                        <FooterTemplate>
                            <span>합계</span>
                        </FooterTemplate>
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_PRODUCTQTY" Caption="생산수량"  Width="6%">
                        <CellStyle HorizontalAlign="Right" />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_INSPQTY" Caption="검사수량"  Width="6%">
                        <CellStyle HorizontalAlign="Right" />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_NGQTY" Caption="부적합수량"  Width="6%">
                        <CellStyle HorizontalAlign="Right" />
                         <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_NGRATE" Caption="부적합률(%)"  Width="6%">
                        <CellStyle HorizontalAlign="Right" />
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataTextColumn FieldName="F_PPM" Caption="PPM"  Width="6%">
                        <CellStyle HorizontalAlign="Right" />
                        <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn FieldName="F_LOSSAMT" Caption="손실금액(원)" Width="6%">
                        <CellStyle HorizontalAlign="Right" />
                        <PropertiesTextEdit DisplayFormatString="n0" />
                    </dx:GridViewDataTextColumn>
                     ...
                     <dx:GridViewBandColumn Caption="부적합유형">
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="F_NGTYPENM" Caption="내용" Width="8%">
                                <CellStyle HorizontalAlign="Left" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_NGTYPECNT" Caption="수량" Width="6%">
                                <CellStyle HorizontalAlign="Right" />
                                <PropertiesTextEdit DisplayFormatString="n0" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
                    ...
                    <dx:GridViewBandColumn Caption="부적합원인">
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="F_NGCAUSENM" Caption="내용" Width="8%">
                                <CellStyle HorizontalAlign="Left" />
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="F_NGCAUSECNT" Caption="수량" Width="6%">
                                <CellStyle HorizontalAlign="Right" />
                                <PropertiesTextEdit DisplayFormatString="n0" />
                            </dx:GridViewDataTextColumn>
                        </Columns>
                ...
                <TotalSummary>
                    <dx:ASPxSummaryItem FieldName="F_NUMBER" SummaryType="Custom" Visible="false" />
                    <dx:ASPxSummaryItem FieldName="F_ITEMNM" SummaryType="Custom" Visible="false" />
                    <dx:ASPxSummaryItem FieldName="F_PRODUCTQTY" SummaryType="Custom" DisplayFormat="{0:n0}" />
                    <dx:ASPxSummaryItem FieldName="F_INSPQTY" SummaryType="Custom" DisplayFormat="{0:n0}" />
                    <dx:ASPxSummaryItem FieldName="F_NGQTY" SummaryType="Custom" DisplayFormat="{0:n0}" />
                    <dx:ASPxSummaryItem FieldName="F_NGRATE" SummaryType="Custom" DisplayFormat="{0:##0.##}" />
