<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD0101.aspx.cs" Inherits="SPC.WebUI.Pages.WERD.WERD0101" %>
<%-- 공정별 품목 등록 --%>
    ...
    <script type="text/javascript">
        ...
        function fn_OnSaveClick() {
            ...
            for (i = 0; i < rowCount; i++) {
                var lossamt = '';
                if (devGrid1.batchEditApi.GetCellValue(i, 'F_LOSSAMT') == null || devGrid1.batchEditApi.GetCellValue(i, 'F_LOSSAMT') == 'undefined' || devGrid1.batchEditApi.GetCellValue(i, 'F_LOSSAMT') == '') {
                    lossamt = ''
                } else {
                    lossamt = devGrid1.batchEditApi.GetCellValue(i, 'F_LOSSAMT');
                }
                lossamtvalues += lossamt + ',';
            }
            lossamtvalues += '@#';
            lossamtvalues = lossamtvalues.replace(',@#', '');

            lossamtvalues = lossamtvalues.replace('@#', '');



            devGrid1.PerformCallback('SAVE|' + lossamtvalues);
        }
            ...
            <div id="divTopLeft" style="height:100%;width:40%;display:inline-block;padding-right:5px;">
                ...
                <div id="divTopLeftTitle">
                    <div class="form-group padder">
                        <label class="col-sm-12 h5 font-bold bg-primary" style="padding:5px;">■ 공정목록</label>
                    </div>
                </div>
                <%-- 좌상단 조회조건 --%>
                <div id="divTopLeftSearch" >
                  <table class="InputTable">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                           <dx:ASPxTextBox ID="schF_PROCCD" ClientInstanceName="schF_PROCCD" runat="server" Width="100%" ClientVisible="false" ></dx:ASPxTextBox>
                            <dx:ASPxTextBox ID="schF_PROCNM" ClientInstanceName="schF_PROCNM" runat="server" Width="100%"></dx:ASPxTextBox>
                        </td>
                        <td class="tdContent">
                    ...
                    <section class="panel panel-default" style="height: 98%;">
                        ...
                        <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명" Width="100%" CellStyle-HorizontalAlign="Left" ></dx:GridViewDataColumn>
                            </Columns>
            ...
            <section class="panel panel-default" style="height: 100%;">
                ...
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_WORKCD" Caption="공정코드" Width="100px" ReadOnly="true" />
                        <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명" Width="200px" ReadOnly="true" CellStyle-HorizontalAlign="Left" />
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_LOSSAMT" Name="F_LOSSAMT" Caption="단가" Width="110px" PropertiesSpinEdit-DisplayFormatString="#,#" >
