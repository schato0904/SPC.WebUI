<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WERD_DACO2001.aspx.cs" Inherits="SPC.WebUI.Pages.WERDDACO.WERD_DACO2001" %>
    ...
    <script type="text/javascript">
        ...
        function fn_grid(s, e) {
            ...
            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr[id$=DXDataRow2]>td:gt(0)').each(function (idx) {
                arrData[idx] = { "Bancd": $(this).text(), "Itemnm": arrData[idx]["Itemnm"], "Itemcd": arrData[idx]["Itemcd"] };
            });

            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr[id$=DXDataRow4]>td:gt(0)').each(function (idx) {
                arrData[idx] = { "Linecd": $(this).text(), "Bancd": arrData[idx]["Bancd"], "Itemnm": arrData[idx]["Itemnm"], "Itemcd": arrData[idx]["Itemcd"] };
            });

            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr:gt(0)').each(function (idx) {
                $(this).find('td:gt(0)').each(function (idx) {
                    $(this).on("click", function () {
                        fn_Chart2Callback(arrData[idx]["Itemcd"], arrData[idx]["Itemnm"], arrData[idx]["Bancd"], arrData[idx]["Linecd"]);
                    });
                });
            });
        }

        function fn_Chart2Callback(itemcd, Itemnm, Bancd, Linecd) {
            _Itemcd = itemcd + '|' + Itemnm + '|' + Bancd + '|' + Linecd
            fn_OnChartDoCallback2(devChart2, chartWidth2, chartHeight1)
        }
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2 control-label">
                        <ucCTF:ModelDDL ID="ucModelDDL" runat="server" Visible="false"/>
                    </div>
                    ...
                    <dx:ASPxRadioButtonList ID="rdoGBN" ClientInstanceName="rdoGBN" runat="server" Visible="false"
                    ...
                    <dx:ASPxRadioButtonList ID="rdoUNIT" ClientInstanceName="rdoUNIT" runat="server" Visible="false"
                        RepeatDirection="Horizontal" Paddings-Padding="0px" Border-BorderStyle="None">
                        <Items>
            ...
            <table class="tblContents" style="width: 100%;">
                ...
                <tr>
                    <td style="height: 290px; padding-top: 10px;" colspan="2">
                        ...
                        <p>하단의 열을 클릭하시면 해당하는 품목의 불량 점유율을 볼 수 있습니다.</p>
