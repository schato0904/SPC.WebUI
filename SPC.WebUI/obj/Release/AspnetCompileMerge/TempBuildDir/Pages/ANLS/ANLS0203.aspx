<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ANLS0203.aspx.cs" Inherits="SPC.WebUI.Pages.ANLS.ANLS0203" %>
                                            ...
                                            <table class="table table-striped b-t b-light" style="border:solid 1px #9F9F9F;">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td id="tdResult17" style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-right m-r-xs">
                                                        </td>
                                                        <td style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-center">UCLX</td>
                                                        <td id="tdResult18" style="width: 25%; padding-left: 3px; padding-right: 3px;" class="text-right m-r-xs">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-center">LCLX(목표)</td>
                                                        <td id="tdResult19" style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-right m-r-xs">
                                                        </td>
                                                        <td style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-center">LCLX</td>
                                                        <td id="tdResult20" style="width: 25%; padding-left: 3px; padding-right: 3px;" class="text-right m-r-xs">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-center">UCLR(목표)</td>
                                                        <td id="tdResult21" style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-right m-r-xs">
                                                        </td>
                                                        <td style="width: 25%; border-right: 1px solid #dcdcdc; padding-left: 3px; padding-right: 3px;" class="text-center">UCLR</td>
                                                        <td id="tdResult22" style="width: 25%; padding-left: 3px; padding-right: 3px;" class="text-right m-r-xs">
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
