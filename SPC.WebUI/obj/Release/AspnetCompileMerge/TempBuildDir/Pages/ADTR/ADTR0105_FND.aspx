<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0105_FND.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0105_FND_Work" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_nowpage() {
            if (nowpage == 1) {
                document.getElementById("dv1c").style.display = "";
                document.getElementById("dv1g").style.display = "";
                document.getElementById("dv2s").style.display = "none";
                document.getElementById("dv2c").style.display = "none";
            }
            else {
                document.getElementById("dv1c").style.display = "none";
                document.getElementById("dv1g").style.display = "none";
                //document.getElementById("imgMonitoring").style.display = "none";
                document.getElementById("dv2s").style.display = "";
                document.getElementById("dv2c").style.display = "";
            }
        }
        ...
        function fn_OnPopupList(TIMEZONE, visibleIndex) {
            var rowKeys = "";
            if (nowpage == 1) { rowKeys = fn_OnRowKeysNullValueToEmptyWithEncode(devGrid.GetRowKey(visibleIndex)); }
            else { rowKeys = fn_OnRowKeysNullValueToEmptyWithEncode(devGrid2.GetRowKey(visibleIndex)); }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div id="dv1" class="container">
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">                
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <ucCTF:Stopwatch ID="ucStopwatch" runat="server" ClientInstanceName="STATUSDIFF" ItemList="M|1;M|5;M|10;M|20;M|30;M|40;M|50;M|60" ShowRemaintime="true" CallbackEvent="fn_OnSearchClick" />
                    </div>
                </div>
            </div>
        ...
        <div id="dv1c" class="content">
            <img id="imgMonitoring" src="<%=ImageURL%>" style="border:1px solid #9f9f9f;" />
        </div>
        <div id="dv1g" class="paging" style="padding:10px 0px 10px 0px;">
    ...
    <div id="dv2" class="container">
        <div id="dv2s" class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
        ...
        <div id="dv2c" class="content1">
            <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_WORKCD;F_WORKNM;F_ITEMCD;F_ITEMNM" EnableViewState="false" EnableRowsCache="false"
                OnCustomCallback="devGrid2_CustomCallback" OnCustomColumnDisplayText="devGrid2_CustomColumnDisplayText" OnHtmlDataCellPrepared="devGrid2_HtmlDataCellPrepared">
                <Styles>
                    <Header Font-Bold="true" HorizontalAlign="Center"></Header>
                    <Cell HorizontalAlign="Center" Font-Size="9pt" Wrap="False" CssClass="truncated" Cursor="pointer"></Cell>
                    <EditForm CssClass="bg-default"></EditForm>
            ...
            <dx:ASPxGridViewExporter ID="devGridExporter" runat="server" GridViewID="devGrid2"></dx:ASPxGridViewExporter>
        </div>
