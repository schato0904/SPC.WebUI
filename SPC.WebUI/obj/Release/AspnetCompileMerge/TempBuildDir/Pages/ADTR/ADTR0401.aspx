<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0401.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0401" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OKNGCHK(s, e) {
            ...
            if (INSPCD == "AAC501") {
                ...
                var measure = s.GetText().toUpperCase();
                s.SetText(measure);
                s.SetValue(measure);
                ...
                if (!(measure.toUpperCase() == "NG" || measure.toUpperCase() == "OK")) {
                    alert("외관Data는 NG또는 OK로 입력해주세요!!");
                    s.SetText("");
                    s.SetValue("");
                    s.Focus();
                } else if (measure.toUpperCase() == "NG") {
                    txtNGOKCHK.SetText("1");
                    txtNGOKCHK.SetValue("1");
                } else if (measure.toUpperCase() == "OK") {
                    txtNGOKCHK.SetText("0");
                    txtNGOKCHK.SetValue("0");
        ...
        function fn_ValidateMeasure(s, e) {
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_WORKDATE;F_ITEMCD;F_WORKCD;F_SERIALNO;F_NUMBER;F_MEASNO" EnableViewState="false" EnableRowsCache="false"
                ...
                OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText" OnHtmlRowPrepared="devGrid_HtmlRowPrepared" OnHtmlEditFormCreated="devGrid_HtmlEditFormCreated"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <dx:ASPxTextBox ID="txtMODIFYMEASURE" ClientInstanceName="txtMODIFYMEASURE" runat="server" Width="100%" HorizontalAlign="Right"
                                        ...
                                        <ClientSideEvents KeyPress="fn_ValidateMeasure" LostFocus="fn_OKNGCHK"/>
                                    </dx:ASPxTextBox>
