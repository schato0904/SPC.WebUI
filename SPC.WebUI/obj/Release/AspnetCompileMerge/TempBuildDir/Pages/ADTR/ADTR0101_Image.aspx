<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="ADTR0101_Image.aspx.cs" Inherits="SPC.WebUI.Pages.ADTR.ADTR0101_Image" %>
    ...
    <script type="text/javascript">
        ...
        function imgClick(param) {
            var CompCD = "<%=gsCOMPCD%>"
                ...
                , PcNM = param.PCNM;
            var key = CompCD + '|' + FactCD + '|' + FromDt + '|' + Todt + '|' + PcNM;

            fn_OnPopupMonitoring(key);
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px;">                
        ...
        <div class="content" ><img id="imgMonitoring" src="<%=ImageURL%>" style="border:1px solid #9f9f9f;" /></div>
