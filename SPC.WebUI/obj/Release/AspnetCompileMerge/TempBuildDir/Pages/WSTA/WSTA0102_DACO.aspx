<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="WSTA0102_DACO.aspx.cs" Inherits="SPC.WebUI.Pages.WSTA.WSTA0102_DACO" %>
    ...
    <script type="text/javascript">
        ...
        function fn_grid(s, e) {
            ...
            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr[id$=DXDataRow1]>td:gt(0)').each(function (idx) {
                arrData[idx] = { "Serialno": $(this).text(), "Itemcd": arrData[idx]["Itemcd"] };
            });
            ...
            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr:gt(0)').each(function (idx) {
                $(this).find('td:gt(0)').each(function (idx) {
                    $(this).on("click", function () {
                        fn_Chart2Callback(arrData[idx]["Itemcd"], arrData[idx]["Serialno"], arrData[idx]["Inspdetail"]);
                    });
                });
            });
        }

        function fn_Chart2Callback(Itemcd, Serialno, Inspdetail) {
            _Itemcd = Itemcd + "|" + Serialno + "|" + Inspdetail
            fn_OnChartDoCallback2(devChart2, chartWidth2, chartHeight1)
        }
