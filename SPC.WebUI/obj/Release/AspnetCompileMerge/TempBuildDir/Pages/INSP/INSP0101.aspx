<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="INSP0101.aspx.cs" Inherits="SPC.WebUI.Pages.INSP.INSP0101" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnInspectionClick() {
            ...
            fn_OnPopupInspection(fn_GetCastValue('hidUCITEMCD'), prevLot);
        }
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_WORKDATE;F_BANCD;F_LINECD;F_ITEMCD;F_WORKCD;F_TSERIALNO;F_LOTNO;F_EXTCD;F_WORKTIME;F_FIRSTITEM;F_TAGAKNO;F_WORKMAN" EnableViewState="false" EnableRowsCache="false"
