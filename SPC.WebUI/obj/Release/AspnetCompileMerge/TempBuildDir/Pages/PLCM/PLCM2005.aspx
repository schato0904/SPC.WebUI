<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="PLCM2005.aspx.cs" Inherits="SPC.WebUI.Pages.PLCM.PLCM2005" %>
<%-- 작업지시서 조회 --%>
            ...
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <dx:ASPxComboBox Width="280px" runat="server" ID="schF_RECIPID" ClientInstanceName="schF_RECIPID" IncrementalFilteringMode="None" ValueType="System.String" OnCallback="schF_RECIPID_Callback" >
        ...
        <div id="divRight" style="width:69%;float:left;" class="container1">
            <table class="InputTable" style="width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <dx:ASPxTextBox runat="server" ID="srcF_X" ClientInstanceName="srcF_X"></dx:ASPxTextBox>
                        </td>
                        <td class="tdTitle">Y</td>
                        <td class="tdContentR">
                            <dx:ASPxTextBox runat="server" ID="srcF_Y" ClientInstanceName="srcF_Y"></dx:ASPxTextBox>
                        </td>
                        <td colspan="2"></td>
                    </tr>
             </table>
            <div id="divRightBody" style="width:100%;">
                ...
                <div id="div1" style="width:70%;float:left;">
                    <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="tDate" Width="85px" Caption="작업일자" />
                            <dx:GridViewDataTextColumn FieldName="tTime" Width="80px" Caption="작업시간" />
                            <dx:GridViewDataTextColumn FieldName="tRecipeID" Caption="레시피" CellStyle-HorizontalAlign="Left" />
                            <dx:GridViewDataTextColumn FieldName="tMasterID" Width="120px" Caption="마스터ID" />
                            <dx:GridViewDataTextColumn FieldName="tNo" Width="40px" Caption="NO" />
                            <dx:GridViewDataTextColumn FieldName="tX" Width="40px" Caption="X" />
                            <dx:GridViewDataTextColumn FieldName="tY" Width="40px" Caption="Y" />
                            <dx:GridViewDataTextColumn FieldName="data" Width="65px" Caption="측정치" />
                            <dx:GridViewDataTextColumn FieldName="F_MAX" Width="65px" Caption="상한" />
                            <dx:GridViewDataTextColumn FieldName="F_MIN" Width="65px" Caption="하한" />
                        </Columns>
                    </dx:ASPxGridView>
                ...
                <div id="div2" style="width:30%;float:left;">
                    <table class="InputTable" style="width:100%;">
                        <colgroup>
                            <col style="width: 25%" />
                            <col style="width: 25%" />
