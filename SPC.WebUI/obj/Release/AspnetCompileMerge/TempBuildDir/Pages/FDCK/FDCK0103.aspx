<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="FDCK0103.aspx.cs" Inherits="SPC.WebUI.Pages.FDCK.FDCK0103" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            ...
            fn_OnBatchValidate("F_INSPTYPENM", s, e);
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {                
                var editor = s.GetEditor('F_INSPTYPECD');
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_INSPTYPECD" Caption="점검타입코드" Width="100px">
                        <PropertiesTextEdit MaxLength="12" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_INSPTYPENM" Caption="점검타입명" Width="400px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                        <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataColumn>                    
                    <dx:GridViewDataColumn FieldName="F_REMARK" Caption="비고" Width="600px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                        <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataColumn>    
