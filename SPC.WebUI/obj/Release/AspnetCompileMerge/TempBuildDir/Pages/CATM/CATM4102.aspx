<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM4102.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM4102" %>
<%-- 금형수리이력등록 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">        // 사용자 정의 함수
        ...
        // 키가 있는지 확인
        function HasPkey() {
            return Trim(srcF_MOLDNO.GetText()) != '' && Trim(srcF_MOLDNTH.GetText()) != '' && Trim(srcF_MOLDNTH.GetText()) != '0' && Trim(srcF_SEQ.GetText()) != '' && Trim(srcF_SEQ.GetText()) != '0';
        }
        // 초기화
        ...
        function SetClear(isFirst) {
            ...
            srcF_FIXCOST.SetValue('');
            srcF_FIXDAYS.SetValue('');
            srcF_MEMO.SetValue('');
        }
        // 기본값 설정
        function SetDefault() {
        ...
        function SetPageMode(mode) {
            ...
            switch (mode) {
                case "NEW":
                    SetPageEnable(Trim(srcF_MOLDNO.GetText()) != '' && Trim(srcF_MOLDNTH.GetText()) != '' && Trim(srcF_MOLDNTH.GetText()) != '0');
                    //SetPageEnable(true);
                    break;
                case "EDIT":
                    SetPageEnable(true);
        ...
        <div id="divLeft" style="width:29%;float:left;">
            ...
            <div id="divLeftBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_MOLDNO;F_MOLDNTH" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_MOLDNTH" Caption="금형차수" Width="100px"/>
                        <dx:GridViewDataColumn FieldName="F_CAVITY" Caption="Cavity" Width="100px"/>
        ...
        <div id="divRight" style="width:70%;float:left;">
            ...
            <div id="divMiddle" style="margin-bottom:10px;">
                <table class="InputTable" style="margin-bottom: 5px;width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <ucCTF:SYCOD01 runat="server" id="srcF_FIXTYPECD" ClientInstanceName="srcF_FIXTYPECD" F_CODEGROUP="45" nullText="--선택하세요--" IsRequired="true"></ucCTF:SYCOD01>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_COMPCD;F_FACTCD;F_MOLDNO;F_MOLDNTH;F_SEQ" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="F_MOLDNO" Caption="금형번호" Width="100px"/>
                        <dx:GridViewDataTextColumn FieldName="F_MOLDNTH" Caption="금형차수" Width="100px"/>
                        <dx:GridViewDataTextColumn FieldName="F_FIXYMD" Caption="수리일자" Width="100px"/>
                        <dx:GridViewDataTextColumn FieldName="F_FIXTYPENM" Caption="수리유형" Width="100px"/>
                        <dx:GridViewDataTextColumn FieldName="F_FIXCOST" Caption="수리비용" Width="100px"/>
                        <dx:GridViewDataTextColumn FieldName="F_FIXDAYS" Caption="수리기간" Width="100px"/>
