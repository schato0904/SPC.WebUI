<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM3203.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM3203" %>
<%-- 일수불현황 --%>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRODCOUNT" Caption="당일입고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_OUTCOUNT" Caption="당일출고" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
