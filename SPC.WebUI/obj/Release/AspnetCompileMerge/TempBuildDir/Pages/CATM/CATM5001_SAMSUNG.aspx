<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM5001_SAMSUNG.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM5001_SAMSUNG" %>
<%-- 보온로 모니터링 --%>
        ...
        function fn_OnEndCallback(s, e) {
            ...
            switch (s) {
                ...
                case devGrid1:
                    ...
                    var height = $(document).height() - $('#divRightChart').offset().top - _hMargin;
                    //var params = {
                    //    'WIDTH': width,
                    //    'HEIGHT': height
                    //};
                    SetChartSize(width, height);
                    //devChart1.PerformCallback(encodeURIComponent(JSON.stringify(params)));
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        <div id="divRight" style="width:100%;">
            <div id="divMiddle" style="float:left;margin-bottom:2px;width:100%;">
                <table class="InputTable" style="width:50%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxComboBox runat="server" ID="schF_MACHCD" ClientInstanceName="schF_MACHCD" IncrementalFilteringMode="None" ValueType="System.String" Width="50%">
            ...
            <div style="clear:both;"></div>
            <div id="divRightBody" style="width:30%;float:left;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        <dx:GridViewDataColumn FieldName="No" Caption="No" Width="20%" />
                        <%--<dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />--%>
                        <dx:GridViewDataTextColumn FieldName="F_WORKTIME" Caption="작업시간" Width="40%"/>
                        <dx:GridViewDataTextColumn FieldName="F_TEMP01" Caption="보온로온도" Width="40%"/>
                        <%--<dx:GridViewDataTextColumn FieldName="F_TEMP02" Caption="분위기온도" Width="120px"/>--%>
                    </Columns>
                </dx:ASPxGridView>
