<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM1305.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM1305" %>
<%-- 작업일보 조회 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function devGrid1_RowDblClick(s, e) {
            ...
            var F_WORKYMD = key.split('|')[2];
            fn_OnPopRptCATM1305('작업일보', F_WORKYMD, '');
        }

        // 작업일보 출력 팝업창 열기
        function fn_OnPopRptCATM1305(TITLE, F_WORKYMD, parentCallbackName) {
            var PopParam = {
                'F_WORKYMD': F_WORKYMD
            };
            pPage = './Popup/PopRptCATM1305.aspx' +
        ...
        <div id="divRight" style="width:100%;">
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_COMPCD;F_FACTCD;F_WORKYMD" EnableViewState="false" EnableRowsCache="false"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_WORKYMD" Caption="작업일" Width="90px"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_WORKCOUNT" Caption="작업지시건수" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}" />
                        <dx:GridViewDataSpinEditColumn FieldName="F_ENDCOUNT" Caption="작업이행건수" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}" />
                        <dx:GridViewDataSpinEditColumn FieldName="F_PLANCOUNT" Caption="작업지시수량" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}" />
                        <dx:GridViewDataSpinEditColumn FieldName="F_PRODCOUNT" Caption="생산수량" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_ERRCOUNT" Caption="불량수량" Width="90px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataColumn Caption="비고" UnboundType="String"/>
                    </Columns>
                </dx:ASPxGridView>
