<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="CATM2123.aspx.cs" Inherits="SPC.WebUI.Pages.CATM.CATM2123" %>
<%-- 원재료(원재료) 출고등록 --%>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">        // 사용자 정의 함수
        ...
        function SetPageEnable(enable) {
            ...
            srcF_OUTDATE.SetEnabled(enable);
            srcF_MACHCD.SetEnabled(enable && (Trim(srcF_OUTTYPECD.GetValue()) != '05'));
            //srcF_ITEMCD.SetEnabled(enable);
            srcF_OUTCNT.SetEnabled(enable);
            srcF_SCRAP.SetEnabled(enable);
        ...
        function SetValue(data) {
            ...
            if (typeof data.F_OUTDATE != 'undefined') srcF_OUTDATE.SetValue(str2date(data.F_OUTDATE));
            ...
            if (typeof data.F_SCRAP != 'undefined') srcF_SCRAP.SetValue(data.F_SCRAP);
    ...
    <script type="text/javascript">
        ...
        // 출고유형 변경
        function srcF_OUTTYPECD_OnValueChanged(s, e) {
            // 실사조정 출고 선택시, 설비 클리어 및 비활성화
            if (Trim(s.GetValue()) == '05') {
                srcF_MACHCD.SetValue(null);
                srcF_MACHCD.SetEnabled(false);
            } else {
                srcF_MACHCD.SetEnabled(true);
            ...
            <div id="divLeftBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_ITEMCD" Caption="품번" Width="100px" Visible="false" />
                        ...
                        <%--<dx:GridViewDataColumn FieldName="F_CUSTNM" Caption="사입처" Width="100px"/>--%>
            ...
            <div id="divMiddle" style="margin-bottom:10px;">
                <table class="InputTable" style="margin-bottom: 5px;width:100%;">
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxDateEdit runat="server" ID="srcF_OUTDATE" ClientInstanceName="srcF_OUTDATE" UseMaskBehavior="true" 
                                    ...
                                    Width="100%" AllowNull="true" DisplayFormatString="yyyy-MM-dd HH:mm:ss" EditFormatString="yyyy-MM-dd HH:mm:ss" >
                                </dx:ASPxDateEdit>
                            </div>
                        </td>
                        ...
                        <td class="tdTitle">출고유형</td>
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxComboBox runat="server" ID="srcF_OUTTYPECD" ClientInstanceName="srcF_OUTTYPECD" IncrementalFilteringMode="None" ValueType="System.String" >
                                    <ClientSideEvents ValueChanged="srcF_OUTTYPECD_OnValueChanged" />
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                    <Items>
                                        <dx:ListEditItem Value="01" Text="원재료" Selected="true" />
                                        <dx:ListEditItem Value="05" Text="실사조정출고" />
                                    </Items>
                                </dx:ASPxComboBox>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxSpinEdit runat="server" ID="srcF_OUTCNT" ClientInstanceName="srcF_OUTCNT" ClientEnabled="false" Width="100%" NumberType="Integer" Number="1" MinValue="1" MaxValue="1000000" AllowNull="true" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false" DisplayFormatString="{0:#,0}">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" RequiredField-IsRequired="true" ValidateOnLeave="true" RequiredField-ErrorText="필수 항목입니다.">
                                    </ValidationSettings>
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
                        ...
                        <td class="tdTitle">스크랩투입량</td>
                        <td class="tdContent">
                            <div style="width:100%;float:left;">
                                <dx:ASPxSpinEdit runat="server" ID="srcF_SCRAP" ClientInstanceName="srcF_SCRAP" ClientEnabled="false" Width="100%" NumberType="Integer" Number="0" MinValue="0" MaxValue="1000000" AllowNull="true" AllowMouseWheel="false" SpinButtons-ShowIncrementButtons="false" DisplayFormatString="{0:#,0}">
                                    <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" RequiredField-IsRequired="true" ValidateOnLeave="true" RequiredField-ErrorText="필수 항목입니다.">
                                    </ValidationSettings>
                                    <DisabledStyle BackColor="#EEEEEE" ForeColor="#222222"></DisabledStyle>
                                </dx:ASPxSpinEdit>
            ...
            <div id="divRightBody" style="width:100%;">
                <dx:ASPxGridView ID="devGrid1" ClientInstanceName="devGrid1" runat="server" AutoGenerateColumns="false" Width="100%"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataColumn FieldName="F_COMPCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_FACTCD" Visible="false" />
                        <dx:GridViewDataColumn FieldName="F_OUTDATE" Caption="출고일" Width="120px"/>
                        <dx:GridViewDataColumn FieldName="F_OUTSTOCKNO" Caption="출고번호" Width="120px"/>
                        <dx:GridViewDataColumn FieldName="F_MACHNM" Caption="주조기" Width="120px"/>
                        ...
                        <dx:GridViewDataSpinEditColumn FieldName="F_INGOT" Caption="잉곳" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
                        <dx:GridViewDataSpinEditColumn FieldName="F_SCRAP" Caption="스크랩" Width="120px" PropertiesSpinEdit-DisplayFormatString="{0:#,0}"/>
