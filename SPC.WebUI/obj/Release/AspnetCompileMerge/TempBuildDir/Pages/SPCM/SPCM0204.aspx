<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0204.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0204" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            ...
            fn_OnBatchValidate("F_OPQTY", s, e);
        }
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            ...
            fn_OnControlDisableBox(s.GetEditor('F_OPILBONO'), null);
        }
        ...
        function fn_gridInsItem(rowKeys) {
            ...
            devGrid.GetEditor('F_NQTY').SetText(rowKey[2]);
        ...
        function fn_OnNodeDblClick(s, e) {
            var fields = 'F_LEVEL;F_ITCD;F_CODENM;F_NQTY;';
                 ...
                 <div class="container_r">
                    <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            <div class="form-group">
                                <label class="col-sm-1 control-label">이동일자</label>
                                <div class="col-sm-2 control-label">
                                    <ucCTF:Date ID="ucDate" runat="server" SingleDate="true" />
                                </div>
                                <label class="col-sm-1 control-label">출고창고</label>
                                <div class="col-sm-2 control-label">
                                    <dx:ASPxComboBox ID="ddlStcd" ClientInstanceName="ddlStcd" runat="server" Width="100%" onc
                                        IncrementalFilteringMode="None" CssClass="NoXButton">
                                        <ClientSideEvents SelectedIndexChanged="fn_treeChang" />
                                    </dx:ASPxComboBox>
                                </div>
                                <label class="col-sm-1 control-label">입고창고</label>
                                <div class="col-sm-2 control-label">
                                    <dx:ASPxComboBox ID="ddlStcd2" ClientInstanceName="ddlStcd2" runat="server" Width="100%"
                                        IncrementalFilteringMode="None" CssClass="NoXButton">
                                    </dx:ASPxComboBox>
                                </div>
                            </div>
                    ...
                    <div class="content">
                        ...
                        <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false"  Width="100%"
                            ...
                            <Columns>
                                <dx:GridViewDataTextColumn FieldName="F_OPILBONO" Caption="출고번호" Width="100px"  CellStyle-HorizontalAlign="Center" />
                                ...
                                <dx:GridViewDataColumn FieldName="F_NQTY" Caption="재고수량" Width="100px" CellStyle-HorizontalAlign="Center" />
                                <dx:GridViewDataTextColumn FieldName="F_OPQTY" Caption="이동수량" Width="90px" CellStyle-HorizontalAlign="Right">
                    ...
                    <div class="search">
                        <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                            <div class="form-group">
                                <label class="col-sm-1 control-label">출고일자</label>
                                <div class="col-sm-2 control-label">
                    ...
                    <div class="content">
                        <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="false" Width="100%"
                            KeyFieldName="F_OPILBONO;F_OPDT" EnableViewState="false" EnableRowsCache="false" 
                            ...
                            <Columns>
                                <dx:GridViewDataColumn FieldName="F_STNM"       Caption="출고창고"      Width="100px"/>
                                <dx:GridViewDataColumn FieldName="F_OPDT"       Caption="이동일자"      Width="100px"       CellStyle-HorizontalAlign="Center" />
                                <dx:GridViewDataColumn FieldName="F_OPILBONO"   Caption="출고번호"      Width="100px"       CellStyle-HorizontalAlign="Center" />
                                <dx:GridViewDataColumn FieldName="F_ITCD"       Caption="품목코드"      Width="100px"       CellStyle-HorizontalAlign="Center" />
                                <dx:GridViewDataColumn FieldName="F_ITNM"       Caption="품목명"        Width="250px"       CellStyle-HorizontalAlign="Left" />
                                <dx:GridViewDataColumn FieldName="F_STAND"      Caption="규격"          Width="90px"        CellStyle-HorizontalAlign="Center" />
                                <dx:GridViewDataTextColumn FieldName="F_OPQTY"  Caption="이동수량"      Width="80px"        CellStyle-HorizontalAlign="Right"   PropertiesTextEdit-DisplayFormatInEditMode="true" PropertiesTextEdit-DisplayFormatString="n0" PropertiesTextEdit-MaskSettings-Mask="n0"  />
                                <dx:GridViewDataColumn FieldName="F_TOSTNM"     Caption="입고창고"     Width="100px"/>
