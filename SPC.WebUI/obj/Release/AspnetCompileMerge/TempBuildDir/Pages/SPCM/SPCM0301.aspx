<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0301.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0301" %>
                 ...
                 <div class="search">
                    <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3 control-label">
                                <ucCTF:Date ID="ucDate" runat="server" MonthOnly="true" MaxMonth="36" />
                            </div>
                  ...
                  <div class="content">
                    ...
                    <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false"  Width="100%"
                        ...
                        <Columns>
                            <dx:GridViewDataTextColumn FieldName="YYMM" Caption="재고연월" Width="100px"  CellStyle-HorizontalAlign="Center" />
                            ...
                            <dx:GridViewDataTextColumn FieldName="F_BQTY" Caption="전월재고" Width="90px" CellStyle-HorizontalAlign="Right" />
                            <dx:GridViewDataTextColumn FieldName="F_IPQTY" Caption="당월입고" Width="90px" CellStyle-HorizontalAlign="Right" />
                            <dx:GridViewDataTextColumn FieldName="F_OPQTY" Caption="당월출고" Width="90px" CellStyle-HorizontalAlign="Right" />
