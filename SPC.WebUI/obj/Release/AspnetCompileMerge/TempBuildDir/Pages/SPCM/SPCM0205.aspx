<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="SPCM0205.aspx.cs" Inherits="SPC.WebUI.Pages.SPCM.SPCM0205" %>
        ...
        <div class="search">
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
                    <label class="col-sm-1 control-label">조정일자</label>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false"  Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_OSQTY" Caption="적정재고" Width="90px" CellStyle-HorizontalAlign="Right" Visible="false" />
                    <dx:GridViewDataTextColumn FieldName="F_NQTY" Caption="현재고" Width="90px" CellStyle-HorizontalAlign="Right" />
                    <dx:GridViewDataTextColumn FieldName="F_RQTY" Caption="실사조정수량" Width="90px" CellStyle-HorizontalAlign="Right">
