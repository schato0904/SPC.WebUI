<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0101_DACO.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0101_DACO" %>
                ...
                <tr>
                    <td>
                        ...
                        <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                            KeyFieldName="F_ITEMCD;F_WORKCD;F_SERIALNO;F_SIRYO;F_WORKDATE" EnableViewState="false" EnableRowsCache="false"
                            ...
                            <Columns>                    
                                ...
                                <dx:GridViewDataColumn FieldName="F_WORKDATE"  Caption="일자" Width="90px" />
                                <dx:GridViewDataColumn FieldName="F_WORKTIME"  Caption="시간" Width="70px" />
                                ...
                                <dx:GridViewDataColumn FieldName="F_WORKDATE" Visible="false" />
