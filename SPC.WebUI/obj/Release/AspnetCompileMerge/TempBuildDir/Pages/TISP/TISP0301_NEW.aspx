<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0301_NEW.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.TISP0301_NEW" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    ...
    <script type="text/javascript">
        ...
        function fn_AdjustSize() {
            ...
            $('.right').width(parseInt($(".search").width() - $('.left').width() - 10, 10));
        }
        ...
        function fn_OnRowClick(s, e) {
            if (devGrid.GetRowKey(e.visibleIndex).split('|')[3].replace(/\s+$/, "") != "AAC501") {
                ...
                //devGrid2.PerformCallback("|||");
                fn_SetTextValue('hidKeys', devGrid.GetRowKey(e.visibleIndex));
                devGrid2.PerformCallback();
            }
            else {
                fn_SetTextValue('hidKeys', devGrid.GetRowKey(e.visibleIndex));
        ...
        function OnCellOver(cell, col, row, rowcnt, s) {
            ...
            $(s.GetMainElement()).find('table[id$=DXMainTable]>tbody>tr').each(function (idx) {
                tdCnt = $(this).find('td').length;
                $(this).find('td').each(function (idx) {
                    this.style.backgroundColor = '#FFFFFF';
                    if ((tdCnt == 7 && idx == 5) || (tdCnt == 4 && idx == 2))
        ...
        <div class="content">
            <div class="left" >
                ...
                <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                    KeyFieldName="F_ITEMCD;F_WORKCD;F_SERIALNO;F_INSPCD" EnableViewState="false" EnableRowsCache="false" OnCustomColumnDisplayText="devGrid_CustomColumnDisplayText"
            ...
            <div class="right">    
                <dx:ASPxTextBox ID="hidKeys" ClientInstanceName="hidKeys" runat="server" ClientVisible="false" />
                ...
                <dx:ASPxGridView ID="devGrid2" ClientInstanceName="devGrid2" runat="server" AutoGenerateColumns="False"  Width="100%" 
                    KeyFieldName="F_ROWNUM" EnableViewState="False" EnableRowsCache="False" OnCustomColumnDisplayText="devGrid2_CustomColumnDisplayText"
                    ...
                    <Columns>                            
                        ...
                        <dx:GridViewDataColumn FieldName="F_JUDGE" Caption="편차"  Width="70px"  >
                            <CellStyle HorizontalAlign="Right" />
                        </dx:GridViewDataColumn>  
                ...
                <ucCTF:Pager ID="ucPager" runat="server" PageSize="50" BlockSize="10" targetCtrls="devGrid2" />
