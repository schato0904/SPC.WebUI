<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="TISP0103POP.aspx.cs" Inherits="SPC.WebUI.Pages.TISP.Popup.TISP0103POP" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_devGridRowDbClick(s, e) {
            ...
            oParams += rowKeys + '|' + hidCOMP.GetText() + '|' + hidFACT.GetText();
            
            parent.parent.fn_OnDeleteTab('TISP01POP', parent.parent.fn_OnGetTabObject('TISP01POP'));
            parent.parent.parent.doCreateTab('MM07|MM0701|TISP|TISP01POP|품질종합현황|RP|1', oParams);
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div class="container">
        ...
        <div class="content">
            ...
            <dx:ASPxTextBox ID="hidFACT" ClientInstanceName="hidFACT" runat="server" ClientVisible="false" />
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" Width="100%"
                ...
                KeyFieldName="F_ITEMCD;F_ITEMNM;F_WORKCD;F_WORKNM;F_MEAINSPCD;F_INSPDETAIL;F_SERIALNO;F_SIRYO;F_FREEPOINT;F_STANDARD;F_MAX;F_MIN;F_WORKDATE;F_WORKTIME" 
