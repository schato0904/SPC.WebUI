<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="DIOF0501_cheongmyung.aspx.cs" Inherits="SPC.WebUI.Pages.DIOF.DIOF0501_cheongmyung" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnDayClick(iDay) {
            ...
            pPage = rootURL + 'Pages/DIOF/Popup/DIOF0501POP_cheongmyung.aspx' +
            '?TITLE=설비일상점검 점검내역 일자별 관리자확인' +
            '&CRUD=' +
            '&KEY=' + fn_GetCastValue('schF_MACHIDX') +
            '&CODE=' + fn_GetCastText('schF_MACHIDX').split(';')[0] +
            '&TEXT=' + encodeURIComponent(fn_GetCastText('schF_MACHIDX').split(';')[1]) +
            '&DATE=' + fn_GetCastValue('hidUCFROMDT') + '-' + ('0' + iDay).slice(-2);
        ...
        <div class="search">
            <table class="contentTable">
                ...
                <tr>
                    ...
                    <td class="tdInput">
                        <ucCTF:SYCOD01 runat="server" ID="schF_MACHKIND" ClientInstanceName="schF_MACHKIND" F_CODEGROUP="40" targetCtrls="schF_MACHIDX" nullText="선택하세요." />
                    </td>
                    ...
                    <td class="tdInput">
                        <dx:ASPxComboBox ID="schF_MACHIDX" ClientInstanceName="schF_MACHIDX" runat="server" Width="100%"
                            ...
                            OnCallback="schF_MACHIDX_Callback" NullText="설비분류를 선택하세요">
                            <Columns>
