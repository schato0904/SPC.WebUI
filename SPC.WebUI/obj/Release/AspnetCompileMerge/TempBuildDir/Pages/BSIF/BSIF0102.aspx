<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0102.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0102" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_SHEWHARTCD", s, e);
            fn_OnBatchValidate("F_SHEWHARTNM", s, e);
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {                
                var editor = s.GetEditor('F_SHEWHARTCD');
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_SHEWHARTCD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_SHEWHARTCD" Caption="공정이상코드" Width="100px">
                        <PropertiesTextEdit MaxLength="2" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_SHEWHARTNM" Caption="공정이상명" Width="120px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataSpinEditColumn FieldName="F_NO" Caption="순번" Width="40px">
                        <PropertiesSpinEdit NumberType="Integer" MinValue="0" MaxValue="99999" SpinButtons-ShowIncrementButtons="false" />
                    </dx:GridViewDataSpinEditColumn>
                    <dx:GridViewDataCheckColumn FieldName="F_DISPLAY" Caption="관리유무" Width="60px" />
                    <dx:GridViewDataColumn FieldName="F_REMARK" Caption="비고" Width="450px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
