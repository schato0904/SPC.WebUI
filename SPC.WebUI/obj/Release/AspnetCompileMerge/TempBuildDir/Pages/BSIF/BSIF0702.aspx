<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0702.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0702" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                ...
                devGrid.GetEditor("F_LINECD").PerformCallback(oParam);
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_LINENM" Name="F_BANNM" Caption="라인명" Width="100px"  ReadOnly="true">
