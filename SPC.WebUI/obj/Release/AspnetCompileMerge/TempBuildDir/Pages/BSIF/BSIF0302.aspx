<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0302.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.BSIF0302" %>
    ...
    <div class="container">
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" 
                KeyFieldName="F_MEAINSPCD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_MEAINSPCD" Caption="검사항목코드" Width="100px">
                        <PropertiesTextEdit MaxLength="12" />
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataColumn FieldName="F_INSPDETAIL" Caption="검사항목명" Width="200px">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                        <Settings AutoFilterCondition="Contains" />
                    </dx:GridViewDataColumn>                    
                    <dx:GridViewDataTextColumn FieldName="F_MANAGESTAN" Caption="관리기준" Width="150px">
