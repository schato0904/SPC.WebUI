<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="BSIF0501_WGROUPPOP.aspx.cs" Inherits="SPC.WebUI.Pages.BSIF.Popup.BSIF0501_WGROUPPOP" %>
    ...
    <script type="text/javascript">
        ...
        function fn_OnBatchEditStartEditing(s, e) {
            if (parseInt(e.visibleIndex, 10) >= 0) {
                ...
                var P_WORKCD = devGrid.batchEditApi.GetCellValue(e.visibleIndex, 'F_WORKCD');
                //var oParam = P_BANCD + '|' + P_LINECD + '|' + P_WORKCD;
                //ddlLINEEdit.PerformCallback(oParam);
                //ddlWORK1Edit.PerformCallback(oParam);
                ddlLINEEdit.SetValue(P_LINECD);
                ddlWORK1Edit.SetValue(P_WORKCD);
                ...
                fn_OnControlEnableComboBox(ddlWORK1Edit, false);
                ...
                fn_OnControlEnableComboBox(ddlWORK1Edit, true);
        ...
        function fn_OnBatchEditEndEditing(s, e) {
            ...
            var subColumn1 = s.GetColumnByField("F_WORKCD");
            if (!e.rowValues.hasOwnProperty(subColumn1.index))
                return;
            var cellInfo = e.rowValues[subColumn1.index];
            if (ddlWORK1Edit.GetSelectedIndex() > -1 || cellInfo.text != ddlWORK1Edit.GetText()) {
                cellInfo.value = ddlWORK1Edit.GetValue();
                cellInfo.text = ddlWORK1Edit.GetText();
                ddlWORK1Edit.SetValue(null);
            }
        }
        ...
        function fn_OnLINECDEditorSelectedIndexChanged(s, e) {
            ddlWORK1Edit.PerformCallback(devGrid.GetEditor("F_BANCD").GetValue() + '|' + s.GetValue() + '|');
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="False" 
                ...
                <Columns>
                    ...
                    <dx:GridViewDataTextColumn FieldName="F_BANNM" Name="F_BANNM" Caption="반명" Width="150px" ReadOnly="true" >
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_LINECD" Name="F_LINECD" Caption="라인코드" Width="80px" >
                        <EditItemTemplate>
                    ...
                    <dx:GridViewDataColumn FieldName="F_LINENM" Caption="라인명" Width="150px"  ReadOnly="true">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                    <dx:GridViewDataComboBoxColumn FieldName="F_WORKCD" Name="F_WORKCD" Caption="공정코드" Width="80px" >
                        <EditItemTemplate>
                            <dx:ASPxComboBox ID="ddlWORK1Edit" ClientInstanceName="ddlWORK1Edit" runat="server" Width="100%"
                                OnCallback="ddlWORK1Edit_Callback" OnDataBound="ddlWORK1Edit_DataBound"
                                EnableCallbackMode="true" IncrementalFilteringMode="None" CssClass="NoXButton">
                                <ClientSideEvents Init="fn_OnControlDisable" SelectedIndexChanged="fn_OnWORKCDEditorSelectedIndexChanged" />
                            </dx:ASPxComboBox>
                        </EditItemTemplate>
                    </dx:GridViewDataComboBoxColumn>
                    <dx:GridViewDataColumn FieldName="F_WORKNM" Caption="공정명" Width="180px"  ReadOnly="true">
                        <CellStyle HorizontalAlign="Left"></CellStyle>
                    </dx:GridViewDataColumn>
                </Columns>
            </dx:ASPxGridView>
