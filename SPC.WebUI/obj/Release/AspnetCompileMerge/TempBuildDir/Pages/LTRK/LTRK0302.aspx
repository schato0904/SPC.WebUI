<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="LTRK0302.aspx.cs" Inherits="SPC.WebUI.Pages.LTRK.LTRK0302" %>
        ...
        <div class="search">
            <table class="contentTable">
                ...
                <tr>
                    ...
                    <td class="tdLabel">투입여부</td>
                    <td class="tdInput">
                        <dx:ASPxComboBox ID="ddlF_ISINPUT" ClientInstanceName="ddlF_ISINPUT" runat="server" Width="100%"
                            IncrementalFilteringMode="None" CssClass="NoXButton">
                            <Items>
                                <dx:ListEditItem Text="전체" Value="" Selected="true" />
                                <dx:ListEditItem Text="투입" Value="1" />
                                <dx:ListEditItem Text="미투입" Value="0" />
                            </Items>
                        </dx:ASPxComboBox>
                    </td>
                    ...
                    <td class="tdLabel">투입작지번호</td>
                    <td class="tdInput">
                        <dx:ASPxTextBox ID="srcF_ORDERNO" ClientInstanceName="srcF_ORDERNO" runat="server" Width="100%" />
                    </td>
                </tr>
                <tr>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataColumn FieldName="F_WORKCD" Caption="출고구분" Width="80px" />
