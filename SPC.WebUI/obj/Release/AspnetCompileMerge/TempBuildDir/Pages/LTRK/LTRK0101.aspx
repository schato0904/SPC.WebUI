<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcMasterPage.Master" AutoEventWireup="true" CodeBehind="LTRK0101.aspx.cs" Inherits="SPC.WebUI.Pages.LTRK.LTRK0101" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cphHead" runat="server">
    <script type="text/javascript">
        ...
        function fn_OnValidate(s, e) {
            fn_OnBatchValidate("F_VENDORTP", s, e);
            fn_OnBatchValidate("F_VENDORNM", s, e);
        }

        // BatchEditStartEditing
        function fn_OnBatchEditStartEditing(s, e) {
            fn_OnControlDisableBox(s.GetEditor('F_VENDORCD'), null);
        }
    </script>
</asp:Content>
    ...
    <div class="container">
            ...
            <div class="form-horizontal bg-white fa-border" style="margin-bottom: 10px; border: 1px solid #9F9F9F;">
                <div class="form-group">
                    ...
                    <div class="col-sm-2 control-label">
                        <dx:ASPxRadioButtonList ID="rdoVENDORTP" ClientInstanceName="rdoVENDORTP" runat="server"
                            RepeatDirection="Horizontal" Paddings-Padding="0px" Border-BorderStyle="None">
                            <Items>
                                <dx:ListEditItem Text="전체" Value="" />
                                <dx:ListEditItem Text="고객사" Value="AAE401" />
                                <dx:ListEditItem Text="협력사" Value="AAE402" />
                            </Items>
                        </dx:ASPxRadioButtonList>
                    </div>
                    <label class="col-sm-1 control-label">거래처명</label>
                    <div class="col-sm-2 control-label">
                        <dx:ASPxTextBox ID="txtVENDORNM" ClientInstanceName="txtVENDORNM" runat="server" Width="100%" />
                    </div>
        ...
        <div class="content">
            ...
            <dx:ASPxGridView ID="devGrid" ClientInstanceName="devGrid" runat="server" AutoGenerateColumns="false" Width="100%"
                KeyFieldName="F_COMPCD;F_FACTCD;F_VENDORCD" EnableViewState="false" EnableRowsCache="false"
                ...
                <Columns>
                    ...
                    <dx:GridViewDataComboBoxColumn FieldName="F_VENDORTP" Caption="거래처구분" Width="100px" />
                    <dx:GridViewDataTextColumn FieldName="F_VENDORCD" Caption="거래처코드" Width="100px" />
                    <dx:GridViewDataTextColumn FieldName="F_VENDORNM" Caption="거래처명">
