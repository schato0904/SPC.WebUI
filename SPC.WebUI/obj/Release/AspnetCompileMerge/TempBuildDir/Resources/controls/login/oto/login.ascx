<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="login.ascx.cs" Inherits="SPC.WebUI.Resources.controls.login.oto.login" %>
<style type="text/css">
    .warp {
        width: 652px;
        height: 357px;
        background: url(Resources/controls/login/oto/images/login_bg.jpg) repeat-x 0 0;
    }
    .box {
        width: 250px;
        position: relative;
