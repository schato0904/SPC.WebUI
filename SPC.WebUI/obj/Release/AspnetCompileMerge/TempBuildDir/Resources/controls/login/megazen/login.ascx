<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="login.ascx.cs" Inherits="SPC.WebUI.Resources.controls.login.megazen.login" %>
<style type="text/css">
    .warp {
        width: 685px;
        height: 381px;
        margin: 0 auto;
        margin-top: 200px;
        background: url(Resources/controls/login/megazen/Image/loginbg.jpg) repeat-x 0 0;
    }
    .box {
        width: 250px;
        position: relative;
        ...
        <table border="0" style="border-spacing:0" >
            <tr>
                ...
                <td style="width:72px; text-align:right;" rowspan="2" >
                    <asp:ImageButton ID="btnSubmit" runat="server" ImageUrl="~/Resources/controls/login/megazen/Image/login_butt.gif" OnClientClick="return fnDoLogin();" TabIndex="3" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td colspan="2" style="text-align: left; vertical-align:top">
                    <asp:CheckBox ID="chkSaveUserID" runat="server" Style="vertical-align: middle;" />ID저장</td>
                <td></td>
            </tr>
        </table>
    </div>
