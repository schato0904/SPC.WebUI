<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="login.ascx.cs" Inherits="SPC.WebUI.Resources.controls.login.daedong.login" %>
<style type="text/css">
    .warp {
        width: 800px;
        height: 442px;
        margin: 0 auto;
        margin-top: 200px;
        background: url(Resources/controls/login/daedong/Image/login_bg.jpg) repeat-x 0 0;
    }
    .box {
        width: 250px;
        position: relative;
        ...
        <table border="0" style="border-spacing:0" >
            <tr>
                ...
                <td style="width:72px; text-align:right;" rowspan="2" >
                    <asp:ImageButton ID="btnSubmit" runat="server" ImageUrl="~/Resources/controls/login/daedong/Image/butt.gif" OnClientClick="return fnDoLogin();" TabIndex="3" />
                </td>
            </tr>
            <tr>
                <td>
