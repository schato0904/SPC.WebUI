...
{
    public partial class ucDDLMachType : WebUIBasePageUserControl
    {
        ...
        {
            get { return this.devGridLookup.GridView; }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            devGridLookup.DataSource = this.CachedData;
            devGridLookup.DataBind();
        }
        #endregion
        ...
        { 
            ...
            //this.devGridLookup.DataBinding += devGridLookup_DataBinding;
        ...
        void SetDefaultValue()
        {
            ...
            this.devGridLookup.ClientInstanceName = string.Format("{0}_devGridLookup", this.ClientInstanceName);
            ...
            //this.devGridLookup.DataSource = this.CachedData;
            //this.devGridLookup.DataBind();
        ...
        void devGridLookup_DataBinding(object sender, EventArgs e)
        {
            devGridLookup.GridView.ForceDataRowType(typeof(DataTable));
            devGridLookup.DataSource = this.CachedData;
        }
        #endregion
