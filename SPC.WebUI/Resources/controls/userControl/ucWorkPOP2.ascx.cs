...
{
    public partial class ucWorkPOP2 : WebUIBasePageUserControl
    {
        ...
        protected void WORKCallback2_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            using(CommonBiz biz = new CommonBiz())
            {
                ...
                Page.oParamDic.Add("F_WORKCD", txtWORKPOPCD2.Text);
            ...
            WORKCallback2.JSProperties["cpWORKCD"] = WORKCD;
            WORKCallback2.JSProperties["cpWORKNM"] = WORKNM;
        }
        #endregion
        ...
        /// <param name="sender">object</param>
        /// <param name="e">EventArgs</param>
        protected void txtWORKPOPCD2_Init(object sender, EventArgs e)
        {
            (sender as DevExpress.Web.ASPxTextBox).Attributes.Add("ondblclick", "fn_OnPopupWorkSearch2()");
        }
        #endregion
