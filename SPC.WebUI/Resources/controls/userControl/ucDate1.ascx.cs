...
{
    public partial class ucDate1 : WebUIBasePageUserControl
    {
        ...
        void SetDefaultObject()
        {
            ...
            if (!DateTimeOnly)
            {
                this.txtFROMDT1.DisplayFormatString = "yyyy-MM-dd";
                this.txtFROMDT1.EditFormatString = "yyyy-MM-dd";

                this.txtTODT1.DisplayFormatString = "yyyy-MM-dd";
                this.txtTODT1.EditFormatString = "yyyy-MM-dd";

                hidUCFROMDT1.Text = fromdt.ToString("yyyy-MM-dd");
                hidUCTODT1.Text = todt.ToString("yyyy-MM-dd");
            }
            else
            {
                this.txtFROMDT1.DisplayFormatString = "yyyy-MM-dd hh:mm:ss";
                this.txtFROMDT1.EditFormatString = "yyyy-MM-dd hh:mm:ss";

                this.txtTODT1.DisplayFormatString = "yyyy-MM-dd hh:mm:ss";
                this.txtTODT1.EditFormatString = "yyyy-MM-dd hh:mm:ss";

                hidUCFROMDT1.Text = fromdt.ToString("yyyy-MM-dd hh:mm:ss");
                hidUCTODT1.Text = todt.ToString("yyyy-MM-dd hh:mm:ss");
            }
            ...
            if (MonthOnly)
            {
                ...
                this.txtFROMDT1.DisplayFormatString = "yyyy-MM";
                this.txtFROMDT1.EditFormatString = "yyyy-MM";

                this.txtTODT1.DisplayFormatString = "yyyy-MM";
                this.txtTODT1.EditFormatString = "yyyy-MM";

                hidUCFROMDT1.Text = fromdt.ToString("yyyy-MM");
                hidUCTODT1.Text = todt.ToString("yyyy-MM");

                //this.txtFROMDT.DisplayFormatString = "";
            }

            this.txtFROMDT1.Date = fromdt;
            this.txtTODT1.Date = todt;

            if (SingleDate)
            {
                this.txtFROMDT1.Date = todt;
            ...
            if (CurrentWeekOnly)
            {
                this.txtFROMDT1.MinDate = dtStart.Date.AddDays(-(double)DateTime.Today.DayOfWeek);
                this.txtFROMDT1.MaxDate = dtStart.Date;
                this.txtTODT1.MinDate = dtEnd.Date.AddDays(-(double)DateTime.Today.DayOfWeek);
                this.txtTODT1.MaxDate = dtEnd.Date;
            }
        }
        #endregion
