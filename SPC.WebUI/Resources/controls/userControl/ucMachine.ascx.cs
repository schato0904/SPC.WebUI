...
{
    public partial class ucMachine : WebUIBasePageUserControl
    {
        ...
        protected void ITEMCallback_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            using(CommonBiz biz = new CommonBiz())
            {
                ...
                Page.oParamDic.Add("F_ITEMCD", txtMACHCD.Text);
        ...
        #region txtMACHCD_Init
        /// <summary>
        /// txtMACHCD_Init
        /// </summary>
        /// <param name="sender">object</param>
        /// <param name="e">EventArgs</param>
        protected void txtMACHCD_Init(object sender, EventArgs e)
        {
            (sender as DevExpress.Web.ASPxTextBox).Attributes.Add("ondblclick", "fn_OnPopupucMachineSearch()");
        }
        #endregion
