...
{
    public partial class ucWorkPOP1 : WebUIBasePageUserControl
    {
        ...
        protected void WORKCallback1_Callback(object source, DevExpress.Web.CallbackEventArgs e)
        {
            ...
            using(CommonBiz biz = new CommonBiz())
            {
                ...
                Page.oParamDic.Add("F_WORKCD", txtWORKPOPCD1.Text);
            ...
            WORKCallback1.JSProperties["cpWORKCD"] = WORKCD;
            WORKCallback1.JSProperties["cpWORKNM"] = WORKNM;
        }
        #endregion

        #region txtWORKPOPCD1_Init
        /// <summary>
        /// txtWORKPOPCD1_Init
        /// </summary>
        /// <param name="sender">object</param>
        /// <param name="e">EventArgs</param>
        protected void txtWORKPOPCD1_Init(object sender, EventArgs e)
        {
            (sender as DevExpress.Web.ASPxTextBox).Attributes.Add("ondblclick", "fn_WorkPopUPCheck()");
        }
        #endregion
