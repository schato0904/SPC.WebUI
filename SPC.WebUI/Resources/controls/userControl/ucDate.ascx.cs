...
{
    public partial class ucDate : WebUIBasePageUserControl
    {
        ...
        void SetDefaultObject()
        {
            ...
            if (SingleDate)
            {
                ...
                if (!DateTimeOnly)
                {
                    hidUCFROMDT.Text = todt.ToString("yyyy-MM-dd");
                }
                else
                {
                    hidUCFROMDT.Text = todt.ToString("yyyy-MM-dd hh:mm:ss");
                }

                if (MonthOnly)
                {
                    hidUCFROMDT.Text = todt.ToString("yyyy-MM");
                }
            ...
            if (CurrentWeekOnly)
            {
                this.txtFROMDT.MinDate = dtStart.Date.AddDays(-(double)DateTime.Today.DayOfWeek);
                this.txtFROMDT.MaxDate = dtStart.Date;
                this.txtTODT.MinDate = dtEnd.Date.AddDays(-(double)DateTime.Today.DayOfWeek);
                this.txtTODT.MaxDate = dtEnd.Date;
            }
        }
        #endregion
