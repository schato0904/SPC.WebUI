...
{
    public partial class ucPager_Chart : System.Web.UI.UserControl, IDisposable
    {
        #region 사용자 정의 속성, 프로퍼티

        #region 변수선언
        private Int32 _PageSize = 4;
        ...
        public Int32 GetPageSize()
        {
            ...
            //return Convert.ToInt32((ddlPageSize.Value ?? "4").ToString());
            return 4;
        ...
        void PagerRendering()
        {
            ...
            //    TotalBlocks = TotalPages;

            //if (PageBlock < CurrPage)
            //    PageBlock = CurrPage;
