...
{
    public partial class ucFactMulti : WebUIBasePageUserControl
    {
        ...
        void QCM02_LST()
        {
            ...
            if (!this._IsRequired)
            {
                dtTable.Rows.Add("", this._nullText);
            }
        ...
        {
            return this.hidFACTCD.Text;
        }

        public void SetValue(string value)
        {
            this.hidFACTCD.Text = value;
            this.ddlFACT.Value = value;
        } 
        #endregion
