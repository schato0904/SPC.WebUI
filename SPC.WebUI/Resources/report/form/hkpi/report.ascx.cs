        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            switch (sREPORTNM)
            {
                case "xtraReport1":
                    ...
                    break;
                case "xtraReport2":
                    report = new xtraReport2(dtHead, dtGroup, dtData);
                    break;
                case "xtraReport3":
                    report = new xtraReport3(dtHead, dtGroup, dtData);
                    break;
                case "xtraReport4":
                    report = new xtraReport4(dtHead, dtGroup, dtData);
                    break;
                case "xtraReport5":
                    report = new xtraReport5(dtHead, dtGroup, dtData);
                    break;
                case "xtraReport6":
                    report = new xtraReport6(dtHead, dtGroup, dtData);
                    break;
            }
