<%@ Page Title="" Language="C#" MasterPageFile="~/Resources/controls/MasterPage/spcPopupMasterPage.Master" AutoEventWireup="true" CodeBehind="Upload2.aspx.cs" Inherits="SPC.WebUI.API.Common.Popup.Upload2" %>
            ...
            <div class="form-horizontal" style="padding-top: 10px;">
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="form-group">
                            <label class="col-sm-12 control-label">(첨부파일은 최대 100MB 까지 업로드 가능합니다)</label>
                        </div>
