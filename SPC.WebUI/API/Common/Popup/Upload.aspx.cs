...
{
    public partial class Upload : WebUIBasePage
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            switch (sDATA_GBN)
            {
                case "C":
                case "D":
                    devUploader.ValidationSettings.AllowedFileExtensions = new string[] { ".pdf", ".zip" };
                    break;
                case "E":
                    devUploader.ValidationSettings.AllowedFileExtensions = new string[] { ".jpg", ".jpeg", ".gif", ".pdf", ".zip" };
                    break;
                default:
                    devUploader.ValidationSettings.AllowedFileExtensions = new string[] { ".jpg", ".jpeg", ".gif", ".png", ".doc", ".docx", ".ppt", ".pptx", ".xls", ".xlsx", ".pdf", ".zip" };
                    break;
            }
        }
        #endregion
        ...
        protected void devUploader_FilesUploadComplete(object sender, DevExpress.Web.FilesUploadCompleteEventArgs e)
        {
            ...
            else
            {
                ...
                {
                    e.CallbackData = String.Format("Success|{0}", sAttachUniqueID);
                }
            }
        }
